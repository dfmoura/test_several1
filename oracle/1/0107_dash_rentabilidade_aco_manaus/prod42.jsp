...
<head>
    ...
    <title>Tela de Investimentos</title>
    <style>
        body {
            display: flex;
...
<body>
    ...
    <div class="container">
        <div class="section">
            <div class="part" id="left-top">
                <div class="part-title">Investimentos por Empresa</div>
            ...
            <div class="part" id="left-bottom">
                <div class="part-title">TOP 10 - Investimentos por CR</div>
        ...
        <div class="section">
            <div class="part" id="right-top">
                <div class="part-title">TOP 10 - Investimentos por Natureza</div>
                <div class="chart-container">
                    <canvas id="barChartRight"></canvas>
                </div>
            </div>
            <div class="part" id="right-bottom">
                <div class="part-title">Detalhamento Investimentos</div>
    ...
    <script>
        ...
        const dadosExemplo = {
            ...
            do_emp: [
                { CODEMP: 1, EMPRESA: "Empresa A", VLRINV: 450000 },
                { CODEMP: 2, EMPRESA: "Empresa B", VLRINV: 380000 },
                { CODEMP: 3, EMPRESA: "Empresa C", VLRINV: 320000 },
                { CODEMP: 4, EMPRESA: "Empresa D", VLRINV: 100000 }
            ],
            do_nat: [
                { CODEMP: 1, CODNAT: 1001, NATUREZA: "Natureza A", VLRINV: 180000 },
                { CODEMP: 1, CODNAT: 1002, NATUREZA: "Natureza B", VLRINV: 150000 },
                { CODEMP: 1, CODNAT: 1003, NATUREZA: "Natureza C", VLRINV: 120000 },
                { CODEMP: 2, CODNAT: 2001, NATUREZA: "Natureza D", VLRINV: 200000 },
                { CODEMP: 2, CODNAT: 2002, NATUREZA: "Natureza E", VLRINV: 180000 },
                { CODEMP: 3, CODNAT: 3001, NATUREZA: "Natureza F", VLRINV: 160000 },
                { CODEMP: 3, CODNAT: 3002, NATUREZA: "Natureza G", VLRINV: 160000 },
                { CODEMP: 4, CODNAT: 4001, NATUREZA: "Natureza H", VLRINV: 100000 }
            ],
            do_cr: [
                { CODEMP: 1, CODCENCUS: 101, CR: "Centro de Resultado A", VLRINV: 85000 },
                { CODEMP: 1, CODCENCUS: 102, CR: "Centro de Resultado B", VLRINV: 72000 },
                { CODEMP: 1, CODCENCUS: 103, CR: "Centro de Resultado C", VLRINV: 68000 },
                { CODEMP: 2, CODCENCUS: 201, CR: "Centro de Resultado D", VLRINV: 95000 },
                { CODEMP: 2, CODCENCUS: 202, CR: "Centro de Resultado E", VLRINV: 88000 },
                { CODEMP: 2, CODCENCUS: 203, CR: "Centro de Resultado F", VLRINV: 82000 },
                { CODEMP: 3, CODCENCUS: 301, CR: "Centro de Resultado G", VLRINV: 78000 },
                { CODEMP: 3, CODCENCUS: 302, CR: "Centro de Resultado H", VLRINV: 75000 },
                { CODEMP: 3, CODCENCUS: 303, CR: "Centro de Resultado I", VLRINV: 72000 },
                { CODEMP: 4, CODCENCUS: 401, CR: "Centro de Resultado J", VLRINV: 100000 }
            ],
            do_detalhe: [
                { CODEMP: 1, EMPRESA: "Empresa A", CODNAT: 1001, NATUREZA: "Natureza A", CODCENCUS: 101, CR: "Centro de Resultado A", VLRINV: 45000 },
                { CODEMP: 1, EMPRESA: "Empresa A", CODNAT: 1002, NATUREZA: "Natureza B", CODCENCUS: 102, CR: "Centro de Resultado B", VLRINV: 38000 },
                { CODEMP: 1, EMPRESA: "Empresa A", CODNAT: 1003, NATUREZA: "Natureza C", CODCENCUS: 103, CR: "Centro de Resultado C", VLRINV: 32000 },
                { CODEMP: 2, EMPRESA: "Empresa B", CODNAT: 2001, NATUREZA: "Natureza D", CODCENCUS: 201, CR: "Centro de Resultado D", VLRINV: 58000 },
                { CODEMP: 2, EMPRESA: "Empresa B", CODNAT: 2002, NATUREZA: "Natureza E", CODCENCUS: 202, CR: "Centro de Resultado E", VLRINV: 52000 },
                { CODEMP: 2, EMPRESA: "Empresa B", CODNAT: 2003, NATUREZA: "Natureza F", CODCENCUS: 203, CR: "Centro de Resultado F", VLRINV: 45000 },
                { CODEMP: 3, EMPRESA: "Empresa C", CODNAT: 3001, NATUREZA: "Natureza G", CODCENCUS: 301, CR: "Centro de Resultado G", VLRINV: 65000 },
                { CODEMP: 3, EMPRESA: "Empresa C", CODNAT: 3002, NATUREZA: "Natureza H", CODCENCUS: 302, CR: "Centro de Resultado H", VLRINV: 58000 },
                { CODEMP: 4, EMPRESA: "Empresa D", CODNAT: 4001, NATUREZA: "Natureza I", CODCENCUS: 401, CR: "Centro de Resultado I", VLRINV: 100000 }
            ]
        };
        ...
        function preencherTabelaDetalhes() {
            ...
            dadosExemplo.do_detalhe.forEach(item => {
                ...
                row.innerHTML = `
                    ...
                    <td>${item.VLRINV.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                `;
        ...
        function atualizarTotalOverlay() {
            const total = dadosExemplo.do_total[0].VLRINV;
