    ...
    <script>
      ...
      function montarConteudoOverlayIniciadas(op, body, dadosGeral) {
        ...
        body.innerHTML =
          ...
          "</span></div>" +
          '<div class="detalhe-item"><span class="detalhe-label">Data</span><span class="detalhe-valor">' +
          (dtfab ? formatarData(dtfab) : "-") +
          "</span></div>" +
          '<div class="detalhe-item"><span class="detalhe-label">Produto</span><span class="detalhe-valor">' +
          (codprodpa != null ? codprodpa : "") +
          (descrprod ? " - " + descrprod : "") +
          "</span></div>" +
          '<div class="detalhe-item"><span class="detalhe-label">Registro MAPA</span><span class="detalhe-valor">' +
          (codregmapa != null && codregmapa !== "" ? codregmapa : "-") +
          "</span></div>" +
          '<div class="detalhe-item"><span class="detalhe-label">Densidade</span><span class="detalhe-valor">' +
          (densidade != null && densidade !== "" ? densidade : "-") +
          "</span></div>" +
          '<div class="detalhe-item"><span class="detalhe-label">Garantias</span><span class="detalhe-valor">' +
          (garantias != null && garantias !== "" ? garantias : "-") +
          "</span></div>" +
          '<div class="detalhe-item"><span class="detalhe-label">Lote</span><span class="detalhe-valor">' +
          (nrolote != null && nrolote !== "" ? nrolote : "-") +
          "</span></div>" +
          '<div class="detalhe-item"><span class="detalhe-label">Qtd. Produzir</span><span class="detalhe-valor">' +
