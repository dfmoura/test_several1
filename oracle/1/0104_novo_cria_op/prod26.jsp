...
<html lang="pt-BR">
  ...
  <body>
    ...
    <script>
              ...
              if (apontContainer && apontContainer.getAttribute("data-carregado") !== "true") {
                ...
                body.querySelector("#apontamentosTbodyItens").addEventListener("click", function (e) {
                  ...
                  carregarMateriaisPorNuapoSeqapa(nuapo, seqapa).then(function (rowsMat) {
                    ...
                    if (rowsMat.length === 0) {
                      tbodyMat.innerHTML = "<tr><td colspan=\"9\" class=\"apontamentos-placeholder\">Nenhum material.</td></tr>";
                    } else {
                      rowsMat.forEach(function (r) {
                        ...
                        trM.innerHTML = "<td>" + esc(n) + "</td><td>" + esc(seq) + "</td><td>" + esc(seqmp) + "</td><td>" + esc(cod) + "</td><td>" + esc(desc) + "</td><td>" + esc(ctrl) + "</td><td>" + esc(qtd) + "</td><td>" + esc(codvol) + "</td><td>" + esc(tipoUso) + "</td>";
      ...
      // Executa "Gerar Apontamento" na guia Apontamentos: chama o botão Java CadastrarCabecApontamentoBTFromParam com IDIPROC
