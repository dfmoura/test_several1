                        ...
                        <table>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="font-weight: bold;" id="totalizador-valor"></td>
                                    <td colspan="3"></td>
                                </tr>
                            </tfoot>
                        </table>
    ...
    <script>
        function atualizarTotalizadorTela() {
            ...
            document.querySelectorAll("tbody td:nth-child(6)").forEach(td => {
                const texto = td.innerText.replace("R$", "").replace(/\./g, "").replace(",", ".").trim();
                const valor = parseFloat(texto);
                if (!isNaN(valor)) total += valor;
            });

            document.getElementById("totalizador-valor").innerText =
