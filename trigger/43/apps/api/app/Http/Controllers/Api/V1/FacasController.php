...
class FacasController extends Controller
{
    ...
    public function update(Request $request, int $faca): JsonResponse
    {
        $this->authorizeEscrever($request);

        $data = $request->validate([
            'maquina_catalogo' => ['nullable', 'string', 'max:64'],
            'maquina_origem' => ['nullable', 'string', 'max:64'],
            'n_facas' => ['nullable', 'integer', 'min:0'],
            'cilindro' => ['nullable', 'string', 'max:32'],
            'colunas_mapa' => ['nullable', 'string', 'max:64'],
    ...
    public function alinharFornecedores(Request $request): JsonResponse
    {
        $this->authorizeEscrever($request);

        $result = $this->facasMapaService->alinharFornecedoresParceiros();
