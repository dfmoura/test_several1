...
<body>
                                ...
                                <c:forEach var="row" items="${base.rows}">
                                    <tr>
                                        ...
                                        <td class="${row.VLRDESDOB >= 0 ? 'valor-positivo' : 'valor-negativo'}">
                                            <fmt:formatNumber value="${row.VLRDESDOB}" type="currency" currencyCode="BRL" />
                                        </td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="font-weight: bold;" class="${total >= 0 ? 'valor-positivo' : 'valor-negativo'}">
                                        <fmt:formatNumber value="${total}" type="currency" currencyCode="BRL" />
                                    </td>
                                    <td colspan="3"></td>
                                </tr>
                            </tfoot>
    ...
    <script>
        function gerarPDF() {
            ...
            // Get the total value directly from the HTML table footer
            const totalRow = document.querySelector('tfoot tr');
            const totalCell = totalRow.querySelector('td:nth-child(6)');
            const totalText = totalCell.textContent.trim();
            
            // Process each row from the HTML table
