    ...
    <script>
      ...
      async function gerarRelatorioPdf() {
        ...
        function addLinha(text, opts) {
          opts = opts || {};
          var margemEsq = opts.x != null ? opts.x : 12;
          var maxLargura = 190 - margemEsq;
        ...
        doc.setFontSize(16);
        doc.text("Relatório da Operação", 105, yAtual, { align: "center" });
        yAtual += 8;
        ...
        doc.setFont("helvetica", "bold");
        doc.setFontSize(12);
        addLinha("1. Dados gerais da operação");
        doc.setFont("helvetica", "normal");
        doc.setFontSize(10);
        ...
        doc.setFont("helvetica", "bold");
        doc.setFontSize(12);
        addLinha("2. Apontamentos da atividade");
        doc.setFont("helvetica", "normal");
        doc.setFontSize(10);
        ...
        doc.setFont("helvetica", "bold");
        doc.setFontSize(12);
        addLinha("3. Execuções da atividade");
        doc.setFont("helvetica", "normal");
        doc.setFontSize(10);
