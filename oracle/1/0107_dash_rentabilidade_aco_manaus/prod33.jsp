    ...
    <script>
        ...
        async function carregarDadosFaturamentoTipo() {
            try {
                ...
                const dataInicio = document.getElementById('dataInicio') ? document.getElementById('dataInicio').value : '01/01/2024';
                const dataFim = document.getElementById('dataFim') ? document.getElementById('dataFim').value : '31/12/2024';
