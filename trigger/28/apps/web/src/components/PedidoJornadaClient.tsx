            ...
            {!pedido.docsSaida?.length && !pedido.docSaida && fiscal && (
              <div className="fiscal-plan">
                <p className="muted" style={{ marginTop: 0 }}>
                  No faturamento saem <strong>duas notas</strong> (XML + PDF no padrão dos
                  modelos), via{" "}
                  <a
                ...
                <div className="dual-fiscal">
                  {fiscal.emitirNfe && (
                    <div className="dual-fiscal-card nfe">
                      <span className="doc-tag">NF-e · revenda</span>
                      <h3>Mercadoria</h3>
                      <span className="muted">CFOP 5102 · produtos / materiais</span>
                      <b className="money" style={{ display: "block", marginTop: 8 }}>
                        {formatBrl(fiscal.valorNfe || 0)}
                      </b>
                    </div>
                  )}
                  {fiscal.emitirNfse && (
                    <div className="dual-fiscal-card nfse">
                      <span className="doc-tag">NFS-e · serviço</span>
                      <h3>Prestação de serviço</h3>
                      <span className="muted">Impressão / composição gráfica</span>
                      <b className="money" style={{ display: "block", marginTop: 8 }}>
