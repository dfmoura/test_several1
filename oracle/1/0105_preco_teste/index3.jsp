...
<body>
      ...
      <div class="filter-content" id="filterContent">
        <div class="filter-form">
          ...
          <div class="input-group">
            ...
            <input type="text" id="periodoInput" name="periodoInput" placeholder="DD/MM/YYYY" maxlength="10">
          </div>
  ...
  <script>
    ...
    function listarResumoMaterial() {
      ...
      // Se não foi informado período, usa a data atual
      let periodo = '';
      if (periodoInput) {
        ...
        periodo = formatDateForQuery(periodoInput);
      } else {
        // Usa data atual se não foi informado
        const hoje = new Date();
