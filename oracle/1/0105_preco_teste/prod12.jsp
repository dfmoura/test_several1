...
<body class="bg-green-50 min-h-screen flex flex-col items-center py-2">
  ...
  <div class="fixed-header">
    ...
    <div class="header-actions">
      <button id="saveToTableBtn" class="export-btn-overlay" style="margin-right: 10px; background-color: #10b981;" title="Salvar dados na tabela">
        <i class="fas fa-save"></i>
      </button>
      <button id="exportToExcelBtn" class="export-btn-overlay" style="background-color: #3b82f6;" title="Exportar para excel">
