...
<head>
  ...
  <style>
    ...
    /* Garantir que não haja espaçamento entre thead e tbody */
    #dataTable thead {
      margin: 0;
      padding: 0;
    }
    ...
    <table id="dataTable" class="min-w-full bg-white rounded-lg shadow">
      <thead>
        <tr class="bg-green-100">
          ...
          <th></th>
          <th colspan="2" style="background-color: #49bb8d; text-align: center;color: white;">Ticket Médio</th>
          <th>Custo</th>
        ...
        <tr class="bg-green-200 text-green-900">
          ...
          <th class="col-ticket-12m"   style="background-color: #49bb8d; text-align: center;color: white;">Últ. 12M</th>
          <th class="col-ticket-safra"   style="background-color: #49bb8d; text-align: center;color: white;">Safra</th>
