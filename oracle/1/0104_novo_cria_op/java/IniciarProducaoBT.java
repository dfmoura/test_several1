 ...
 */
public class IniciarProducaoBT implements AcaoRotinaJava {

    @Override
    public void doAction(ContextoAcao contexto) throws Exception {
        System.out.println("br.com.triggerint.IniciarProducaoBT - INICIO");

        // Validar se há registro selecionado (apenas um)
        Registro[] linhas = contexto.getLinhas();
        if (linhas.length == 0) {
            contexto.mostraErro("Nenhum registro foi selecionado na tabela TPRIPROC.");
            return;
        }
        ...
        try {
            ...
            System.out.println("Produção iniciada - IDIPROC: " + idiproc + ", Atividades: " + atividadesIniciadas);
        ...
        System.out.println("br.com.triggerint.IniciarProducaoBT - FIM");
    }
}
