...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="chart-container">
                        ...
                        <div class="chart-wrapper">
                            <div class="loading">
                                <i class="fas fa-chart-line" style="font-size: 48px; color: #008a70; margin-bottom: 15px;"></i>
                                <div class="loading-text">Gráfico de linha removido</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="chart-container">
                        ...
                        <div class="chart-wrapper">
                            <div class="loading">
                                <i class="fas fa-chart-bar" style="font-size: 48px; color: #008a70; margin-bottom: 15px;"></i>
                                <div class="loading-text">Gráfico de barras removido</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        // Função principal de inicialização (apenas para os cards)
