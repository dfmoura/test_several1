...
function hideStatusOverlay() {
  document.getElementById('statusOverlay').style.display = 'none';
    ...
    // (Removido) Event listeners de Salvar/Carregar Simulação



    // (Removido) Funções de salvar simulação

    // Função para coletar dados da tabela para simulação
    // (Removido) Coleta de dados para salvar simulação

    // Função para obter próximo código da tabela AD_SIMCAB
    // (Removido) Função de next código simulação

    // Função para obter próximo ID da tabela AD_SIMITE
    // (Removido) Função de next id item simulação

    // Função para mostrar modal de carregar simulação
    // (Removido) Abertura modal carregar simulação

    // Função para carregar dados das simulações
    // (Removido) Carregamento de dados de simulações

    // Função para renderizar tabela de simulações
    // (Removido) Render da tabela de simulações

    // Função para carregar dados da simulação na tabela
    // (Removido) Preenchimento da tabela a partir da simulação

    // Função para carregar simulação a partir de uma linha da tabela
    // (Removido) Carregamento da simulação a partir da linha
