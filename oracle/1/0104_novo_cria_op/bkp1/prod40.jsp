    ...
    <script>
      ...
      async function atualizarListaBalancasNaGuiaGeral() {
        ...
        if (!balancas || balancas.length === 0) {
          ...
          let html =
            '<table class="balancas-tabela"><thead><tr><th>Código</th><th>Placa de série</th><th>Descrição</th></tr></thead><tbody>';
          balancas.forEach(function (b) {
            ...
            const desc = b.DESCRICAO != null ? b.DESCRICAO : b.descricao;
            html +=
              "<tr><td>" +
              (codigo != null ? codigo : "") +
              "</td><td>" +
        ...
        try {
          ...
          if (!balancasDisp || balancasDisp.length === 0) {
            ...
            balancasDisp.forEach(function (b) {
              ...
              const desc =
                b.DESCRICAO != null ? b.DESCRICAO : b.descricao || "";
              const label =
                (placas != null ? placas : "") +
                (desc ? " - " + String(desc) : "");
              options +=
