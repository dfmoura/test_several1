...
<snk:query var="detalhe">
	...
	D.ESTOQUE,D.VENDA_PER_GIRO,D.DU,round(D.GIRO,2)GIRO,D.DU_GIRO,round((D.EST_MIN- NVL(b.QTDNEG, 0)),2)EST_MIN
    ...
    LEFT JOIN (
        SELECT 
        CODEMP, CODPROD, MARCA, SUM(QTDNEG) QTDNEG
        FROM(
        select 
        CAB.DTNEG, CAB.CODEMP, ITE.CODPROD, PRO.MARCA, SUM(ITE.QTDNEG * AD_QTDVOLLT) QTDNEG
        from tgfcab cab
        ...
        GROUP BY CAB.DTNEG,CAB.CODEMP,ITE.CODPROD,PRO.MARCA
        )
        GROUP BY CODEMP, CODPROD, MARCA
