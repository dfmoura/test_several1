...
SELECT
VGF.CODEMP,VGF.TIPOPROD,VGF.CODPROD,VGF.DESCRPROD AS PRODUTO,VGF.CODGER,VGF.GERENTE,SUM(TOTALLIQ)TOTALLIQ
FROM VGF_CONSOLIDADOR_NOTAS_GM  VGF
INNER JOIN TGFPAR PAR ON VGF.CODPARC = PAR.CODPARC
LEFT JOIN TGFPAR PARM ON PAR.CODPARCMATRIZ = PARM.CODPARC
WHERE 
...
AND (AD_TPPROD = :A_TPPROD OR ( AD_TPPROD = 4 AND :A_TPPROD IS NULL ))
group by VGF.CODEMP,VGF.TIPOPROD,VGF.CODPROD,VGF.DESCRPROD,VGF.CODGER,VGF.GERENTE
