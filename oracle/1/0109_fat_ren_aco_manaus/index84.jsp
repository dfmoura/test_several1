...
<body>
    ...
    <snk:query var="fat_tipo">  
        WITH bas AS (
            ...
            Select codgrupai AD_TPPROD,descrgrupo_nivel1 TIPOPROD,SUM(VLRDESC)VLRDESC from bas2
            GROUP BY codgrupai,descrgrupo_nivel1 ORDER BY SUM(VLRDESC) DESC
    </snk:query> 
...
WITH bas AS (
    ...
    <div class="container">
        <div class="section">
            <div class="part" id="left-top">
                <div class="part-title">Desconto Grupo Produto</div>
            ...
            <div class="part" id="left-bottom">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                    <div class="part-title">Desconto -${row.descrgrupo_nivel1} - Empresa</div>
                </c:forEach>
                <div class="chart-container">
        ...
        <div class="section">
            <div class="part" id="right-top">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                <div class="part-title">Desconto ${row.descrgrupo_nivel1} - Vendedores</div>
            </c:forEach>
                <div class="chart-container">
            ...
            <div class="part" id="right-bottom">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                    <div class="part-title">Desconto ${row.descrgrupo_nivel1} - Produtos</div>
                </c:forEach>
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${fat_produto.rows}" var="row">
                                <tr>
                                    ...
                                    <td>${row.CODPROD}</td>
                                    <td>${row.descrprod}</td>
                                    <td><fmt:formatNumber value="${row.VLRDESC}" type="currency" currencySymbol="" groupingUsed="true" minFractionDigits="2" maxFractionDigits="2"/></td>
                                    <c:set var="total" value="${total + row.VLRDESC}" />
                                </tr>
                            </c:forEach>
                            <tr>
                                <td><b>Total</b></td>
    ...
    <script>
        ...
        function ref_fat1(TIPOPROD) {
            ...
            refreshDetails('html5_af0k681', params1); 
