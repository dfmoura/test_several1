...
<snk:query var="fat_tipo">  
  ...
  AND CODGER = :A_GERENTE
  AND AD_TPPROD = :A_TPPROD
  GROUP BY AD_TPPROD,CODGER,AD_SUPERVISOR,SUPERVISOR
</snk:query>    
...
SELECT
CODEMP,AD_SUPERVISOR,SUPERVISOR,CODGER,GERENTE,TIPOPROD,CODPROD,DESCRPROD AS PRODUTO,SUM(TOTALLIQ)TOTALLIQ
FROM VGF_CONSOLIDADOR_NOTAS_GM
WHERE
DTNEG BETWEEN :P_PERIODO.INI AND :P_PERIODO.FIN
AND GOLSINAL = -1
...
GROUP BY CODEMP,AD_SUPERVISOR,SUPERVISOR,CODGER,GERENTE,TIPOPROD,CODPROD,DESCRPROD
