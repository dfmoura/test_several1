...
<html lang="pt">
  <head>
    ...
    <style>
      ...
      /* Melhorias para cabeçalho fixo */
      .overlay-table-container::-webkit-scrollbar {
        width: 8px;
        height: 8px;
      }

      .overlay-table-container::-webkit-scrollbar-track {
        background: #f1f1f1;
        border-radius: 4px;
      }

      .overlay-table-container::-webkit-scrollbar-thumb {
        background: #c1c1c1;
        border-radius: 4px;
      }

      .overlay-table-container::-webkit-scrollbar-thumb:hover {
        background: #a8a8a8;
      }

      /* Melhorar a aparência do cabeçalho fixo */
      .overlay-table thead th:first-child {
        border-top-left-radius: 8px;
      }

      .overlay-table thead th:last-child {
      ...
      @media (max-width: 768px) {
        ...
        /* Ajustes para mobile - cabeçalho fixo */
        .overlay-table-container {
          max-height: 50vh;
        }
