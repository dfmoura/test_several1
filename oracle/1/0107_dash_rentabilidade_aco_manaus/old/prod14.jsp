...
<style>
    ...
    .filter-input:focus {
      outline: none;
      border-color: #130455;
      box-shadow: 0 0 0 2px rgba(19, 4, 85, 0.25);
    }
  ...
  <div class="fixed-filters">
    <div class="filters-container">
      <div class="filter-group">
        <label for="dataInicio" class="filter-label"><strong>Data Início:</strong></label>
        <input type="date" class="filter-input" id="dataInicio" value="2025-08-01">
      </div>
      <div class="filter-group">
        <label for="dataFim" class="filter-label"><strong>Data Fim:</strong></label>
