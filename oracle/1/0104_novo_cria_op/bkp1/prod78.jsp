  ...
  <body>
    ...
    <script>
      ...
      function abrirOverlayDetalhe(op) {
        ...
        } else if (btnAcao.style.display !== "none") {
          btnAcao.focus();
        }
      ...
      // Executa "Gerar Apontamento" na guia Apontamentos: CadastrarCabecApontamentoBTFromParam (id. botão 304), IDIPROC e IDIATV.
      // A regra personalizada CORE_E01128 exige IDIATV quando aplicável; enviar IDIATV quando disponível.
      function executarGerarApontamento(opts) {
        ...
        return JX.acionarBotao(params, { tipo: "JAVA", idBotao: 304 })
              ...
              if (useRecipePdf) {
                ...
                for (var iIt = 0; iIt < itensAtual.length; iIt++) {
                  ...
                  if (matsAtual && matsAtual.length > 0) {
                    addLinha("");
                    addLinha("    --- Matérias-primas consumidas neste item ---");
