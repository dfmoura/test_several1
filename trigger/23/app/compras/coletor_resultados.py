            ...
            for unidade in unidades_alvo:
                ...
                for per_ini, per_fim in janelas:
                    ...
                    for raw in client.paginar(
                        COMPRAS_RESULTADOS_ENDPOINT,
                        params_base={
                            # Nomes oficiais da OpenAPI (não codigoUasg /
                            # dataResultadoPncpInicio — esses geram 404 no gateway).
                            "unidadeOrgaoCodigoUnidade": unidade,
                            "dataResultadoPncpInicial": per_ini.isoformat(),
                            "dataResultadoPncpFinal": per_fim.isoformat(),
                        },
