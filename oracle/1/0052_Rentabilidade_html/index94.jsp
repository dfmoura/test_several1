...
<snk:query var="fat_det">
    SELECT * FROM (
        ...
        (
        SELECT
        CODEMP,EMPRESA,NUNOTA,TO_CHAR(DTNEG,'DD-MM-YYYY')DTNEG,AD_TPPROD,TIPOPROD,CODPROD,DESCRPROD,CODGER,GERENTE,CODPARC,NOMEPARC AS PARCEIRO,HL
        ...
        SELECT CODEMP,EMPRESA,NUNOTA,DTNEG,AD_TPPROD,TIPOPROD,CODPROD,DESCRPROD,CODGER,GERENTE,CODPARC,PARCEIRO,SUM(HL) HL 
        FROM HL 
        WHERE 
                ...
                <c:forEach var="row" items="${fat_det.rows}">
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <fmt:formatNumber value="${row.HL}" type="number" currencySymbol="" groupingUsed="true" minFractionDigits="2" maxFractionDigits="2"/>
                        </td>
                    </tr>
                </c:forEach>              
            </tbody>
