...
AND VGF.AD_SUPERVISOR = :A_SUPERVISOR
...
<snk:query var="fat_tipo">  
  ...
  AND VGF.AD_SUPERVISOR = :A_SUPERVISOR
  AND VGF.AD_TPPROD = :A_TPPROD
  GROUP BY VGF.AD_TPPROD, VGF.CODVEND, VGF.VENDEDOR, VGF.AD_SUPERVISOR, VGF.SUPERVISOR,VGF.CODGER
  ORDER BY 5 DESC
</snk:query>    
...
<snk:query var="det_sup">
  SELECT
  VGF.CODEMP,VGF.CODVEND,VGF.VENDEDOR,VGF.AD_SUPERVISOR,VGF.SUPERVISOR,VGF.CODGER,VGF.GERENTE,VGF.TIPOPROD,VGF.CODPROD,VGF.DESCRPROD AS PRODUTO,SUM(TOTALLIQ)TOTALLIQ
  FROM VGF_CONSOLIDADOR_NOTAS_GM VGF
  INNER JOIN TGFPAR PAR ON VGF.CODPARC = PAR.CODPARC
  LEFT JOIN TGFPAR PARM ON PAR.CODPARCMATRIZ = PARM.CODPARC
  WHERE 
  ...
  AND VGF.AD_TPPROD = :A_TPPROD
  AND VGF.AD_SUPERVISOR = :A_SUPERVISOR
  GROUP BY VGF.CODEMP,VGF.CODVEND,VGF.VENDEDOR,VGF.AD_SUPERVISOR,VGF.SUPERVISOR,VGF.CODGER,VGF.GERENTE,VGF.TIPOPROD,VGF.CODPROD,VGF.DESCRPROD
</snk:query>
