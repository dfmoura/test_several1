...
<html lang="pt-BR">
  ...
  <body>
    ...
    <header>
      ...
      <div class="header-actions">
        ...
        <button
          class="test-btn-302"
          id="btnTest302"
          onclick="acionarBotao302()"
          title="Botão Teste 302"
          aria-label="Acionar Botão Teste 302"
        >
          Teste 302
        </button>
        <button
    ...
    <script>
      ...
      // Função para acionar o botão 302 via JX.acionarBotao
      async function acionarBotao302() {
        try {
          // Verificar se SankhyaJX está disponível
          if (typeof JX === "undefined" || !JX.acionarBotao) {
            console.error("SankhyaJX não está disponível ou método acionarBotao não encontrado");
            alert("Erro: Biblioteca SankhyaJX não está disponível");
            return;
          }

          console.log("Acionando botão 302...");

          // Acionar botão 302 do tipo JAVA
          ...
          if (resp && resp.mensagem) {
            ...
            alert('Botão 302 acionado com sucesso!');
          }
        } catch (erro) {
          console.error('Falha ao acionar botão 302:', erro);
          alert('Erro ao acionar botão 302: ' + (erro.message || erro));
        }
      }
