    ...
    <script>
        ...
        async function gerarPDF() {
            try {
                ...
                // Adicionar cabeçalho compacto (25mm de altura)
                doc.setFillColor(44, 62, 80);
                doc.rect(0, 0, doc.internal.pageSize.width, 25, 'F');
                
                // Adicionar logo branca (tamanho pequeno)
                doc.addImage(whiteLogoData, 'PNG', margin, 8, 30, 9);
                
                // Adicionar título e subtítulo compactos
                doc.setFontSize(14);
                doc.setTextColor(255, 255, 255);
                doc.text('Relatório Financeiro Gerencial', 45, 14);
                doc.setFontSize(8);
                doc.text('Análise detalhada das movimentações financeiras', 45, 19);
                ...
                // Posição inicial da tabela logo após o cabeçalho
                const startY = 25;
                
                // Adicionar tabela ao PDF
                doc.autoTable({
                    startY: startY, // Começa logo após o cabeçalho
                    head: head,
                    body: body,
                    styles: { 
                    ...
                    pageBreak: 'avoid', // Evitar quebras desnecessárias
                    tableLineWidth: 0.1
                });
                ...
                // Adicionar linha de total compacta
                if (totalText) {
                    doc.autoTable({
