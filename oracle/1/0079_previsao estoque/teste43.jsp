...
<snk:query var="detalhe">
    ...
    SELECT
        ...
        - 
        SUM(CASE WHEN :P_TRIANGULACAO = 'S' THEN 0 ELSE NVL(B.QTDNEG, 0) END)
        ,0) 
        AS VENDA_PER_GIRO,
        ...
        )-SUM(CASE WHEN :P_TRIANGULACAO = 'S' THEN 0 ELSE NVL(B.QTDNEG, 0) END)) / FUN_TOT_DIAS_UTE_SATIS(:P_PERIODO1.INI, :P_PERIODO1.FIN)
        ...
        )- SUM(CASE WHEN :P_TRIANGULACAO = 'S' THEN 0 ELSE NVL(B.QTDNEG, 0) END)) / FUN_TOT_DIAS_UTE_SATIS(:P_PERIODO1.INI, :P_PERIODO1.FIN)),0)
            AS EST_MIN
    ...
    ) B ON A.CODPROD = b.CODPROD AND A.CODEMP = B.CODEMP
