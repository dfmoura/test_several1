        ...
        try {
          ...
          const sqlMensal = `
            ...
            FROM (
              ...
              GROUP BY MET.DTREF, MET.CODVEND, MET.CODPARC, MET.MARCA, NVL(VGF.CODGRUPOPROD, MAR.AD_GRUPOPROD)
            )
            GROUP BY 
        ...
        return `
            ...
            FROM (
              SELECT 
                ...
                MAX(X.QTDPREV) AS QTDPREV,
                SUM(X.VLRREAL) AS VLRREAL,
                MAX(X.VLRPREV) AS VLRPREV
              FROM (
                SELECT 
                  MET.DTREF,
                  MET.CODVEND,
              ...
              GROUP BY X.DTREF, X.CODVEND, X.CODPARC, X.MARCA
            )
            GROUP BY MARCA
            ORDER BY 1`;
      }
