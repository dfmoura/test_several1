...
select codemp,codgrupai,descrgrupo_nivel1,codprod,descrprod,totalliq,total_grupo,percentual_grupo,ranking_grupo,
ROW_NUMBER() OVER (PARTITION BY codgrupai ORDER BY total_grupo DESC) AS ranking_grupo1
from bas