...
export function NfseDetail() {
  ...
  const handleCancelar = async () => {
    ...
    setError('');
    try {
      await api.cancelar(chave, { codigoMotivo, motivo });
      setShowCancel(false);
      load();
    } catch (e) {
          ...
          <div className="card w-full max-w-md p-6">
            ...
            <div className="mt-4 space-y-3">
              <div>
                ...
                <input className="input" value={codigoMotivo} onChange={(e) => setCodigoMotivo(e.target.value)} />
              </div>
              <div>
                <label className="label">Motivo (mín. 15 caracteres)</label>
