...
SELECT
   ...
   BQ.STATUS,
   CASE
      WHEN BQ.STATUS = 'ENC' THEN 'PEDIDO ENCERRADO'
      WHEN BQ.STATUS = 'ME' THEN 'MERCADORIA ENTREGUE'
      WHEN BQ.STATUS = 'MA' THEN 'MERCADORIA A CAMINHO'
      WHEN BQ.STATUS = 'PE' THEN 'PREVISAO DE ENTREGA'
      WHEN BQ.STATUS = 'ANF' THEN 'AGUARDANDO NF'
      WHEN BQ.STATUS = 'NFE' THEN 'NOTA FISCAL EMITIDA'
      WHEN BQ.STATUS = 'PS' THEN 'PEDIDO EM SEPARACAO'
      WHEN BQ.STATUS = 'R' THEN 'REJEITADO'
      WHEN BQ.STATUS = 'A' THEN 'APROVADO'
      WHEN BQ.STATUS = 'EE' THEN 'EM ANALISE'
      WHEN BQ.STATUS = 'C' THEN 'CANCELADO'
      WHEN BQ.STATUS = 'PFP' THEN 'PEDIDO FATURADO PARCIAL'
      ELSE BQ.STATUS
