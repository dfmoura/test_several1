    ...
    <style>
        * {
        ...
        thead {
            ...
            color: white !important; /* Força o texto branco em todas as colunas do cabeçalho */
            position: sticky;
            top: 0;
    ...
    <script>
        ...
        async function gerarPDF() {
            try {
                ...
                const logoUrl = 'https://raw.githubusercontent.com/dfmoura/test_several1/refs/heads/main/ireport/0044_Relatorio_Financeiro/logo-menu2.png';
                
                // Tamanhos ajustados (aumentei a largura e altura)
                const logoWidth = 35;  // Aumentei de 25 para 35
                const logoHeight = 10; // Aumentei de 7.5 para 10
                const logoX = margin;
                const logoY = 3;
                ...
                await new Promise((resolve, reject) => {
                    img.onload = resolve;
                    img.onerror = reject;
                    img.src = logoUrl + '?t=' + new Date().getTime(); // Cache buster
                });

                // Criar canvas para processar a logo com borda arredondada
                const canvas = document.createElement('canvas');
                canvas.width = img.width;
                canvas.height = img.height;
                const ctx = canvas.getContext('2d');

                // Criar fundo branco com borda arredondada
                ctx.fillStyle = 'white';
                ...
                // Adicionar fundo branco e logo ao PDF
                doc.setFillColor(255, 255, 255);
                doc.roundedRect(logoX, logoY, logoWidth, logoHeight, 2, 2, 'F'); // Borda arredondada
                doc.addImage(whiteLogoData, 'PNG', logoX, logoY, logoWidth, logoHeight);
                ...
                doc.autoTable({
                    ...
                    headStyles: {
                        ...
                        textColor: [255, 255, 255], // Branco para todo o texto
                        fontStyle: 'bold',
                        fontSize: 7
                    },
                    ...
                    didParseCell: function(data) {
                        // Aplicar estilos de cor apenas para células de valor (coluna 5) no corpo da tabela
                        ...
                        // Forçar cabeçalhos (th) a serem brancos
        ...
        document.getElementById('th-valor').style.color = 'white';
        });        
