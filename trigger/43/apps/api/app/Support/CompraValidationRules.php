...
final class CompraValidationRules
{
    ...
    public static function receber(): array
    {
        return [
            ...
            'itens.*.lotes.*.largura_mm' => array_merge(['nullable'], PadraoDecimal::rules(PadraoDecimal::SCALE_DIM, true)),
            'itens.*.lotes.*.comprimento_m' => array_merge(['nullable'], PadraoDecimal::rules(PadraoDecimal::SCALE_DIM, true)),
            'itens.*.lotes.*.endereco_id' => ['nullable', 'integer', 'exists:estoque_enderecos,id'],
