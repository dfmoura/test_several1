  ...
  <body>
    ...
    <script>
      ...
      function createLineChart(labels, realData, metaData) {
        ...
        const realDataAcumulado = [];
        const metaDataAcumulado = [];
        let realAcumulado = 0;
        let metaAcumulado = 0;

        for (let i = 0; i < realData.length; i++) {
          realAcumulado += realData[i];
          metaAcumulado += metaData[i];
          realDataAcumulado.push(realAcumulado);
          metaDataAcumulado.push(metaAcumulado);
        }
