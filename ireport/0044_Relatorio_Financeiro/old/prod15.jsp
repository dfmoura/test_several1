    ...
    <script>
        ...
        function gerarPDF() {
            ...
            document.querySelectorAll("tbody tr").forEach(tr => {
                ...
                let rawValue = row[5] || "";
                let isNegative = rawValue.includes('(');
                rawValue = rawValue
            ...
            const totalFormatado = 'R$ ' + Math.abs(total).toLocaleString('pt-BR', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });
            const totalFinal = total < 0 ? `(${totalFormatado})` : totalFormatado;
            ...
            doc.autoTable({
                ...
                didParseCell: function(data) {
                    if (data.column.index === 5 && typeof data.cell.raw === 'string') {
                        const isNeg = data.cell.raw.includes('(');
