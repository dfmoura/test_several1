...
<script>
    const incrementValue = 0.1; // Defina o valor de incremento/decremento (em decimal)
    ...
    document.querySelectorAll('.btn').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            if (this.classList.contains('btn-decrease')) {
                value = (value - incrementValue).toFixed(1); // Decremento em decimal
            } else {
                value = (value + incrementValue).toFixed(1); // Incremento em decimal
            }
