...
<body>
    <div class="container mt-5 main-container">
        <div class="left-container">
            ...
            <!-- Título "Usuários" para o campo de seleção -->
            <label for="usuarioSelect" class="form-label">Usuários</label>
        ...
        async function loadEvents(fetchInfo, successCallback, failureCallback) {
            try {
                ...
                if (selectedUserIds.length === 0) {
                    // Se nenhum usuário for selecionado, exibe todos os eventos
                    selectedUserIds = ['0'];  // Aqui assumimos que '0' vai retornar todos os eventos
                }
                ...
                const query = `
                    ...
                    WHERE cal.usuario IN (${selectedUserIds.join(',')})`;  // Interpolação direta dos IDs selecionados
