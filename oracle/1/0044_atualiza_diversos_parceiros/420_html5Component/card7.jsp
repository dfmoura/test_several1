                ...
                <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                    ...
                    <body>
                        ...
                        CASE 
                            ...
                            WHEN DTVENC < SYSDATE AND DHBAIXA IS NULL THEN DTVENC-SYSDATE/*'Aberto Vencido'*/
                            WHEN (DTVENC - DHBAIXA) > 0 AND DHBAIXA IS NOT NULL THEN DTVENC - DHBAIXA /*'Antecipação'*/
                            WHEN (DTVENC - DHBAIXA) < 0 AND DHBAIXA IS NOT NULL THEN DTVENC - DHBAIXA /*'Pago em atraso'*/
                            WHEN (DTVENC - DHBAIXA) = 0 AND DHBAIXA IS NOT NULL THEN DTVENC - DHBAIXA /*'No dia'*/
                        END AS DIAS_EM_ATRASO,
                        CASE 
                            /*WHEN DTVENC > SYSDATE AND DHBAIXA IS NULL THEN 'A vencer'*/
                        ...
                        AND
                        (
                        (DTVENC < SYSDATE AND DHBAIXA IS NULL)/*'Aberto Vencido'*/
                        OR ((DTVENC - DHBAIXA) > 0 AND DHBAIXA IS NOT NULL) /*'Antecipação'*/
                        OR ((DTVENC - DHBAIXA) < 0 AND DHBAIXA IS NOT NULL) /*'Pago em atraso'*/
                        OR ((DTVENC - DHBAIXA) = 0 AND DHBAIXA IS NOT NULL) /*'No dia'*/
                        )                      
