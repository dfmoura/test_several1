  ...
  <body>
    ...
    <header>
      ...
      <div class="header-actions">
        <button class="filtro-btn" data-situacao="Prod. Não Iniciada">
          Prod. Não Iniciada
        </button>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll(".filtro-btn").forEach((btn) => {
          btn.addEventListener("click", function () {
            ...
            } else if (filtroAtual === "Agd. Aceite") {
      ...
      // Executa "Iniciar produção" na guia Agd. Aceite: IniciarProducaoBTFromParam (id. botão 306), IDIPROC e IDIATV quando houver.
