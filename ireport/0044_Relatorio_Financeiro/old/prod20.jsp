        ...
        async function gerarPDF() {
            try {
                ...
                const canvas = await html2canvas(header, {
                    ...
                    useCORS: true,
                    allowTaint: true,
                    backgroundColor: '#2c3e50' // Garante fundo escuro para logo branca
                });
                ...
                document.querySelectorAll("#data-table tbody tr").forEach(tr => {
                    ...
                    // Somar valores para calcular total
                    if (cells.length > 5) {
                ...
                doc.autoTable({
                    ...
                    didParseCell: function(data) {
                        ...
                        if (data.column.index === 5) {
                            ...
                            const isNeg = cellText.includes('(') || cellText.startsWith('-');
                            data.cell.styles.textColor = isNeg ? [231, 76, 60] : [39, 174, 96];
                        }
                    },
                    columnStyles: {
                        0: { cellWidth: 15 },
                ...
                // Adicionar linha de total usando o valor calculado no JSP
                const jspTotal = parseFloat(`${total}`);
                const finalTotal = isNaN(jspTotal) ? pdfTotal : jspTotal;
                const totalFormatted = finalTotal.toLocaleString('pt-BR', {
                ...
                doc.autoTable({
                    ...
                    body: [[
                        ...
                        {content: finalTotal >= 0 ? totalFormatted : `(${Math.abs(finalTotal).toLocaleString('pt-BR', {minimumFractionDigits: 2, maximumFractionDigits: 2})})`,
