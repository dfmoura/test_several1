      ...
      <tbody>
        <c:forEach var="row" items="${base.rows}">
          <tr class="border-b border-green-100 hover:bg-green-50 transition">
            ...
            <td class="px-3 py-2 whitespace-nowrap text-center">
              <input type="text" class="row-dtvigor border border-green-300 rounded px-2 py-1 w-32 focus:outline-none focus:ring-2 focus:ring-green-400 text-center" value="" placeholder="dd/mm/aaaa" maxlength="10" />
            </td>
          </tr>
        </c:forEach>
      </tbody>
