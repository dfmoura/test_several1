    ...
    (function() {
      ...
      function buildSQL(dtInicio, dtFim) {
        return [
          ...
          "  F.CODNAT,",
          "  NAT.DESCRNAT,",
          "  NVL(SUM(CASE WHEN F.RECDESP = -1 THEN F.VLRBAIXA * -1 ELSE F.VLRBAIXA END), 0) AS VLRBAIXA",
          "FROM TGFFIN F",
      ...
      function buildSQLDetalheNatureza(dtInicio, dtFim, codnat, codcencus) {
        return [
          ...
          "  F.CODPARC,",
          "  PAR.NOMEPARC,",
          "  (CASE WHEN F.RECDESP = -1 THEN F.VLRBAIXA * -1 ELSE F.VLRBAIXA END) AS VLRBAIXA",
          "FROM TGFFIN F",
          "INNER JOIN TGFNAT NAT ON F.CODNAT = NAT.CODNAT",
      ...
      function exportarDetalheExcel() {
        ...
        var dados = [[
          'NUFIN', 'NUNOTA', 'NUMNOTA', 'CODNAT', 'DESCRNAT', 'DHBAIXA', 'CODPARC', 'NOMEPARC', 'VLRBAIXA'
        ]];
