...
<body>
    <snk:query var="fat_det">
        ...
        (
        SELECT
        CODEMP,EMPRESA,NUNOTA,DTNEG,AD_TPPROD,TIPOPROD,CODPROD,DESCRPROD,CODGER,GERENTE,CODPARC,NOMEPARC AS PARCEIRO,QTDNEG,ROUND((VLRDESC/NULLIF(QTDNEG,0)),4) AS VLRDESC_UN,VLRDESC
