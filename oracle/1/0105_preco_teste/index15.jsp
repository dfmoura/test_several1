...
<body>
  <div class="container mx-auto py-8">
    ...
    <div class="filter-container">
      <div class="filter-header" onclick="toggleAllFilters()">
        <span class="toggle-icon">▼</span>
        <span>Filtros</span>
      </div>
      <div class="filter-content" id="allFilterContent">
        <!-- Filtros Básicos -->
        ...
        <!-- Filtros Múltiplos -->
        <div class="mb-4" style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #eee;">
  ...
  <script>
    ...
    function toggleAllFilters() {
      const content = document.getElementById('allFilterContent');
