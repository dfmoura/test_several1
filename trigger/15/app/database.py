...
class OrgaoConsolidado(Base):
    """Entidade canônica de órgão/unidade — une Portal, Compras.gov e Power BI."""
...
FONTES_MODALIDADE_VINCULO = frozenset({"portal", "compras_api", "powerbi"})


class ModalidadeConsolidada(Base):
    """Entidade canônica de modalidade — une Portal, Compras.gov e Power BI."""
