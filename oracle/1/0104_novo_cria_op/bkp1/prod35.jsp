    ...
    <script>
      ...
      function montarConteudoOverlayIniciadas(op, body, dadosGeral) {
        ...
        body.innerHTML =
          ...
          '<div class="apontamentos-tabela-wrap" id="apontamentosTabelaCabecWrap" style="display:none;"><table class="apontamentos-tabela" id="apontamentosTabelaCabec"><thead><tr><th>NUAPO</th><th>DHAPO</th><th>CODUSU</th><th>NOMEUSU</th><th>DESC_SITUACAO</th><th>Ação</th></tr></thead><tbody id="apontamentosTbodyCabec"></tbody></table></div>' +
          '</div>' +
