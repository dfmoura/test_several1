...
<snk:query var="detalhe">
	select 
	CODEMP,NOMEFANTASIA,MARCA,AD_QTDVOLLT,
	ESTOQUE,VENDA_PER_GIRO,DU,round(GIRO,2)GIRO,DU_GIRO,round(EST_MIN,2)EST_MIN,round(VAR_META,2)VAR_META,round(EST_MIN_COM_VAR,2)EST_MIN_COM_VAR
