  ...
  <body>
        ...
        <div class="row">
          <div class="col-lg-12 mb-3">
            <div class="chart-container" id="variablesContainer">
              ...
              <div id="gridVariablesCardsContainer">
    ...
    <script>
      ...
      async function loadGridVariablesData() {
        try {
          ...
          const sql = `
                    ...
                    SELECT 
                    'JOAO DAS COUVE' DESCRVAR,
                    100 ATING_VAR,
                    83 AS PERC_ATING_VAR,
                    70000 BENEFICIO_REAL,
                    150000 BENEFICIO_PREVISTO
                    FROM DUAL

                    UNION ALL

                    SELECT 
                    'SENHOR DO TOMATE' DESCRVAR,
                    10 ATING_VAR,
                    3 AS PERC_ATING_VAR,
                    8200 BENEFICIO_REAL,
                    20000 BENEFICIO_PREVISTO
                    FROM DUAL

                    UNION ALL

                    SELECT 
                    'MAQUINDA DA VERDADE' DESCRVAR,
                    30 ATING_VAR,
                    55 AS PERC_ATING_VAR,
                    35000 BENEFICIO_REAL,
                    99000 BENEFICIO_PREVISTO
                    FROM DUAL
      ...
      function renderGridVariablesCards() {
        ...
        // Criar cards em grid de 5 por linha
      ...
      function adjustVariablesContainerHeight() {
        ...
        // Calcular altura baseada no número de cards e linhas
        ...
        // Calcular número de linhas (5 cards por linha em telas grandes)
        const cardsPerRow = 5;
        const numRows = Math.ceil(numCards / cardsPerRow);

        // Altura base: título (60px) + padding (30px)
        const baseHeight = 90;

        // Altura por linha: altura do card (90px) + margin bottom (10px)
        const heightPerRow = 100;

        // Calcular altura total necessária
        const totalHeight = baseHeight + numRows * heightPerRow;
