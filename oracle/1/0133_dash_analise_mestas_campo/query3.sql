...
CODPARC, PARCEIRO, CLASCOMERCIAL, ESTADO, TIPO, APLICACAO, NOMECID,UF
...
WHERE (VGF.CODCENCUS = :P_CR OR :P_CR IS NULL)
  ...
  GROUP BY MET.CODMETA,MET.DTREF,VEN.CODVEND,VEN.APELIDO,VEN.AD_VENDEDOR_MATRIZ,NVL(VEN.CODGER,0),NVL(MET.CODPARC,0),NVL(PAR.RAZAOSOCIAL,0),NVL(MET.MARCA,0),NVL(VGF.CODGRUPOPROD,MAR.AD_GRUPOPROD),NVL(VGF.CODCENCUS,0), NVL(MET.QTDPREV,0), NVL(PRC.VLRVENDALT,0), F_DESCROPC('TGFPAR','AD_CLASCOMERCIAL',PAR.AD_CLASCOMERCIAL),
...
GROUP BY CODPARC, PARCEIRO, CLASCOMERCIAL, ESTADO, TIPO, APLICACAO, NOMECID,UF
