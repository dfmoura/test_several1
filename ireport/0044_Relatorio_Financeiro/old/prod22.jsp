...
<body>
    ...
    <script>
        ...
        async function gerarPDF() {
            try {
                ...
                doc.autoTable({
                    ...
                    didParseCell: function(data) {
                        ...
                        if (data.column.index === 5) {
                            ...
                            // Verificar se o valor é negativo analisando o texto
                ...
                if (totalElement) {
                    ...
                    // Fallback: tentar capturar de qualquer elemento do footer
                ...
                // Se ainda não encontrou o total, usar a variável global
                ...
                // Garantir que temos um total para exibir
                if (totalText) {
        ...
        // Função para capturar o total quando a página carregar
        function capturarTotal() {
            // Primeira tentativa: elemento oculto com dados precisos
            ...
            if (hiddenTotal) {
                ...
                if (!isNaN(totalNumerico)) {
                    ...
                    console.log('Total capturado do elemento oculto:', totalCalculado);
                    return;
                }
            }
            
            // Segunda tentativa: elemento visível
            const totalElement = document.querySelector('#total-value');
            if (totalElement) {
                const totalText = totalElement.textContent.trim();
                const numeroLimpo = totalText.replace(/\./g, '').replace(',', '.');
                totalCalculado = parseFloat(numeroLimpo);
                console.log('Total capturado do elemento visível:', totalCalculado, 'Texto original:', totalText);
                return;
            }
            
            console.warn('Não foi possível capturar o total');
        }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setTimeout(() => {
                ...
                // Capturar o total após a página carregar
