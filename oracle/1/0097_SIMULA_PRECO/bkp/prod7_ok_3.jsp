    ...
    <table id="dataTable" class="min-w-full table-auto fixed-header bg-white rounded-lg shadow overflow-x-auto">
      <thead>
        <tr class="bg-green-200 text-green-900">
          <th class="px-3 py-2">Cód. Tab.</th>
          <th class="px-3 py-2">Tabela</th>
          <th class="px-3 py-2">Cód. Prod.</th>
          <th class="px-3 py-2">Produto</th>
          <th class="px-3 py-2">Marca</th>
          <th class="px-3 py-2">Vol. LT</th>
          <th class="px-3 py-2">Ponderação</th>
          <th class="px-3 py-2">Dt. Vigor</th>
          <th class="px-3 py-2">Custo Satis</th>
          <th class="px-3 py-2">Preço Tab.</th>
          <th class="px-3 py-2">Margem</th>
          <th class="px-3 py-2">Preço Tab. (-15%)</th>
          <th class="px-3 py-2">Marge (-15%)</th>
          <th class="px-3 py-2">Preço Tab. (-35%)</th>
          <th class="px-3 py-2">Margem (-35%)</th>
          <th class="px-3 py-2">Ticket Méd. Objetivo</th>
          <th class="px-3 py-2">Ticket Méd. Últ. 12M</th>
          <th class="px-3 py-2">Ticket Méd. Safra</th>
          <th class="px-3 py-2">Custo Satis Atual</th>
