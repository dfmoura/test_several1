...
FROM (
    SELECT
        ...
        CASE
            ...
            WHEN HIERARQUIA = '5.1' THEN
                (VALOR_ATUAL - VALOR_ANTERIOR) + COALESCE(SUM_27_ATUAL, 0)
            WHEN HIERARQUIA = '5.2' THEN
                (VALOR_ATUAL - VALOR_ANTERIOR)
            WHEN HIERARQUIA = '5.3' THEN
                (VALOR_ATUAL - VALOR_ANTERIOR)
        ...
        CASE
            ...
            WHEN HIERARQUIA = '5.1' THEN
                (VALOR_ANTERIOR - VALOR_ANTERIOR_ANTERIOR) + COALESCE(SUM_27_ANTERIOR, 0)
            WHEN HIERARQUIA = '5.2' THEN
                (VALOR_ANTERIOR - VALOR_ANTERIOR_ANTERIOR)
            WHEN HIERARQUIA = '5.3' THEN
                (VALOR_ANTERIOR - VALOR_ANTERIOR_ANTERIOR)
    ...
    FROM (
        SELECT
            ...
            SUM(
                CASE
                    WHEN a.HIERARQUIA = '10.1' THEN (a.VALOR_ATUAL - a.VALOR_ANTERIOR)
                    ELSE 0
                END
            ...
            SUM(
                CASE
                    WHEN a.HIERARQUIA = '10.1' THEN (a.VALOR_ANTERIOR - a.VALOR_ANTERIOR_ANTERIOR)
                    ELSE 0
                END
            ...
            SUM(
                CASE
                    WHEN a.HIERARQUIA = '2.6' THEN a.VALOR_ATUAL * a.sinal
                    ELSE 0
                END
            ...
            SUM(
                CASE
                    WHEN a.HIERARQUIA = '2.6' THEN a.VALOR_ANTERIOR * a.sinal
                    ELSE 0
                END
            ...
            SUM(
                CASE
                    WHEN a.HIERARQUIA = '2.7' THEN a.VALOR_ATUAL
                    ELSE 0
                END
            ) OVER () AS SUM_27_ATUAL,

            SUM(
                CASE
                    WHEN a.HIERARQUIA = '2.7' THEN a.VALOR_ANTERIOR
                    ELSE 0
                END
            ) OVER () AS SUM_27_ANTERIOR
