...
/** Navegação primária — cadeia feliz; compras/estoque no fim (suporte). */
const PRIMARY_NAV: NavItem[] = [
  ...
  { href: "/producao", label: "Produção", matchPrefix: true },
...
const DRAWER_SECTIONS: { label: string; items: NavItem[] }[] = [
  ...
  {
    label: "Suporte (quando OP precisa)",
    items: [
      { href: "/estoque", label: "Estoque", matchPrefix: true },
      { href: "/compras", label: "Compras", matchPrefix: true },
    ],
    ...
    <header className="app-chrome">
      <div className="app-chrome-inner">
        <div className="topbar-start">
          ...
          {brand?.codigo && (
            <span className="emp-badge" title={brand.cnpjFormatado ?? brand.nomeFantasia}>
              {brand.codigo}
            </span>
          )}
      ...
      >
        <div className="nav-drawer-head">
          <div>
            ...
            {brand?.codigo && (
              <p className="nav-drawer-emp">
                {brand.codigo}
                {brand.cnpjFormatado ? ` · ${brand.cnpjFormatado}` : ""}
              </p>
            )}
