      SELECT 
        ...
        SELECT
          CODPROD,
          CODEMP,
          OBTEMCUSTO_SATIS(CODPROD, 'S', CODEMP, 'N', 0, 'N', ' ', '02/09/2025', 3) AS CUSTO_SATIS,
          ROW_NUMBER() OVER (PARTITION BY CODEMP, CODPROD ORDER BY DTATUAL DESC) AS RN
        FROM TGFCUS
        WHERE DTATUAL <= TO_DATE('02/09/2025', 'DD/MM/YYYY')
        AND CODEMP = 1 
        )
        WHERE RN = 1
        ),
        ...
        WHERE DTNEG >= ADD_MONTHS(TO_DATE('02/09/2025', 'DD/MM/YYYY'), -12)
        AND DTNEG < TO_DATE('02/09/2025', 'DD/MM/YYYY')
        AND CODEMP =  1 
        ...
        AND MET.DTREF BETWEEN 
            CASE 
                WHEN EXTRACT(MONTH FROM TO_DATE('02/09/2025', 'DD/MM/YYYY')) <= 6 
                THEN TRUNC(TO_DATE('02/09/2025', 'DD/MM/YYYY'), 'YYYY') - INTERVAL '6' MONTH
                ELSE TRUNC(TO_DATE('02/09/2025', 'DD/MM/YYYY'), 'YYYY') + INTERVAL '6' MONTH
            END
        AND 
        CASE 
            WHEN EXTRACT(MONTH FROM TO_DATE('02/09/2025', 'DD/MM/YYYY')) <= 6 
            THEN LAST_DAY(TRUNC(TO_DATE('02/09/2025', 'DD/MM/YYYY'), 'YYYY') + INTERVAL '5' MONTH)
            ELSE LAST_DAY(TRUNC(TO_DATE('02/09/2025', 'DD/MM/YYYY'), 'YYYY') + INTERVAL '17' MONTH)
        END
        ...
        FROM VGF_VENDAS_SATIS
        WHERE 
        DTNEG >= ADD_MONTHS(TO_DATE('02/09/2025', 'DD/MM/YYYY'), -12)
        AND DTNEG < TO_DATE('02/09/2025', 'DD/MM/YYYY')
        AND CODEMP =  1 
        ...
        TAB.DTVIGOR,
        NVL(SNK_GET_PRECO(TAB.NUTAB, PRO.CODPROD, TO_DATE('02/09/2025', 'DD/MM/YYYY')), 0) AS PRECO_TAB,
        ...
        AND PRO.ATIVO = 'S'
        AND TAB.DTVIGOR <= TO_DATE('02/09/2025', 'DD/MM/YYYY')
