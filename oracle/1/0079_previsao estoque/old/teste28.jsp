...
<snk:query var="detalhe">
    ...
    /*round(EST_MIN_COM_VAR,2)EST_MIN_COM_VAR,*/
    VAR_META
    ...
    SELECT
        ...
        ((
            ...
            AS EST_MIN,        
                    ...
                    (
                        SELECT
                        FUN_CALC_VAR_SATIS(QTDPREV2,QTDPREV1) VAR_META
                        
                        FROM(
                        
                        SELECT
                        MARCA,
                        SUM(CASE WHEN DTREF BETWEEN :P_PERIODO.INI AND :P_PERIODO.FIN THEN QTDPREV ELSE 0 END) AS QTDPREV1,
                        SUM(CASE WHEN DTREF BETWEEN :P_PERIODO1.INI AND :P_PERIODO1.FIN THEN QTDPREV ELSE 0 END) AS QTDPREV2
                        FROM (
                        SELECT
                        ...
                        WHERE codmeta = 4  
                          AND (
                              (DTREF BETWEEN :P_PERIODO.INI AND :P_PERIODO.FIN)
                              OR 
                              (DTREF BETWEEN :P_PERIODO1.INI AND :P_PERIODO1.FIN)
                          )
                        AND QTDPREV > 0
