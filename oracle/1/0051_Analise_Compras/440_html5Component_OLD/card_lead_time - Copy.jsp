...
SUM(VLRFRETE_POR_ITEM) AS VLRFRETE_POR_ITEM,
AVG(PERC_VLRFRETE_POR_ITEM_NA_NOTA) AS PERC_VLRFRETE_POR_ITEM_NA_NOTA
...
NULL AS PED_TO_NOTA,
NULL AS TOTAL_DIAS,
NULL AS VLRFRETE_POR_ITEM,
NULL AS PERC_VLRFRETE_POR_ITEM_NA_NOTA
...
NULL AS PED_TO_NOTA,
NULL AS TOTAL_DIAS,
ROUND(SUM(VLRFRETE_POR_ITEM),2) AS VLRFRETE_POR_ITEM,
ROUND(AVG(PERC_VLRFRETE_POR_ITEM_NA_NOTA),2) AS PERC_VLRFRETE_POR_ITEM_NA_NOTA
		...
		<div class="header-card" >
			...
			<div class="header-card-right">
				...
				<h3>
					...
					Frete: R$ ${row.VLRFRETE_POR_ITEM} | % ${row.PERC_VLRFRETE_POR_ITEM_NA_NOTA}
				</h3>
			</div>
