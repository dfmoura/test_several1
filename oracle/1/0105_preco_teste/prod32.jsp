  ...
  <div id="loadSimulationModal" class="status-overlay">
    <div class="status-content" style="max-width: 800px; width: 90%; max-height: 80vh;">
      ...
      <div class="status-message" style="text-align: left;">
        ...
        <div style="max-height: 400px; overflow-y: auto; border: 1px solid #e5e7eb; border-radius: 6px; margin-bottom: 15px;">
          <table id="simulationTable" style="width: 100%; border-collapse: collapse; font-size: 12px;">
            <thead style="background-color: #f3f4f6; position: sticky; top: 0;">
              <tr>
                ...
                <th style="padding: 8px; border: 1px solid #e5e7eb; text-align: left;">Nome Fantasia</th>
                <th style="padding: 8px; border: 1px solid #e5e7eb; text-align: left;">Período</th>
                <th style="padding: 8px; border: 1px solid #e5e7eb; text-align: left;">Parceiro</th>
              </tr>
            </thead>
  ...
  document.getElementById('statusOverlay').style.display = 'none';
    ...
    function renderSimulationTable(simulations) {
      ...
      simulations.forEach(simulation => {
        ...
        row.innerHTML = `
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.CODIGO}</td>
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.CODUSU}</td>
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.NOMEUSU || '-'}</td>
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.DHSIM || '-'}</td>
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.DESCRICAO || '-'}</td>
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.CODEMP}</td>
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.NOMEFANTASIA || '-'}</td>
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.PERIODO || '-'}</td>
          <td style="padding: 8px; border: 1px solid #e5e7eb;">${simulation.CODPARC || '-'}</td>
        `;
