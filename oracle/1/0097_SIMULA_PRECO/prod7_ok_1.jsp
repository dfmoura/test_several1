...
ORDER BY 1,5,3 DESC
  ...
  <div class="w-full max-w-7xl px-2 mb-4">
  ...
  <div class="w-full max-w-7xl scroll-x">
    <table id="dataTable" class="min-w-full table-auto fixed-header bg-white rounded-lg shadow overflow-x-auto">
      <thead>
        <tr class="bg-green-200 text-green-900">
          <th class="px-3 py-2">CODTAB</th>
          <th class="px-3 py-2">NOMETAB</th>
          <th class="px-3 py-2">CODPROD</th>
          <th class="px-3 py-2">DESCRPROD</th>
          <th class="px-3 py-2">MARCA</th>
          <th class="px-3 py-2">AD_QTDVOLLT</th>
          <th class="px-3 py-2">POND_MARCA</th>
          <th class="px-3 py-2">DTVIGOR</th>
          <th class="px-3 py-2">CUSTO_SATIS</th>
          <th class="px-3 py-2">PRECO_TAB</th>
          <th class="px-3 py-2">MARGEM</th>
          <th class="px-3 py-2">PRECO_TAB_MENOS15</th>
          <th class="px-3 py-2">MARGEM_MENOS15</th>
          <th class="px-3 py-2">PRECO_TAB_MENOS65</th>
          <th class="px-3 py-2">MARGEM_MENOS65</th>
          <th class="px-3 py-2">TICKET_MEDIO_OBJETIVO</th>
          <th class="px-3 py-2">TICKET_MEDIO_ULT_12_M</th>
          <th class="px-3 py-2">TICKET_MEDIO_SAFRA</th>
          <th class="px-3 py-2">CUSTO_SATIS_ATU</th>
          <th class="px-3 py-2">Nova Margem (%)</th>
          <th class="px-3 py-2">Novo Preço (R$)</th>
        </tr>
      </thead>
      <tbody>
        <c:forEach var="row" items="${base.rows}">
          <tr class="border-b border-green-100 hover:bg-green-50 transition">
            <td class="px-3 py-2 whitespace-nowrap">${row.CODTAB}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.NOMETAB}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.CODPROD}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.DESCRPROD}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.MARCA}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.AD_QTDVOLLT}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.POND_MARCA}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.DTVIGOR}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.CUSTO_SATIS}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.PRECO_TAB}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.MARGEM}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.PRECO_TAB_MENOS15}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.MARGEM_MENOS15}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.PRECO_TAB_MENOS65}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.MARGEM_MENOS65}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.TICKET_MEDIO_OBJETIVO}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.TICKET_MEDIO_ULT_12_M}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.TICKET_MEDIO_SAFRA}</td>
            <td class="px-3 py-2 whitespace-nowrap">${row.CUSTO_SATIS_ATU}</td>
            <td class="px-3 py-2 whitespace-nowrap">
              <input type="number" step="0.01" class="row-margin border border-green-300 rounded px-2 py-1 w-24 focus:outline-none focus:ring-2 focus:ring-green-400" value="" data-custo="${row.CUSTO_SATIS_ATU}" />
            </td>
            <td class="px-3 py-2 whitespace-nowrap">
              <input type="number" step="0.01" class="row-price border border-green-300 rounded px-2 py-1 w-24 focus:outline-none focus:ring-2 focus:ring-green-400" value="" data-custo="${row.CUSTO_SATIS_ATU}" />
            </td>
          </tr>
        </c:forEach>
      </tbody>
