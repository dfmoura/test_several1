...
<body>
    ...
    (
    SELECT
    VGF.CODEMP,VGF.EMPRESA,VGF.CODTIPOPER,VGF.DESCROPER,VGF.CUSMEDSICM_TOT
    ...
    <snk:query var="custo_emp">
        ...
        (
        SELECT
        VGF.CODEMP,SUBSTR(VGF.EMPRESA,1,18)EMPRESA,VGF.CODTIPOPER,VGF.DESCROPER,VGF.CUSMEDSICM_TOT
        FROM VGF_CONSOLIDADOR_NOTAS_GM VGF
        INNER JOIN TGFPAR PAR ON VGF.CODPARC = PAR.CODPARC
        LEFT JOIN TGFPAR PARM ON PAR.CODPARCMATRIZ = PARM.CODPARC
        WHERE
...
<snk:query var="custo_tipo">
    ...
    (
    SELECT
    VGF.CODEMP,SUBSTR(VGF.EMPRESA,1,18)EMPRESA,VGF.CODTIPOPER,VGF.DESCROPER,VGF.AD_TPPROD,VGF.TIPOPROD,VGF.CUSMEDSICM_TOT
    FROM VGF_CONSOLIDADOR_NOTAS_GM VGF
    INNER JOIN TGFPAR PAR ON VGF.CODPARC = PAR.CODPARC
    LEFT JOIN TGFPAR PARM ON PAR.CODPARCMATRIZ = PARM.CODPARC
    WHERE
...
<snk:query var="custo_produto">  
    ...
    (
        SELECT
        VGF.CODEMP,VGF.EMPRESA,VGF.CODTIPOPER,VGF.DESCROPER,VGF.AD_TPPROD,VGF.TIPOPROD,VGF.CODPROD,VGF.DESCRPROD,VGF.CUSMEDSICM_TOT
        FROM VGF_CONSOLIDADOR_NOTAS_GM VGF
        INNER JOIN TGFPAR PAR ON VGF.CODPARC = PAR.CODPARC
        LEFT JOIN TGFPAR PARM ON PAR.CODPARCMATRIZ = PARM.CODPARC
        WHERE
