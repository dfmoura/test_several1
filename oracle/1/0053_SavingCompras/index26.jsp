...
<body>
    ...
    <snk:query var="ganho_evol_produto">
        ...
        SELECT 
         ...
         WHERE CAB.TIPMOV = 'O'
           ...
           AND ITE.VLRDESC > 0 ORDER BY GANHO_EVOLUCAO DESC)
           
    SELECT PRODUTO, SUM(GANHO_EVOLUCAO) AS GANHO_EVOLUCAO 
    FROM BAS WHERE ROWNUM <= 10 GROUP BY PRODUTO ORDER BY GANHO_EVOLUCAO DESC
    ...
    SELECT PARCEIRO, SUM(GANHO_EVOLUCAO) AS GANHO_EVOLUCAO 
    FROM BAS WHERE ROWNUM <= 10 GROUP BY PARCEIRO  ORDER BY GANHO_EVOLUCAO DESC
