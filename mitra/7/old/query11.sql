...
SELECT
    ...
    /* =====================================================
       COLUNAS BASE
    ===================================================== */
    valor_base_atual / 1000 AS valor_base_atual,
    valor_base_anterior / 1000 AS valor_base_anterior,
    valor_base_anterior2 / 1000 AS valor_base_anterior2,

    /* =====================================================
       VALOR ANO ATUAL
       REGRA ESPECIAL PARA 5.1
    ===================================================== */
    CASE

        WHEN ORDEM = '5.1'
        THEN valor_base_anterior

        WHEN VARIACAO = 'Sim'
        THEN valor_base_anterior - valor_base_atual

        ELSE valor_base_atual
    ...
    CASE
        ...
        WHEN ORDEM = '5.1'
        THEN valor_base_anterior2

        WHEN VARIACAO = 'Sim'
        THEN valor_base_anterior2 - valor_base_anterior

        ELSE valor_base_anterior
