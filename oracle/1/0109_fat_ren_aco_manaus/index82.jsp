  ...
  AND (NUNOTA = :P_NUNOTA OR :P_NUNOTA IS NULL)
    ...
    <div class="container">
        <div class="section">
            <div class="part" id="left-top">
                <div class="part-title">Custos Grupo Produto</div>
            ...
            <div class="part" id="left-bottom">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                    <div class="part-title">Custos - ${row.descrgrupo_nivel1} - Empresa</div>
                </c:forEach>
                <div class="chart-container">
        ...
        <div class="section">
            <div class="part" id="right-top">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                <div class="part-title">Custos ${row.descrgrupo_nivel1} - Vendedores</div>
            </c:forEach>
                <div class="chart-container">
            ...
            <div class="part" id="right-bottom">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                    <div class="part-title">Custos ${row.descrgrupo_nivel1} - Produtos</div>
                </c:forEach>
    ...
    <script>
        ...
        function ref_fat1(TIPOPROD) {
            ...
            refreshDetails('html5_af0k64z', params1); 
