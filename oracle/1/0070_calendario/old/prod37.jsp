...
<body>
    ...
    <script>
        ...
        async function loadEvents(fetchInfo, successCallback, failureCallback) {
            try {
                const data = await JX.consultar(`SELECT 
                ...
                // Filtra eventos com base nos IDs de usuários selecionados
                const filteredEvents = data
                    .filter(item => selectedUserIds.length === 0 || selectedUserIds.includes(item.USUARIO))
                    .map(item => ({
