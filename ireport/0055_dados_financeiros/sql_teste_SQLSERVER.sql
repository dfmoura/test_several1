-- Razão Auxiliar das Contas - Convertido para SQL Server
-- Consulta principal convertida de Oracle para SQL Server
SELECT	P.CODEMP,
		P.CODCTACTB,
		P.CTACTB,
...
FROM
(
-- Pega as Contas de Ativo - Saldo Anterior
SELECT	LAN.CODEMP,
		LAN.CODCTACTB,
...
-- Pega as Contas de Ativo - Movimentações do Período
SELECT	LAN.CODEMP,
		LAN.CODCTACTB,
		CAST(PLA.CTACTB AS VARCHAR(50)) AS CTACTB,
		CAST(PLA.DESCRCTA AS VARCHAR(MAX)) AS DESCRCTA,
...
-- Pega as Contas de Passivo - Saldo Anterior
SELECT	LAN.CODEMP,
		LAN.CODCTACTB,
		CAST(PLA.CTACTB AS VARCHAR(50)) AS CTACTB,
		CAST(PLA.DESCRCTA AS VARCHAR(MAX)) AS DESCRCTA,
...
-- Pega as Contas de Passivo - Movimentações do Período
SELECT	LAN.CODEMP,
		LAN.CODCTACTB,
		CAST(PLA.CTACTB AS VARCHAR(50)) AS CTACTB,
		CAST(PLA.DESCRCTA AS VARCHAR(MAX)) AS DESCRCTA,
