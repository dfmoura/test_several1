...
export const EMPRESA_SEED_ID = "seed-empresa-matriz";
...
/** Resolve a empresa raiz ativa (matriz). Single-tenant fase 1. */
...
export function serializeEmpresaBrand(
  e: Pick<Empresa, "id" | "nomeFantasia" | "razaoSocial" | "cnpj" | "ambienteFiscal" | "simularProducao">,
) {
  return {
    id: e.id,
    nomeFantasia: e.nomeFantasia,
