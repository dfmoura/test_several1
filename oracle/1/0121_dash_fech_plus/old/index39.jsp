...
<html lang="pt">
  <head>
    ...
    <style>
      ...
      .variable-detail-value.currency {
        color: #28a745;
      }

      .variable-detail-value.number {
        color: #007bff;
      }
  ...
  <body>
    ...
    <div class="main-container">
      ...
      <!-- Seção de Cards Dinâmicos de Variáveis -->
        ...
        <div class="row">
          <div class="col-lg-12 mb-3">
            <div class="chart-container">
              ...
              <div id="variablesCardsContainer">
    ...
    <script>
      ...
      // Função para carregar dados das variáveis de benefício
      async function loadVariablesData() {
        try {
          ...
          if (data && data.length > 0) {
            ...
            window.variablesData = data.map((item) => ({
            ...
            // Renderizar cards das variáveis
            renderVariablesCards();
          } else {
            // Mostrar mensagem quando não há dados
            document.getElementById("variablesCardsContainer").innerHTML = `
              <div class="text-center py-4">
                <i class="fas fa-info-circle text-muted" style="font-size: 48px;"></i>
                <p class="mt-3 text-muted">Nenhuma variável de benefício encontrada para o período selecionado.</p>
              </div>
            `;
          }
        } catch (error) {
          ...
          document.getElementById("variablesCardsContainer").innerHTML = `
            <div class="text-center py-4">
              ...
              <p class="mt-3 text-muted">Erro ao carregar dados das variáveis. Tente novamente.</p>
            </div>
          `;
        }
      }

      // Função para renderizar cards das variáveis dinamicamente
      function renderVariablesCards() {
        const container = document.getElementById("variablesCardsContainer");

        if (!window.variablesData || window.variablesData.length === 0) {
          container.innerHTML = `
            <div class="text-center py-4">
              <i class="fas fa-info-circle text-muted" style="font-size: 48px;"></i>
              <p class="mt-3 text-muted">Nenhuma variável de benefício encontrada.</p>
            </div>
          `;
          return;
        }

        // Criar grid responsivo para os cards
        const cardsHTML = window.variablesData
          .map((variable, index) => {
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
              <div class="variable-card">
                <div class="variable-card-header">
                  <div class="variable-card-icon">
                    <i class="${icon}"></i>
                  </div>
                  <div class="variable-card-title">${variable.descrvar}</div>
                  <div class="variable-card-percentage">${variable.perc_ating_var.toFixed(
                    1
                  )}%</div>
                </div>
                <div class="variable-card-details">
                  <div class="variable-detail-item">
                    <div class="variable-detail-label">Vendedores com Benefício</div>
                    <div class="variable-detail-value number">${variable.ating_var.toLocaleString(
                      "pt-BR"
                    )}</div>
                  </div>
                  <div class="variable-detail-item">
                    <div class="variable-detail-label">Benefício Real</div>
                    <div class="variable-detail-value currency">${formatCurrency(
                      variable.beneficio_real
                    )}</div>
                  </div>
                  <div class="variable-detail-item">
                    <div class="variable-detail-label">Benefício Previsto</div>
                    <div class="variable-detail-value currency">${formatCurrency(
        ...
        // Renderizar cards em grid responsivo
        container.innerHTML = `
          <div class="row">
            ${cardsHTML}
          </div>
