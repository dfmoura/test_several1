    ...
    <table id="dataTable" class="min-w-full bg-white rounded-lg shadow">
      <thead>
        ...
        <tr class="bg-green-200 text-green-900">
          ...
          <th class="col-margem-12m">Mar. Ult12</th>
          ...
          <th class="col-volume"  style="background-color: #0cc40c; text-align: center;">Volume</th>
          <th class="col-preco-total"  style="background-color: #0cc40c; text-align: center;">Preço Total</th>
        </tr>
      </thead>
  ...
  function collectTableDataForExcel() {
    ...
    rows.forEach(row => {
      ...
      const rowData = {
        ...
        'Custo Atual': convertToBrazilianFormat(cells[19].textContent.trim()),
