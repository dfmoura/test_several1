  ...
  return (
    <div className="shell shell-wide">
      ...
      <header className="jornada-hero">
        <div>
          <p className="jornada-kicker">1 · Suprimentos</p>
          <h1>Compras de insumos</h1>
          <p className="jornada-sub muted">
            Passo 1 do ciclo: necessidades → pedido de compra → NFe → matching → estoque.
            Depois: orçamento → pedido/OS → NF → boleto → entrega → recebimento.
          </p>
          {pedidoFiltro && (
        ...
        <div className="jornada-cta">
          ...
          <Link className="secondary" href="/pedidos">
            Pedidos de venda
          </Link>
        </div>
      </header>
