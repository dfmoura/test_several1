...
<body>
    ...
    <script>
        ...
        document.getElementById("btnSalvar").addEventListener("click", () => {
            ...
            const dataInicio = document.getElementById("DTAINICIO").value;
            const dataFim = document.getElementById("DTAFIM").value;
            const horaInicio = document.getElementById("HRINI").value;
            const horaFim = document.getElementById("HRFIM").value;
            ...
            JX.salvar({
                ...
                HRINI: horaInicio,
                HRFIM: horaFim
            }, 'AD_CALENDINOV', { CODIGO: CodCal }).then(response => {
        ...
        document.getElementById("btnCancelar").addEventListener("click", () => {
            location.reload(); // Recarrega a página para resetar os campos
        });
