    ...
    <script>
      ...
      function renderGridVariablesCards() {
        ...
        const cardsHTML = window.gridVariablesData
          .map((variable, index) => {
            ...
            return `
              <div class="grid-variable-card horizontal-mode">
      ...
      function initializeHorizontalScroll() {
        ...
        function scrollByCards(direction = 1) {
          const cardWidth = 220; // largura do card
      ...
      function adjustVariablesContainerHeight() {
        ...
        // Altura base: título (45px) + padding wrapper (20px)
        const baseHeight = 65;

        // Altura da linha horizontal: altura do card (110px) + padding scroller (20px)
        const scrollerHeight = 130;
