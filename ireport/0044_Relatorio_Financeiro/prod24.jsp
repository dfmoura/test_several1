    ...
    <style>
        * {
        ...
        @media print {
            ...
            .logo img {
                filter: brightness(0) invert(1); /* Garante que a logo fique branca na impressão */
            }
    ...
    <script>
        ...
        async function gerarPDF() {
            try {
                ...
                // Adicionar cabeçalho com fundo escuro
                doc.setFillColor(44, 62, 80);
                doc.rect(0, 0, doc.internal.pageSize.width, 50, 'F');
                
                // Adicionar logo branca (tamanho pequeno: 50x15)
                doc.addImage(whiteLogoData, 'PNG', 15, 15, 50, 15);
                
                // Adicionar título e subtítulo
                doc.setFontSize(20);
                doc.setTextColor(255, 255, 255);
                doc.text('Relatório Financeiro Gerencial', 70, 25);
                doc.setFontSize(12);
                doc.text('Análise detalhada das movimentações financeiras', 70, 32);
