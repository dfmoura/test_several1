...
<html lang="pt">
  ...
  <body>
    ...
    <script>
      ...
      // Carrega parceiros para o multilist (inicialmente sem filtro de data)
      ...
      function applyParceiroSelection() {
        ...
        // Não dispara load imediatamente para permitir combinar com outros filtros
      }
      ...
      async function loadChartsData() {
        try {
          ...
          // Calcular ticket médio previsto e real por mês
      ...
      function updateSummaryCards(dados) {
        ...
        const pctQtd =
          totals.qtdReal > 0 ? (totals.qtdPrev / totals.qtdReal) * 100 : 0;
        const pctVlr =
          totals.vlrReal > 0 ? (totals.vlrPrev / totals.vlrReal) * 100 : 0;

        document.getElementById("pctQtd").textContent = formatPercent(pctQtd);
        document.getElementById("pctVlr").textContent = formatPercent(pctVlr);

        // Calcular ticket médio previsto
      ...
      async function loadData() {
        try {
          ...
          if (result && result.length > 0) {
            ...
            updateMapDisplay();
            // Carregar/atualizar gráficos após dados
            loadChartsData();
      ...
      document.addEventListener("DOMContentLoaded", function () {
        initMap();
        // Preencher automaticamente com a safra atual ao abrir a tela
