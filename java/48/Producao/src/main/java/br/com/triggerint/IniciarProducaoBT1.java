 ...
 * - P_IDIPROC: ID da instância de processo (obrigatório quando chamado remotamente)
 */
public class IniciarProducaoBT1 implements AcaoRotinaJava {
    ...
    public void doAction(ContextoAcao contexto) throws Exception {
        ...
        if (paramIdiproc != null) {
            ...
            chamadaRemota = true;
            System.out.println("Chamada remota detectada - Parâmetro P_IDIPROC recebido: " + paramIdiproc);
            ...
            if (linhas.length == 0) {
                contexto.mostraErro("Nenhum registro foi selecionado na tabela TPRIPROC e nenhum parâmetro P_IDIPROC foi fornecido.");
                return;
            }
