...
ROUND((ABS(VLRFAT)-ABS(VLRDEVOL)-ABS(VLRDESC)-ABS(VLRDO)-ABS(VLRINV)) / (ABS(VLRFAT_MA)-ABS(VLRDEVOL_MA)-ABS(VLRDESC_MA)-ABS(VLRDO_MA)-ABS(VLRINV_MA)),2) AS VAR_RES
...
SELECT
HL,VLRFAT,VLRDESC,VLRDEVOL,HL_MA,VLRFAT_MA,VLRDESC_MA,VLRDEVOL_MA,VLRDO,VLRDO_MA,VLRINV,VLRINV_MA
FROM(
SELECT
1 AS COD
    ...
    <div class="row mt-2">
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="card-footer text-muted">
                    <b>Período Anterior:</b> ${row.VLRDO_MA} <b>Var.:</b> ${row.VAR_VLRDO}
                </div>
            </div>
        </div>
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="card-footer text-muted">
                    <b>Período Anterior:</b> ${row.VLRINV_MA} <b>Var.:</b> ${row.VAR_VLRINV}
                </div>
            </div>
        </div>
    </div>
	...
	<div class="row mt-2">
		...
		<div class="col-lg-10 mb-4">
			<div class="card shadow-sm">
				...
				<div class="card-footer text-muted">
					<b>Período Anterior:</b> ${row.RES_MA} <b>Var.:</b> ${row.VAR_RES}
				</div>
			</div>
		</div>
	</div>
