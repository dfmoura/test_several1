    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            <c:forEach items="${fat_pruduto.rows}" var="row">
                bubbleData.push({
                    x: Math.random() * 100, // This should be replaced with the desired x value
                    y: Math.random() * 100, // This should be replaced with the desired y value
                    r: Math.log(${row.VLRFAT}) * 5, // Adjust the multiplier to get the desired bubble size
                    label: "${row.PRODUTO}"
                });
            </c:forEach>
