    ...
    <script>
      ...
      function montarConteudoDefaultOverlay(op, body) {
        body.innerHTML =
          ...
          (op.descprod || "-") +
          "</span></div>" +
          '<div class="detalhe-item"><span class="detalhe-label">Centro de Trabalho</span><span class="detalhe-valor">' +
      ...
      function montarConteudoOverlayIniciadas(op, body, dadosGeral) {
        ...
        body.innerHTML =
          ...
          '<div class="overlay-campo"><label>Centro de Trabalho</label><input type="text" disabled value="' +
          (codwcp != null ? codwcp : "") +
          '"></div>' +
          '<div class="overlay-campo"><label>Descrição Centro de Trabalho</label><input type="text" disabled value="' +
