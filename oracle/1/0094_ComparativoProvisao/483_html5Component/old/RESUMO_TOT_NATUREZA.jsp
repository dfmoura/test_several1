                                        ...
                                        <tbody id="valoresnat">
                                            <c:forEach items="${valoresnat.rows}" var="row">
                                                <tr onclick="selectNatureza('${row.DESCRNAT}')">
                                                    <td>${row.DESCRNAT}</td>
                                                    <td>
                                                        <fmt:formatNumber value="${row.PROVISAO_RECEITA}"
                                                    ...
                                                    <td>
                                                        <fmt:formatNumber value="${row.DIVER_RECEITA}" type="currency"
                                                            currencySymbol="" groupingUsed="true" minFractionDigits="2"
                                                            maxFractionDigits="2" />
                                                    </td>
                                                    <td>
                                                        <fmt:formatNumber value="${row.PROVISAO_DESPESA}"
                                                            type="currency" currencySymbol="" groupingUsed="true"
                                                            minFractionDigits="2" maxFractionDigits="2" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <fmt:formatNumber value="${row.DIVER_DESPESA}" type="currency"
                                                            currencySymbol="" groupingUsed="true" minFractionDigits="2"
                                                            maxFractionDigits="2" />
                                                    </td>
                                                </tr>
