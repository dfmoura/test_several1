              ...
              <table class="overlay-table">
                <thead>
                  <tr>
                    ...
                    <th class="text-center">% Ating. Qtd</th>
                    <th class="text-center">Vlr Real</th>
                    <th class="text-center">Vlr Prev</th>
                    <th class="text-center">% Ating. Vlr</th>
                    <th class="text-center">Ticket Médio Prev</th>
                    <th class="text-center">Ticket Médio Real</th>
                    <th class="text-center">Var. Ticket Médio</th>
                  </tr>
                </thead>
      ...
      function renderAnalysisVend(rows) {
        ...
        tbody.innerHTML = (rows || [])
          .map((r) => {
            ...
            <td>${r.CODVEND ?? ""}</td>
            <td>${r.APELIDO ?? ""}</td>
            <td class="text-center">${formatNumber(qr)}</td>
            <td class="text-center">${formatNumber(qp)}</td>
            <td class="text-center">${formatPercent(pctQtd)}</td>
            <td class="text-center">${formatCurrency(vr)}</td>
            <td class="text-center">${formatCurrency(vp)}</td>
            <td class="text-center">${formatPercent(pctVlr)}</td>
            <td class="text-center">${formatCurrency(ticketPrev)}</td>
            <td class="text-center">${formatCurrency(ticketReal)}</td>
            <td class="text-center">${formatPercent(variacaoTicket)}</td>
          </tr>`;
          })
          .join("");
      }
