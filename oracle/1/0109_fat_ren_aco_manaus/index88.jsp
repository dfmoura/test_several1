...
<head>
    ...
    <style>
        ...
        .chart-overlay {
            ...
            font-weight: bold;
            color: #333;
            left: 64%; /* Move o overlay 10% para a direita */
...
<body>
    ...
    with bas as (
                ...
                CASE 
                    ...
                    ELSE NAT.DESCRNAT
                END DESCRNAT,
                sum(ISNULL(ROUND(VLRBAIXA, 2), 0) )as VLRINV,
...
<snk:query var="fat_produto">
    ...
    <div class="container">
        <div class="section">
            <div class="part" id="left-top">
                <div class="part-title"> Investimento</div>
                <div class="chart-container">
                    <canvas id="doughnutChart"></canvas>
                    <c:forEach items="${fat_total.rows}" var="row">
                        <div class="chart-overlay"><fmt:formatNumber value="${row.VLRINV}" type="currency" currencySymbol="" groupingUsed="true" minFractionDigits="0" maxFractionDigits="0"/></div>
                    </c:forEach>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${fat_produto.rows}" var="row">
                                <tr>
                                    ...
                                    <td><fmt:formatNumber value="${row.VLRINV}" type="currency" currencySymbol="" groupingUsed="true" minFractionDigits="2" maxFractionDigits="2"/></td>
                                    <c:set var="total" value="${total + row.VLRINV}" />
                                </tr>
                            </c:forEach>
                            <tr>
                                <td><b>Total</b></td>
    ...
    <script>
        ...
        function ref_fat1(TIPOPROD) {
            ...
            refreshDetails('html5_af0k7gp', params1); 
