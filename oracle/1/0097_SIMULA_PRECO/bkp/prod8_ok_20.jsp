  ...
  <div class="w-full px-1 mb-4">
    <div class="flex flex-col md:flex-row md:space-x-4 space-y-2 md:space-y-0 items-center justify-between bg-green-100 rounded-lg p-4 shadow">
      ...
      <div class="flex items-center space-x-2">
        ...
        <input id="tableFilter" type="text" placeholder="Digite para filtrar... (use | para múltiplos termos)" class="border border-green-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-green-400 w-64" />
      </div>
      <div class="flex items-center space-x-2">
