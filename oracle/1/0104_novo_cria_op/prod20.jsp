    ...
    <script>
      ...
      function montarConteudoOverlayIniciadas(op, body, dadosGeral) {
        ...
        body.innerHTML =
          ...
          '<p style="font-size:0.9rem;color:var(--cinza-texto);opacity:0.8;">Apontamentos serão exibidos aqui em uma próxima etapa.</p>' +
          "</div>" +
          '<div class="overlay-tab-content" data-tab-content="execucoes">' +
          '<p style="font-size:0.9rem;color:var(--cinza-texto);opacity:0.8;">Execuções serão exibidas aqui em uma próxima etapa.</p>' +
          "</div>" +
          "</div>" +
          "</div>";
