...
export async function PUT(
  ...
  try {
    // codigo é imutável após criação (chave de negócio / auditoria fiscal e estoque)
    const updated = await prisma.produto.update({
      ...
      data: {
        ...
        ...(body.ean !== undefined ? { ean: body.ean?.replace(/\D/g, "") || null } : {}),
        ...(body.csosn !== undefined ? { csosn: body.csosn || null } : {}),
        ...(body.cstIcms !== undefined ? { cstIcms: body.cstIcms || null } : {}),
        ...(body.cstPis !== undefined ? { cstPis: body.cstPis || null } : {}),
        ...(body.cstCofins !== undefined ? { cstCofins: body.cstCofins || null } : {}),
        ...(body.tributacaoIss !== undefined
          ? { tributacaoIss: body.tributacaoIss != null ? Number(body.tributacaoIss) : null }
          : {}),
        ...(body.issRetido !== undefined ? { issRetido: Boolean(body.issRetido) } : {}),
        ...(body.codigoMunicipioPrestacao !== undefined
          ? {
              codigoMunicipioPrestacao:
                body.codigoMunicipioPrestacao?.replace(/\D/g, "") || null,
            }
          : {}),
        ...(body.ibsCbsSituacaoTributaria !== undefined
          ? { ibsCbsSituacaoTributaria: body.ibsCbsSituacaoTributaria || null }
          : {}),
        ...(body.ibsCbsClassificacaoTributaria !== undefined
          ? { ibsCbsClassificacaoTributaria: body.ibsCbsClassificacaoTributaria || null }
          : {}),
        ...(body.infAdProdPadrao !== undefined
          ? { infAdProdPadrao: body.infAdProdPadrao || null }
          : {}),
        ...(body.naturezaOperacaoId !== undefined
