...
<body>
    ...
    <snk:query var="cip_produto">  	
        ...
        SELECT 1 AD_TPPROD, 'teste' TIPOPROD, 10 AS VLRCIP_PERC 
        FROM dual
...
SELECT
1 AD_TPPROD, 1 CODGER,'auuuu' GERENTE, 7000 VLRFAT
FROM dual
...
SELECT
1 CODEMP, 2 TIPOPROD, 1 CODPROD,'tentacao' AS PRODUTO, 9 CODGER,'almir sater' GERENTE,35000 TOTALLIQ
FROM dual
    ...
    <div class="container">
        <div class="section">
            <div class="part" id="left-top">
                <div class="part-title">Fat. Grupo Produto</div>
