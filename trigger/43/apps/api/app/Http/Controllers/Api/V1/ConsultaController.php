...
class ConsultaController extends Controller
{
    ...
    /**
     * Geocodifica endereço: Nominatim (rua) → BrasilAPI CEP v2.
     * Parceiro (ponto B) e origem da EMP (ponto A) usam a mesma cadeia.
     * Não inventa centroide como se fosse a planta.
     */
