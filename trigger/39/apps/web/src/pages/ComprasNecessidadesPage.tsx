            ...
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  <SortableTh column="produto" sortKey={sortKey} sortDir={sortDir} onSort={requestSort}>
                    Produto
                  </SortableTh>
                  ...
                  <SortableTh column="quando" sortKey={sortKey} sortDir={sortDir} onSort={requestSort}>
                    Quando
                  </SortableTh>
                </tr>
              </thead>
