...
<body>
    ...
    <script>
        ...
        function editarRegistro(item) {
            codigoAtual = item.CODIGO; // Armazena o código do registro
            ...
            document.getElementById('btnSalvar').textContent = 'Atualizar'; // Altera o texto do botão para "Atualizar"
        }
        ...
        // Função para salvar ou atualizar o registro
        document.getElementById('btnSalvar').addEventListener('click', function () {
            const confirmSave = confirm("Tem certeza que deseja " + (codigoAtual ? "atualizar" : "salvar") + " este registro?");
            if (confirmSave) {
                const dados = {
                ...
                if (codigoAtual) {
                    // Atualiza o registro
                    JX.atualizar(dados, 'AD_CALENDINOV', [{ CODIGO: codigoAtual }]).then(function () {
                        console.log('Registro atualizado com sucesso.');
                        carregarDados(); // Atualiza a tabela após salvar ou atualizar
        ...
        function resetForm() {
            ...
            codigoAtual = null; // Limpa o código do registro
            document.getElementById('btnSalvar').textContent = 'Salvar'; // Restaura o texto do botão
        }
