...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("evolution_instance", sa.String(length=80), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("evolution_message_id", sa.String(length=120), nullable=True),
    ...
    op.create_index(
        "ix_messages_sender_status", "messages", ["sender_id", "status"]
    )
    ...
    op.create_index(
        "ix_delivery_events_message_id", "delivery_events", ["message_id"]
    )
    ...
    op.create_index("ix_admin_audit_sender_id", "admin_audit_log", ["sender_id"])


def downgrade() -> None:
    op.drop_index("ix_admin_audit_sender_id", table_name="admin_audit_log")
