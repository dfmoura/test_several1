  ...
  <body>
    ...
    <script>
      ...
      function exportAnalysisToExcel(tab) {
        ...
        const numericFields = ["QTD_REAL", "QTD_PREV", "VLR_REAL", "VLR_PREV"];
        ...
        rows.forEach((row) => {
          ...
          headers.forEach((header) => {
            ...
            if (numericFields.includes(header)) {
              ...
              const isValor = header.includes("VLR");
              const styleId = isValor ? "NumeroBR" : "NumeroBRInteiro";
              xml += `<Cell ss:StyleID="${styleId}"><Data ss:Type="Number">${numValue}</Data></Cell>\n`;
            } else {
              // Campos de texto
              xml += `<Cell><Data ss:Type="String">${escapeXml(
                String(value)
