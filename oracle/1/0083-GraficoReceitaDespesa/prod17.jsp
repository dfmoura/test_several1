...
<body>
  ...
  <script>
    ...
    function updateChartReceita(dayCount) {
      ...
      receitaChart.data.datasets[0].data = vlrProvN_Atual;
      receitaChart.data.datasets[1].data = vlrProvS_Atual;
      receitaChart.data.datasets[2].data = vlrProvN_Ant;
      receitaChart.update();
    }
    ...
    function updateChartDespesa(dayCount) {
      ...
      despesaChart.data.datasets[0].data = vlrProvN_Atual;
      despesaChart.data.datasets[1].data = vlrProvN_Ant;
      despesaChart.update();
    }
    ...
    function updateChartCompra(dayCount) {
      ...
      compraChart.data.datasets[0].data = vlrProvS_Atual;
      compraChart.data.datasets[1].data = vlrProvS_Ant;
      compraChart.update();
    }
    ...
    function updateChartFluxo(dayCount) {
      ...
      fluxoChart.data.datasets[0].data = vlrReceita;
      fluxoChart.data.datasets[1].data = vlrDespesa;
      fluxoChart.data.datasets[2].data = saldoAcumulado;
      fluxoChart.update();
    }
      ...
      data: {
        ...
        datasets: [
          ...
          },
          {
            ...
            backgroundColor: 'rgba(0, 255, 123, 0.6)',
            stack: 'agrupado'
          },
          {
    ...
    slider.noUiSlider.on('update', function (values, handle) {
      ...
      sliderValue.textContent = dayCount;
