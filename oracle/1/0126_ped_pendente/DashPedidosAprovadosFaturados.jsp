    ...
    <main class="main-container">
      ...
      <section class="summary-cards">
        ...
        <div class="summary-card" id="cardFaturados" data-type="faturados">
          ...
          <div class="faturados-subcards" id="subcardsFaturados" style="display: none;">
    ...
    <script>
      ...
      async function carregarDados() {
        try {
          ...
          // Query para pedidos aprovados (query3.sql)
          const sqlAprovados = `
            SELECT DISTINCT 
              NUNOTA,
              DTMOV,
          ...
          // Query para pedidos faturados (query4.sql) - simplificada para obter os dados principais
          const sqlFaturados = `
            WITH FERIADOS AS (
            ...
            BASE_DATA AS (
              SELECT A.NUNOTA, A.DTFATUR, VAR.NUNOTAORIG, cab1.dtfatur dtfatur1, A.DTMOV, A.DTNEG, A.CODVEND, A.APELIDO, A.CODPARC, A.NOMEPARC
              FROM (
      ...
      function renderResumo() {
        ...
        // Mostrar subcards quando houver dados
        if (qtdFaturados > 0) {
          document.getElementById("subcardsFaturados").style.display = "grid";
        }
      }
      ...
      function renderTabela() {
        ...
        const linhas = data
          .sort((a, b) => {
            const dA = new Date(a.DTMOV || a.DTNEG || 0);
            const dB = new Date(b.DTMOV || b.DTNEG || 0);
      ...
      document.getElementById("subcard4h").addEventListener("click", () => handleCardClick("4h"));
      document.getElementById("subcard7h").addEventListener("click", () => handleCardClick("7h"));
      document.getElementById("subcard24h").addEventListener("click", () => handleCardClick("24h"));
