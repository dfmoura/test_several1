...
final class ImplantacaoCatalogo
{
    ...
    public static function itens(): array
    {
        return [
            ...
            [
                'codigo' => 'F5_PRODUTOS',
                'nome' => 'Cadastro de insumos e SKUs',
                'porque' => 'MP/EMB/REV para compra, estoque e OP — PA sob encomenda fica em família + spec, sem explodir cadastro.',
                'onda' => 5,
                'superficie' => self::SUPERFICIE_ERP,
                'elo' => false,
                'rota' => '/produtos',
            ...
            [
                ...
                'porque' => 'Virada/legado (A03), correções e perdas — saldo só via MOV.',
                'onda' => 5,
                'superficie' => self::SUPERFICIE_ERP,
                'elo' => false,
