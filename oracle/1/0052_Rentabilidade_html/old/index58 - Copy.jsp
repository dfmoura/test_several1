        ...
        <div class="col-md-6">
            <div class="left-section">
                ...
                <c:forEach items="${fat_total.rows}" var="row">
                    <div class="overlay-text"><fmt:formatNumber value="${row.VLRFAT}" type="currency" currencySymbol="" groupingUsed="true" minFractionDigits="0" maxFractionDigits="0"/></div> <!-- Texto sobreposto -->
                </c:forEach>
            </div>
            <div class="left-section">
                ...
                <c:forEach items="${cip_total.rows}" var="row">
                    <div class="overlay-text"><fmt:formatNumber value="${row.VLRCIP}" type="currency" currencySymbol="" groupingUsed="true" minFractionDigits="0" maxFractionDigits="0"/></div> <!-- Texto sobreposto -->
                </c:forEach>
            </div>
        </div>
        <div class="col-md-6">
