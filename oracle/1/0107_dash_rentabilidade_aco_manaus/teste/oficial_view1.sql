...
CAB.TIPMOV, TOP1.AD_COMPOE_FAT, CAB.DTNEG, TOP1.ATIVO ATIVO_TOP,
CAB.CODNAT,NAT.DESCRNAT,NAT.ATIVA ATIVA_NAT,NAT.AD_TIPOCUSTO TIPOCUSTO, CAB.CODCENCUS,CUS.DESCRCENCUS,CUS.ATIVO ATIVO_CR, CAB.CODVEND,
...
CAB.CODTIPOPER, TOP1.DESCROPER,TOP1.AD_COMPOE_FAT,  ITE.CODPROD, PRO.DESCRPROD, 
ITE.CODVOL, 
