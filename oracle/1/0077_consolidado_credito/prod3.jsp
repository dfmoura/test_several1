...
SELECT
CLIENTE,
SUBSTR(RAZAOSOCIAL,1,10) RAZAOSOCIAL,
...
<div class="container">
  <div class="top">
    ...
    <div class="cards-container">
          ...
          <div class="cards">
            <!-- 4 cards on the left -->
            <div class="card" onclick="abrir('1')">
