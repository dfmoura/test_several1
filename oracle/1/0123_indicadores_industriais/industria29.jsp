                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card kpi-card card-clickable" data-kpi="tempoEntrega" id="cardTempoEntrega">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="indicator-name mb-2">% pedidos com entrega no prazo (efetiva − prevista ≤ 0)</p>
...
ORDER BY CB.CODEMP, CB.DTNEG, CB.NUNOTA, CB.CODPROD`;
        ...
        function createLineChart(canvasId, chartData, kpi) {
            ...
            const suggestedMax = (kpi === 'qualidade' || kpi === 'tempoEntrega' || kpi === 'formulacao' || kpi === 'volumeRealizado' || kpi === 'ocupacaoProducao' || kpi === 'manutencaoPreventiva' || kpi === 'manutencaoCorretiva') ? 100 : undefined;
