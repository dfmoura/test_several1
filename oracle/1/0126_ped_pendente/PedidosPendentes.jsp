  ...
  <body>
        ...
        <div class="panel">
          ...
          <div class="chart-wrapper">
            ...
            <div class="chart-center-text">
              <div class="big" id="centerValor">--</div>
              <div class="small">VLR total</div>
            </div>
          </div>
        </div>
        <div class="panel">
          ...
          <div class="chart-wrapper">
            ...
            <div class="chart-center-text">
              <div class="big" id="centerQtd">--</div>
    ...
    <script>
      ...
      function renderResumo() {
        ...
        document.getElementById("centerValor").textContent = formatCurrency(totalValor);
        document.getElementById("centerQtd").textContent = formatNumber(totalQtd);
