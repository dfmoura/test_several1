  ...
  function collectTableDataForExcel() {
    ...
    rows.forEach(row => {
      ...
      const rowData = {
        ...
        'Mar. Ult12': convertToBrazilianFormat(cells[17].textContent.trim()),
        'Ticket Safra': convertToBrazilianFormat(cells[18].textContent.trim()),
        'Mar. Safra': convertToBrazilianFormat(cells[19].textContent.trim()),
        'Custo Atual': convertToBrazilianFormat(cells[20].textContent.trim()),
