  ...
  <div class="w-full px-1 mb-4">
    <div class="flex flex-col md:flex-row md:space-x-4 space-y-2 md:space-y-0 items-center justify-between bg-green-100 rounded-lg p-4 shadow">
      ...
      <div class="flex items-center space-x-2">
        ...
        <input id="globalDtVigor" type="date" class="border border-green-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-green-400 w-40" />
      ...
      <tbody>
        <c:forEach var="row" items="${base.rows}">
          <tr class="border-b border-green-100 hover:bg-green-50 transition">
            ...
            <td class="px-3 py-2 whitespace-nowrap text-center">
              <input type="date" class="row-dtvigor border border-green-300 rounded px-2 py-1 w-32 focus:outline-none focus:ring-2 focus:ring-green-400 text-center" value="" />
            </td>
          </tr>
        </c:forEach>
      </tbody>
