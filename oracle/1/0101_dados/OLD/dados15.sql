        ...
        BEGIN
            IF v_dhsolicit < v_data_corte AND v_dias_pendentes >= 15 THEN
                ...
                v_corpo :=
                    ...
                    '<p style="margin-top: 15px;"><strong>Prazo final para aprovação:</strong> ' || TO_CHAR(v_data_corte + 5, 'DD/MM/YYYY') || '</p>' ||
                    '<p style="margin-top: 10px;"><strong>Dias restantes para aprovação:</strong> <span style="color: #dc3545; font-weight: bold;">' || ROUND(v_data_corte + 5 - SYSDATE, 0) || ' dia(s)</span></p>' ||
