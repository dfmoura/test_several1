  ...
  <body>
      ...
      <section class="panel">
        ...
        <div class="table-wrapper">
          <table>
            ...
            <tbody id="tableBody">
              <tr>
                <td colspan="10" class="muted" style="text-align: center; padding: 24px;">Carregando...</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <script>
        ...
        try {
          ...
          if (typeof JX === "undefined" || !JX.consultar) {
            ...
            document.getElementById("tableBody").innerHTML =
              '<tr><td colspan="10" class="muted" style="text-align:center; padding:24px;">Conector JX indisponível.</td></tr>';
            renderResumo();
            renderTabela();
            return;
          }
          ...
          document.getElementById("tableBody").innerHTML =
            '<tr><td colspan="10" class="muted" style="text-align:center; padding:24px;">Erro ao buscar dados: ' + error.message + '</td></tr>';
        } finally {
          showLoading(false);
        }
      }
      ...
      function renderTabela() {
        ...
        if (!data.length) {
          let colspan = 8; // Pedido, Nro. Nota, Data Movimento, Data Negociação, Dt. Fat. Final, Vendedor, Parceiro
