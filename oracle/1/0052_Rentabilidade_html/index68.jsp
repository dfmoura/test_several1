...
<snk:query var="fat_tipo">  
  ...
  AND VGF.CODGER = :A_GERENTE
  AND VGF.AD_TPPROD = :A_TPPROD
  GROUP BY VGF.AD_TPPROD,VGF.CODGER,VGF.AD_SUPERVISOR,VGF.SUPERVISOR
...
SELECT
VGF.CODEMP,VGF.AD_SUPERVISOR,VGF.SUPERVISOR,VGF.CODGER,VGF.GERENTE,VGF.TIPOPROD,VGF.CODPROD,VGF.DESCRPROD AS PRODUTO,SUM(TOTALLIQ)TOTALLIQ
FROM VGF_CONSOLIDADOR_NOTAS_GM  VGF
INNER JOIN TGFPAR PAR ON VGF.CODPARC = PAR.CODPARC
LEFT JOIN TGFPAR PARM ON PAR.CODPARCMATRIZ = PARM.CODPARC
WHERE 
...
AND (AD_TPPROD = :A_TPPROD AND ((AD_SUPERVISOR = :A_SUPERVISOR) OR (CODGER = :A_GERENTE AND :A_SUPERVISOR IS NULL)))
GROUP BY VGF.CODEMP,VGF.AD_SUPERVISOR,VGF.SUPERVISOR,VGF.CODGER,VGF.GERENTE,VGF.TIPOPROD,VGF.CODPROD,VGF.DESCRPROD
