...
**Status:** Aceito (Fases A–C entregues)  
**Data:** 2026-09-23  
...
2. RETIRAR      QR VOL: no corredor  ou  confirmar na OP       (mesmo writer)
3. BAIXAR       volumes explícitos → SAIDA_PRODUCAO
4. ENTREGAR     quem recebeu na máquina                        (handoff, sem MOV)
5. VER          volumes baixados + genealogia
```
...
| Porta | Quem | Ação |
|-------|------|------|
| OP · Separação | PCP / produção | Preview + confirmar (Fase A) · entregar na máquina (C) |
| Estoque · Retiradas | Almoxarifado | Fila a retirar / a entregar · caminhada + QR (B) |
