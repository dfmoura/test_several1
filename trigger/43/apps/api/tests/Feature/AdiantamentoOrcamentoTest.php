...
class AdiantamentoOrcamentoTest extends TestCase
{
    ...
    public function test_aprovar_abre_cfin_se_a_empresa_nao_tiver(): void
    {
        $this->cfin->delete();
        $this->assertSame(0, EmpresaContaFinanceira::query()->where('empresa_id', $this->empresa->id)->count());
        ...
        $this->assertSame(1, EmpresaContaFinanceira::query()->where('empresa_id', $this->empresa->id)->where('ativa', true)->count());
    }
