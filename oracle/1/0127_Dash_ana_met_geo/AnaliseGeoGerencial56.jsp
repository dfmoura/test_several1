...
<html lang="pt">
  <head>
    ...
    <style>
      ...
      /* ===== Expansão (Último nível Vendedor -> Parceiro -> Marca -> Produto) ===== */
  ...
  <body>
    ...
    <div class="main-container">
      ...
      <!-- Overlay de Detalhe do Vendedor (Parceiros) -->
      <div class="overlay-modal" id="vendedorDetailModal">
        <div class="overlay-content">
          <div class="overlay-header">
            <h2 class="overlay-title">
              <i class="fas fa-user-tie"></i>
              Detalhe do Vendedor - Parceiros
            </h2>
            <button class="overlay-close" onclick="closeVendedorDetailOverlay()">
              <i class="fas fa-times"></i>
            </button>
          </div>
          ...
          <div class="overlay-toolbar" style="display: flex">
            <div class="toolbar-left">
              <div class="search-container">
                ...
                <input
                  type="text"
                  id="vendedorDetailSearch"
                  class="search-input"
                  placeholder="Buscar por código ou nome do parceiro"
                  oninput="filterVendedorDetail()"
                />
              </div>
              <button class="btn-overlay" onclick="reloadVendedorDetail()">
                <i class="fas fa-sync-alt"></i> Atualizar
              </button>
            </div>
            <div class="toolbar-right">
              <button
                class="btn-overlay btn-success"
                onclick="exportVendedorDetailToExcel()"
              >
                <i class="fas fa-file-excel"></i> Excel
              </button>
            </div>
          ...
          <div class="overlay-section" style="display: block">
            <div class="overlay-table-container">
              <table class="overlay-table">
                <thead>
                  <tr>
                    <th class="sortable-header" data-sort-key="codparc" onclick="handleVendedorDetailSort('codparc')">
                      Código Parceiro
                    </th>
                    <th class="sortable-header" data-sort-key="parceiro" onclick="handleVendedorDetailSort('parceiro')">
                      Parceiro
                    </th>
                    <th class="text-center sortable-header" data-sort-key="qtdprev" onclick="handleVendedorDetailSort('qtdprev')">
                      Qtd Prev
                    </th>
                    <th class="text-center sortable-header" data-sort-key="qtdreal" onclick="handleVendedorDetailSort('qtdreal')">
                      Qtd Real
                    </th>
                    <th class="text-center sortable-header" data-sort-key="perc" onclick="handleVendedorDetailSort('perc')">
                      % Ating. Qtd
                    </th>
                    <th class="text-center sortable-header" data-sort-key="vlr_prev" onclick="handleVendedorDetailSort('vlr_prev')">
                      Vlr Prev
                    </th>
                    <th class="text-center sortable-header" data-sort-key="vlr_real" onclick="handleVendedorDetailSort('vlr_real')">
                      Vlr Real
                    </th>
                    <th class="text-center sortable-header" data-sort-key="perc_vlr" onclick="handleVendedorDetailSort('perc_vlr')">
                      % Ating. Vlr
                    </th>
                    <th class="text-center sortable-header" data-sort-key="ticket_medio" onclick="handleVendedorDetailSort('ticket_medio')">
                      Ticket Médio
                    </th>
                    <th class="text-center sortable-header" data-sort-key="ticket_medio_meta" onclick="handleVendedorDetailSort('ticket_medio_meta')">
                      Ticket Médio Meta
                    </th>
                    <th class="text-center sortable-header" data-sort-key="var_perc_ticket_medio" onclick="handleVendedorDetailSort('var_perc_ticket_medio')">
                      Var. % Ticket Médio
                    </th>
                  </tr>
                </thead>
                <tbody id="vendedorDetailBody"></tbody>
              </table>
            </div>
          </div>
        </div>
      ...
      <!-- Overlay de Detalhe do Parceiro (Marcas) -->
      <div class="overlay-modal" id="parceiroDetailModal">
        <div class="overlay-content">
          <div class="overlay-header">
            <h2 class="overlay-title">
              <i class="fas fa-handshake"></i>
              Detalhe do Parceiro - Marcas
            </h2>
            <button class="overlay-close" onclick="closeParceiroDetailOverlay()">
              <i class="fas fa-times"></i>
            </button>
          </div>
          ...
          <div class="overlay-toolbar" style="display: flex">
            <div class="toolbar-left">
              <div class="search-container">
                ...
                <input
                  type="text"
                  id="parceiroDetailSearch"
                  class="search-input"
                  placeholder="Buscar por marca"
                  oninput="filterParceiroDetail()"
                />
              </div>
              <button class="btn-overlay" onclick="reloadParceiroDetail()">
                <i class="fas fa-sync-alt"></i> Atualizar
              </button>
              <button class="btn-overlay" id="toggleAllParceiroDetailBtn" onclick="toggleAllParceiroDetailExpansion()">
                <i class="fas fa-chevron-down" id="toggleAllParceiroDetailIcon"></i> <span id="toggleAllParceiroDetailText">Expandir Todos</span>
              </button>
            </div>
            <div class="toolbar-right">
              <button
                class="btn-overlay btn-success"
                onclick="exportParceiroDetailToExcel()"
              >
                <i class="fas fa-file-excel"></i> Excel
              </button>
            </div>
          ...
          <div class="overlay-section" style="display: block">
            <div class="overlay-table-container">
              <table class="overlay-table">
                <thead>
                  <tr>
                    <th class="sortable-header" data-sort-key="marca" onclick="handleParceiroDetailSort('marca')">
                      Marca
                    </th>
                    <th class="text-center sortable-header" data-sort-key="qtdprev" onclick="handleParceiroDetailSort('qtdprev')">
                      Qtd Prev
                    </th>
                    <th class="text-center sortable-header" data-sort-key="qtdreal" onclick="handleParceiroDetailSort('qtdreal')">
                      Qtd Real
                    </th>
                    <th class="text-center sortable-header" data-sort-key="perc" onclick="handleParceiroDetailSort('perc')">
                      % Ating. Qtd
                    </th>
                    <th class="text-center sortable-header" data-sort-key="vlr_prev" onclick="handleParceiroDetailSort('vlr_prev')">
                      Vlr Prev
                    </th>
                    <th class="text-center sortable-header" data-sort-key="vlr_real" onclick="handleParceiroDetailSort('vlr_real')">
                      Vlr Real
                    </th>
                    <th class="text-center sortable-header" data-sort-key="perc_vlr" onclick="handleParceiroDetailSort('perc_vlr')">
                      % Ating. Vlr
                    </th>
                    <th class="text-center sortable-header" data-sort-key="ticket_medio" onclick="handleParceiroDetailSort('ticket_medio')">
                      Ticket Médio
                    </th>
                    <th class="text-center sortable-header" data-sort-key="ticket_medio_meta" onclick="handleParceiroDetailSort('ticket_medio_meta')">
                      Ticket Médio Meta
                    </th>
                    <th class="text-center sortable-header" data-sort-key="var_perc_ticket_medio" onclick="handleParceiroDetailSort('var_perc_ticket_medio')">
                      Var. % Ticket Médio
                    </th>
                  </tr>
                </thead>
                <tbody id="parceiroDetailBody"></tbody>
              </table>
            </div>
          </div>
        </div>
      ...
      <!-- Overlay de Detalhe do Parceiro - Marcas (da guia Parceiro) -->
      <div class="overlay-modal" id="parceiroMarcaDetailModal">
        <div class="overlay-content">
          <div class="overlay-header">
            <h2 class="overlay-title">
            ...
            <button class="overlay-close" onclick="closeParceiroMarcaDetailOverlay()">
              <i class="fas fa-times"></i>
            </button>
          </div>
          ...
          <div class="overlay-toolbar" style="display: flex">
            <div class="toolbar-left">
              <div class="search-container">
                ...
                <input
                  type="text"
                  id="parceiroMarcaDetailSearch"
                  class="search-input"
                  placeholder="Buscar por marca"
                  oninput="filterParceiroMarcaDetail()"
                />
              </div>
              <button class="btn-overlay" onclick="reloadParceiroMarcaDetail()">
                <i class="fas fa-sync-alt"></i> Atualizar
              </button>
              <button class="btn-overlay" id="toggleAllParceiroMarcaDetailBtn" onclick="toggleAllParceiroMarcaDetailExpansion()">
                <i class="fas fa-chevron-down" id="toggleAllParceiroMarcaDetailIcon"></i> <span id="toggleAllParceiroMarcaDetailText">Expandir Todos</span>
              </button>
            </div>
            <div class="toolbar-right">
              <button
                class="btn-overlay btn-success"
                onclick="exportParceiroMarcaDetailToExcel()"
              >
                <i class="fas fa-file-excel"></i> Excel
              </button>
            </div>
          ...
          <div class="overlay-section" style="display: block">
            <div class="overlay-table-container">
              <table class="overlay-table">
                <thead>
                  <tr>
                    <th class="sortable-header" data-sort-key="marca" onclick="handleParceiroMarcaDetailSort('marca')">
                      Marca
                    </th>
                    <th class="text-center sortable-header" data-sort-key="qtdprev" onclick="handleParceiroMarcaDetailSort('qtdprev')">
                      Qtd Prev
                    </th>
                    <th class="text-center sortable-header" data-sort-key="qtdreal" onclick="handleParceiroMarcaDetailSort('qtdreal')">
                      Qtd Real
                    </th>
                    <th class="text-center sortable-header" data-sort-key="perc" onclick="handleParceiroMarcaDetailSort('perc')">
                      % Ating. Qtd
                    </th>
                    <th class="text-center sortable-header" data-sort-key="vlr_prev" onclick="handleParceiroMarcaDetailSort('vlr_prev')">
                      Vlr Prev
                    </th>
                    <th class="text-center sortable-header" data-sort-key="vlr_real" onclick="handleParceiroMarcaDetailSort('vlr_real')">
                      Vlr Real
                    </th>
                    <th class="text-center sortable-header" data-sort-key="perc_vlr" onclick="handleParceiroMarcaDetailSort('perc_vlr')">
                      % Ating. Vlr
                    </th>
                    <th class="text-center sortable-header" data-sort-key="ticket_medio" onclick="handleParceiroMarcaDetailSort('ticket_medio')">
                      Ticket Médio
                    </th>
                    <th class="text-center sortable-header" data-sort-key="ticket_medio_meta" onclick="handleParceiroMarcaDetailSort('ticket_medio_meta')">
                      Ticket Médio Meta
                    </th>
                    <th class="text-center sortable-header" data-sort-key="var_perc_ticket_medio" onclick="handleParceiroMarcaDetailSort('var_perc_ticket_medio')">
                      Var. % Ticket Médio
                    </th>
                  </tr>
                </thead>
                <tbody id="parceiroMarcaDetailBody"></tbody>
              </table>
            </div>
          </div>
        </div>
      ...
      <!-- Overlay de Detalhe da Marca (Vendedores) -->
      <div class="overlay-modal" id="marcaDetailModal">
        <div class="overlay-content">
          <div class="overlay-header">
            <h2 class="overlay-title">
              <i class="fas fa-tags"></i>
              Detalhe da Marca - Vendedores
            </h2>
            <button class="overlay-close" onclick="closeMarcaDetailOverlay()">
              <i class="fas fa-times"></i>
            </button>
          </div>
          ...
          <div class="overlay-toolbar" style="display: flex">
            <div class="toolbar-left">
              <div class="search-container">
                ...
                <input
                  type="text"
                  id="marcaDetailSearch"
                  class="search-input"
                  placeholder="Buscar por código ou nome do vendedor"
                  oninput="filterMarcaDetail()"
                />
              </div>
              <button class="btn-overlay" onclick="reloadMarcaDetail()">
                <i class="fas fa-sync-alt"></i> Atualizar
              </button>
            </div>
            <div class="toolbar-right">
              <button
                class="btn-overlay btn-success"
                onclick="exportMarcaDetailToExcel()"
              >
                <i class="fas fa-file-excel"></i> Excel
              </button>
            </div>
          ...
          <div class="overlay-section" style="display: block">
            <div class="overlay-table-container">
              <table class="overlay-table">
                <thead>
                  <tr>
                    <th class="sortable-header" data-sort-key="codvend" onclick="handleMarcaDetailSort('codvend')">
                      Código Vendedor
                    </th>
                    <th class="sortable-header" data-sort-key="apelido" onclick="handleMarcaDetailSort('apelido')">
                      Vendedor
                    </th>
                    <th class="text-center sortable-header" data-sort-key="qtdprev" onclick="handleMarcaDetailSort('qtdprev')">
                      Qtd Prev
                    </th>
                    <th class="text-center sortable-header" data-sort-key="qtdreal" onclick="handleMarcaDetailSort('qtdreal')">
                      Qtd Real
                    </th>
                    <th class="text-center sortable-header" data-sort-key="perc" onclick="handleMarcaDetailSort('perc')">
                      % Ating. Qtd
                    </th>
                    <th class="text-center sortable-header" data-sort-key="vlr_prev" onclick="handleMarcaDetailSort('vlr_prev')">
                      Vlr Prev
                    </th>
                    <th class="text-center sortable-header" data-sort-key="vlr_real" onclick="handleMarcaDetailSort('vlr_real')">
                      Vlr Real
                    </th>
                    <th class="text-center sortable-header" data-sort-key="perc_vlr" onclick="handleMarcaDetailSort('perc_vlr')">
                      % Ating. Vlr
                    </th>
                    <th class="text-center sortable-header" data-sort-key="ticket_medio" onclick="handleMarcaDetailSort('ticket_medio')">
                      Ticket Médio
                    </th>
                    <th class="text-center sortable-header" data-sort-key="ticket_medio_meta" onclick="handleMarcaDetailSort('ticket_medio_meta')">
                      Ticket Médio Meta
                    </th>
                    <th class="text-center sortable-header" data-sort-key="var_perc_ticket_medio" onclick="handleMarcaDetailSort('var_perc_ticket_medio')">
                      Var. % Ticket Médio
                    </th>
                  </tr>
                </thead>
                <tbody id="marcaDetailBody"></tbody>
              </table>
            </div>
          </div>
        </div>
                ...
                <div id="parceiroMultiContainer" style="position: relative">
                  <div
                    ...
                    style="
                      ...
                      font-size: 0.75rem;
                    "
                    onclick="event.stopPropagation(); toggleParceiroDropdown()"
                ...
                <div id="vendedorMultiContainer" style="position: relative">
                  <div
                    ...
                    style="
                      ...
                      font-size: 0.75rem;
                    "
                    onclick="event.stopPropagation(); toggleVendedorDropdown()"
                ...
                <div id="marcaMultiContainer" style="position: relative">
                  <div
                    ...
                    style="
                      ...
                      font-size: 0.75rem;
                    "
                    onclick="event.stopPropagation(); toggleMarcaDropdown()"
                ...
                <div id="grupoMultiContainer" style="position: relative">
                  <div
                    ...
                    style="
                      ...
                      font-size: 0.75rem;
                    "
                    onclick="event.stopPropagation(); toggleGrupoDropdown()"
                ...
                <div id="crMultiContainer" style="position: relative">
                  <div
                    ...
                    style="
                      ...
                      font-size: 0.75rem;
                    "
                    onclick="event.stopPropagation(); toggleCrDropdown()"
                ...
                <div id="gerenteMultiContainer" style="position: relative">
                  <div
                    ...
                    style="
                      ...
                      font-size: 0.75rem;
                    "
                    onclick="event.stopPropagation(); toggleGerenteDropdown()"
                ...
                <div id="naturezaMultiContainer" style="position: relative">
                  <div
                    ...
                    style="
                      ...
                      font-size: 0.75rem;
                    "
                    onclick="event.stopPropagation(); toggleNaturezaDropdown()"
    ...
    <script>
      ...
      function getDatasDinamicas() {
        ...
        const dtInicio = String(primeiroDia.getDate()).padStart(2, '0') + '/' + 
                        String(primeiroDia.getMonth() + 1).padStart(2, '0') + '/' + 
                        primeiroDia.getFullYear();
        
        // Último dia do mês
        const ultimoDia = new Date(ano, mes + 1, 0);
        const dtFim = String(ultimoDia.getDate()).padStart(2, '0') + '/' + 
      ...
      function renderAnalysisVend(rows) {
        ...
        tbody.innerHTML = (rows || [])
          .map((r) => {
            ...
            return `<tr style="cursor: pointer;" ondblclick="openVendedorDetailOverlay(${r.CODVEND || 0}, '${(r.APELIDO || '').replace(/'/g, "\\'")}')">
            <td>${r.CODVEND ?? ""}</td>
            <td>${r.APELIDO ?? ""}</td>
            <td>${r.GERENTE ?? ""}</td>
      ...
      function renderAnalysisParc(rows) {
        ...
        tbody.innerHTML = (rows || [])
          .map((r) => {
            ...
            return `<tr style="cursor: pointer;" ondblclick="openParceiroMarcaDetailOverlay(${r.CODPARC || 0}, '${(r.PARCEIRO || '').replace(/'/g, "\\'")}')">
            <td>${r.CODPARC ?? ""}</td>
            <td>${r.PARCEIRO ?? ""}</td>
            <td class="text-center metric-value">${qtdRealFmt}</td>
            <td class="text-center metric-value">${qtdPrevFmt}</td>
      ...
      function renderAnalysisMarca(rows) {
        ...
        tbody.innerHTML = (rows || [])
          .map((r) => {
            ...
            return `<tr style="cursor: pointer;" ondblclick="openMarcaDetailOverlay('${(r.MARCA || '').replace(/'/g, "\\'")}')">
            <td>${r.MARCA ?? ""}</td>
            <td class="text-center metric-value">${qtdRealFmt}</td>
            <td class="text-center metric-value">${qtdPrevFmt}</td>
            <td class="text-center metric-cell">${pctQtdChip}</td>
      ...
      // Função auxiliar para formatar números no padrão brasileiro (vírgula para decimais, ponto para milhares)
      function formatNumberForExcel(value) {
        if (value === null || value === undefined || value === "") return "";
        const numValue = parseFloat(value);
        if (isNaN(numValue)) return String(value);
        // Formata com vírgula para decimais e ponto para milhares
        return new Intl.NumberFormat("pt-BR", {
      ...
      // ===== Overlay Análise: Exportação para Excel (.xls) =====
      function exportAnalysisToExcel(tab) {
        // Exporta arquivo Excel (.xls) no formato XML SpreadsheetML
        let rows = [];
        let headers = [];
        if (tab === "vend") {
        ...
        // Campos numéricos que precisam formatação brasileira
        const numericFields = [
          "QTD_REAL",
          "QTD_PREV",
          "% ATING. QTD",
        ...
        xml += '<Worksheet ss:Name="Analise">\n';
        xml += "<Table>\n";

        // Cabeçalhos
        xml += "<Row>\n";
        headers.forEach((header) => {
          xml += `<Cell><Data ss:Type="String">${escapeXml(
            header
          )}</Data></Cell>\n`;
        });
        xml += "</Row>\n";
        ...
        // Dados
        rows.forEach((row) => {
          // Calcula valores derivados para as novas colunas
          const qr = parseFloat(row.QTD_REAL || 0);
          const qp = parseFloat(row.QTD_PREV || 0);
          ...
          headers.forEach((header) => {
            let value;
            // Mapeia as novas colunas calculadas
            if (header === "% ATING. QTD") {
              value = pctQtd;
            } else if (header === "% ATING. VLR") {
              value = pctVlr;
            } else if (header === "TICKET MÉDIO PREV") {
              value = ticketPrev;
            } else if (header === "TICKET MÉDIO REAL") {
              value = ticketReal;
            } else if (header === "VAR. TICKET MÉDIO") {
            ...
            if (numericFields.includes(header)) {
              ...
              const numValue =
                value === null || value === undefined
                  ? ""
                  : parseFloat(value) || 0;
              // Aplica estilo brasileiro (vírgula para decimais, ponto para milhares)
              // Para valores monetários, usa formato com 2 decimais
              // Para percentuais, usa formato de percentual (divide por 100)
              const isPercentual =
                header.includes("% ATING") || header.includes("VAR. TICKET");
              const isValor =
                header.includes("VLR") || header.includes("TICKET");
              let styleId;
        ...
        link.setAttribute("download", `analise_${tab}.xls`);
      ...
      // ===== Overlay Detalhe do Vendedor (Parceiros) =====
      let vendedorDetailRaw = [];
      let currentVendedorCod = null;
      let currentVendedorNome = '';
      let vendedorDetailSortState = { column: null, direction: 'asc' };

      // ===== Overlay Detalhe da Marca (Vendedores) =====
      let marcaDetailRaw = [];
      let currentMarcaNome = null;
      let marcaDetailSortState = { column: null, direction: 'asc' };

      // ===== Overlay Detalhe do Parceiro (Marcas) =====
      let parceiroDetailRaw = [];
      let currentParceiroCod = null;
      let currentParceiroNome = '';
      let parceiroDetailSortState = { column: null, direction: 'asc' };
      // Expansão: cache de produtos por marca (no último nível da guia Vendedor)
      let parceiroMarcaProdutosCache = {}; // key -> rows
      let parceiroMarcaProdutosLoading = {}; // key -> boolean
      let parceiroMarcaProdutosExpanded = {}; // key -> boolean

      // ===== Overlay Detalhe do Parceiro - Marcas (da guia Parceiro) =====
      let parceiroMarcaDetailRaw = [];
      let currentParceiroMarcaCod = null;
      let currentParceiroMarcaNome = '';
      let parceiroMarcaDetailSortState = { column: null, direction: 'asc' };
      // Expansão: cache de produtos por marca
      let parceiroMarcaDetailProdutosCache = {}; // key -> rows
      let parceiroMarcaDetailProdutosLoading = {}; // key -> boolean
      let parceiroMarcaDetailProdutosExpanded = {}; // key -> boolean

      // ===== Overlay Detalhe do Vendedor: SQL Builder baseado em query1.sql =====
      function buildVendedorDetailSQL(dtInicio, dtFim, codVend) {
        const {
          parceirosIn,
          vendedoresIn,
          gerentesIn,
        ...
        // Construir filtros de coordenação, marcas e CR baseados nos selecionados
        ...
        const crFilter = selectedCrs && selectedCrs.length > 0
          ? `AND (VGF.CODCENCUS IN (${selectedCrs.join(',')}))`
          : '';
          ...
          FROM (
            ...
            FROM (
              ...
              FROM (
                ...
                WHERE 1=1
                  ${selectedCrs && selectedCrs.length > 0 ? `AND VGF.CODCENCUS IN (${selectedCrs.join(',')})` : ''}
                GROUP BY
                  MET.CODMETA,
                  MET.DTREF,
                  VEN.CODVEND,
      ...
      // ===== Overlay Detalhe da Marca: SQL Builder baseado em query6.sql =====
      function buildMarcaDetailSQL(dtInicio, dtFim, marca) {
        const {
          parceirosIn,
          vendedoresIn,
          gerentesIn,
        ...
        // Construir filtros de coordenação, grupos, CR e parceiros baseados nos selecionados
        const coordFilter = selectedGerentes && selectedGerentes.length > 0 
          ? `AND (X.CODGER IN (${selectedGerentes.join(',')}))`
          : '';
        const crFilter = selectedCrs && selectedCrs.length > 0
      ...
      // ===== Overlay Detalhe do Parceiro: SQL Builder baseado em query2.sql =====
      function buildParceiroDetailSQL(dtInicio, dtFim, codVend, codParc) {
        const {
          parceirosIn,
          vendedoresIn,
          gerentesIn,
        ...
        // Construir filtros baseados nos selecionados
        const coordFilter = selectedGerentes && selectedGerentes.length > 0 
          ? `AND (X.CODGER IN (${selectedGerentes.join(',')}))`
          : '';
        const marcaFilter = selectedMarcas && selectedMarcas.length > 0
      ...
      // ===== Overlay Detalhe do Parceiro - Marcas: SQL Builder baseado em query5.sql =====
      function buildParceiroMarcaDetailSQL(dtInicio, dtFim, codParc) {
        const {
          parceirosIn,
          vendedoresIn,
          gerentesIn,
      ...
      // ===== Overlay Detalhe do Parceiro - Marcas: Produto por Marca (somente REAL) baseado em query3.sql =====
      function buildParceiroMarcaProdutoDetailSQL(dtInicio, dtFim, codParc, marca) {
        const safeMarca = String(marca || "").replace(/'/g, "''");
        const naturezaIn =
          selectedNaturezas && selectedNaturezas.length > 0
            ? ` AND NVL(VGF.CODNAT,0) IN (${selectedNaturezas.join(",")})`
        ...
        const gruposIn =
          selectedGrupos && selectedGrupos.length > 0
            ? ` AND NVL(VGF.CODGRUPOPROD,0) IN (${selectedGrupos.join(",")})`
            : "";
        const crsIn =
          selectedCrs && selectedCrs.length > 0
            ? ` AND NVL(VGF.CODCENCUS,0) IN (${selectedCrs.join(",")})`
            : "";
        const vendedorFilter = selectedVendedores && selectedVendedores.length > 0
          ? ` AND NVL(VGF.CODVEND,0) IN (${selectedVendedores.join(",")})`
          : "";
        ...
        return `
          SELECT
            ...
            VGF.CODPROD,
            PRO.DESCRPROD,
            SUM(NVL(VGF.VLR,0)) AS VLR_REAL,
            SUM(NVL(VGF.QTD,0)) AS QTD_REAL
      ...
      // ===== Último nível (Vendedor -> Parceiro -> Marca): Produto por Marca (somente REAL) =====
      function buildMarcaProdutoDetailSQL(dtInicio, dtFim, codVend, codParc, marca) {
        const safeMarca = String(marca || "").replace(/'/g, "''");
        const naturezaIn =
          selectedNaturezas && selectedNaturezas.length > 0
            ? ` AND NVL(VGF.CODNAT,0) IN (${selectedNaturezas.join(",")})`
      ...
      // ===== Overlay Detalhe do Vendedor: Funções de controle =====
      async function openVendedorDetailOverlay(codVend, nomeVendedor) {
        currentVendedorCod = codVend;
        currentVendedorNome = nomeVendedor;
        const modal = document.getElementById("vendedorDetailModal");
        if (modal) {
          modal.classList.add("show");
          const title = modal.querySelector(".overlay-title");
          if (title) {
            title.innerHTML = `<i class="fas fa-user-tie"></i> Detalhe do Vendedor - ${nomeVendedor} (${codVend})`;
          }
        }
        await reloadVendedorDetail();
      }

      function closeVendedorDetailOverlay() {
        const modal = document.getElementById("vendedorDetailModal");
        if (modal) modal.classList.remove("show");
      }

      async function reloadVendedorDetail() {
        ...
        try {
          ...
          const dtInicio =
            document.getElementById("dtInicio").value || dtInicioDefault;
          const dtFim = document.getElementById("dtFim").value || dtFimDefault;
          const sql = buildVendedorDetailSQL(dtInicio, dtFim, currentVendedorCod);
          const rows = await JX.consultar(sql);
          vendedorDetailRaw = rows || [];
          renderVendedorDetail(vendedorDetailRaw);
          filterVendedorDetail();
        } catch (e) {
          console.error("Erro ao recarregar detalhe do vendedor:", e);
        }
      }

      function renderVendedorDetail(rows) {
        const tbody = document.getElementById("vendedorDetailBody");
        if (!tbody) return;
        tbody.innerHTML = (rows || [])
          .map((r) => {
            ...
            const vr = parseFloat(r.VLR_REAL || 0);
            const vp = parseFloat(r.VLR_PREV || 0);
            const pctQtd = r.PERC !== undefined ? parseFloat(r.PERC) : (qp > 0 ? (qr / qp) * 100 : null);
            const pctVlr = r.PERC_VLR !== undefined ? parseFloat(r.PERC_VLR) : (vp > 0 ? (vr / vp) * 100 : null);
            const ticketMedio = r.TICKET_MEDIO !== undefined ? parseFloat(r.TICKET_MEDIO) : (qr > 0 ? vr / qr : 0);
            const ticketMedioMeta = r.TICKET_MEDIO_META !== undefined ? parseFloat(r.TICKET_MEDIO_META) : (qp > 0 ? vp / qp : 0);
            const varPercTicket = r.VAR_PERC_TICKET_MEDIO !== undefined ? parseFloat(r.VAR_PERC_TICKET_MEDIO) : null;
            ...
            const vlrPrevFmt = formatCurrency(vp);
            const pctVlrFmt = formatPercent(pctVlr);
            const ticketMedioFmt = formatCurrency(ticketMedio);
            const ticketMedioMetaFmt = formatCurrency(ticketMedioMeta);
            const varTicketFmt = formatPercent(varPercTicket);

            const pctQtdChip = buildPercentChip(pctQtd, pctQtdFmt);
            const pctVlrChip = buildPercentChip(pctVlr, pctVlrFmt);
            const varTicketChip = buildVariationChip(varPercTicket, varTicketFmt);

            return `<tr style="cursor: pointer;" ondblclick="openParceiroDetailOverlay(${currentVendedorCod}, ${r.CODPARC || 0}, '${(r.PARCEIRO || '').replace(/'/g, "\\'")}')">
            <td>${r.CODPARC ?? ""}</td>
            <td>${r.PARCEIRO ?? ""}</td>
            <td class="text-center metric-value">${qtdPrevFmt}</td>
            <td class="text-center metric-value">${qtdRealFmt}</td>
            ...
            <td class="text-center metric-value">${vlrRealFmt}</td>
            <td class="text-center metric-cell">${pctVlrChip}</td>
            <td class="text-center metric-value">${ticketMedioFmt}</td>
            <td class="text-center metric-value">${ticketMedioMetaFmt}</td>
            <td class="text-center metric-cell">${varTicketChip}</td>
          </tr>`;
          })
          .join("");
      }

      function filterVendedorDetail() {
        const term = (
          document.getElementById("vendedorDetailSearch").value || ""
        ).toLowerCase();
        const rows = (vendedorDetailRaw || []).filter((r) => {
          return (
            !term ||
            String(r.CODPARC || "")
              .toLowerCase()
        ...
        const sortedRows = applyVendedorDetailSort(rows);
        renderVendedorDetail(sortedRows);
      }

      function handleVendedorDetailSort(columnKey) {
        if (vendedorDetailSortState.column === columnKey) {
          vendedorDetailSortState.direction = vendedorDetailSortState.direction === "asc" ? "desc" : "asc";
        } else {
          vendedorDetailSortState.column = columnKey;
          vendedorDetailSortState.direction = "asc";
        }
        filterVendedorDetail();
      }

      function applyVendedorDetailSort(rows) {
        if (!vendedorDetailSortState.column || !Array.isArray(rows)) return rows;
        const sorted = [...rows];
        sorted.sort((a, b) => {
          let aVal, bVal;
          switch (vendedorDetailSortState.column) {
            case "codparc":
              aVal = parseFloat(a.CODPARC || 0);
              bVal = parseFloat(b.CODPARC || 0);
              break;
            case "parceiro":
              aVal = String(a.PARCEIRO || "").toLowerCase();
              bVal = String(b.PARCEIRO || "").toLowerCase();
              break;
            case "qtdprev":
              aVal = parseFloat(a.QTDPREV || 0);
              bVal = parseFloat(b.QTDPREV || 0);
              break;
            case "qtdreal":
              aVal = parseFloat(a.QTDREAL || 0);
              bVal = parseFloat(b.QTDREAL || 0);
              break;
            case "perc":
              aVal = parseFloat(a.PERC || 0);
              bVal = parseFloat(b.PERC || 0);
              break;
            case "vlr_prev":
              aVal = parseFloat(a.VLR_PREV || 0);
              bVal = parseFloat(b.VLR_PREV || 0);
              break;
            case "vlr_real":
              aVal = parseFloat(a.VLR_REAL || 0);
              bVal = parseFloat(b.VLR_REAL || 0);
              break;
            case "perc_vlr":
              aVal = parseFloat(a.PERC_VLR || 0);
              bVal = parseFloat(b.PERC_VLR || 0);
              break;
            case "ticket_medio":
              aVal = parseFloat(a.TICKET_MEDIO || 0);
              bVal = parseFloat(b.TICKET_MEDIO || 0);
              break;
            case "ticket_medio_meta":
              aVal = parseFloat(a.TICKET_MEDIO_META || 0);
              bVal = parseFloat(b.TICKET_MEDIO_META || 0);
              break;
            case "var_perc_ticket_medio":
              aVal = parseFloat(a.VAR_PERC_TICKET_MEDIO || 0);
              bVal = parseFloat(b.VAR_PERC_TICKET_MEDIO || 0);
              break;
            default:
              return 0;
          }
          const dir = vendedorDetailSortState.direction === "desc" ? -1 : 1;
      ...
      function exportVendedorDetailToExcel() {
        const rows = vendedorDetailRaw || [];
        if (rows.length === 0) {
        ...
        let xml = '<?xml version="1.0"?>\n<?mso-application progid="Excel.Sheet"?>\n<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet">\n<Worksheet ss:Name="DetalheVendedor">\n<Table>\n<Row>\n';
        headers.forEach(h => {
        ...
        rows.forEach(row => {
          xml += "<Row>\n";
          xml += `<Cell><Data ss:Type="Number">${row.CODPARC || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="String">${escapeXml(String(row.PARCEIRO || ""))}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.QTDPREV || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.QTDREAL || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${parseFloat(row.PERC || 0) / 100}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.VLR_PREV || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.VLR_REAL || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${parseFloat(row.PERC_VLR || 0) / 100}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.TICKET_MEDIO || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.TICKET_MEDIO_META || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${parseFloat(row.VAR_PERC_TICKET_MEDIO || 0) / 100}</Data></Cell>\n`;
          xml += "</Row>\n";
        });
        xml += "</Table>\n</Worksheet>\n</Workbook>";
        ...
        link.download = `detalhe_vendedor_${currentVendedorCod}.xls`;
        link.click();
        URL.revokeObjectURL(link.href);
      }

      // ===== Overlay Detalhe da Marca: Funções de controle =====
      async function openMarcaDetailOverlay(marca) {
        currentMarcaNome = marca;
        const modal = document.getElementById("marcaDetailModal");
        if (modal) {
          modal.classList.add("show");
          const title = modal.querySelector(".overlay-title");
          if (title) {
            title.innerHTML = `<i class="fas fa-tags"></i> Detalhe da Marca - ${marca}`;
          }
        }
        await reloadMarcaDetail();
      }

      function closeMarcaDetailOverlay() {
        const modal = document.getElementById("marcaDetailModal");
        if (modal) modal.classList.remove("show");
      }

      async function reloadMarcaDetail() {
        if (!currentMarcaNome) return;
        try {
          if (typeof JX === "undefined" || !JX.consultar) return;
          const { dtInicio: dtInicioDefault, dtFim: dtFimDefault } = getDatasDinamicas();
          const dtInicio =
            document.getElementById("dtInicio").value || dtInicioDefault;
          const dtFim = document.getElementById("dtFim").value || dtFimDefault;
          const sql = buildMarcaDetailSQL(dtInicio, dtFim, currentMarcaNome);
          const rows = await JX.consultar(sql);
          marcaDetailRaw = rows || [];
          renderMarcaDetail(marcaDetailRaw);
          filterMarcaDetail();
        } catch (e) {
          console.error("Erro ao recarregar detalhe da marca:", e);
        }
      }

      function renderMarcaDetail(rows) {
        const tbody = document.getElementById("marcaDetailBody");
        if (!tbody) return;
        tbody.innerHTML = (rows || [])
          .map((r) => {
            const qr = parseFloat(r.QTDREAL || 0);
      ...
      function filterMarcaDetail() {
        const term = (
          document.getElementById("marcaDetailSearch").value || ""
        ).toLowerCase();
        const rows = (marcaDetailRaw || []).filter((r) => {
          return (
            !term ||
            String(r.CODVEND || "")
              .toLowerCase()
        ...
        const sortedRows = applyMarcaDetailSort(rows);
        renderMarcaDetail(sortedRows);
      }

      function handleMarcaDetailSort(columnKey) {
        if (marcaDetailSortState.column === columnKey) {
          marcaDetailSortState.direction = marcaDetailSortState.direction === "asc" ? "desc" : "asc";
        } else {
          marcaDetailSortState.column = columnKey;
          marcaDetailSortState.direction = "asc";
        }
        filterMarcaDetail();
      }

      function applyMarcaDetailSort(rows) {
        if (!marcaDetailSortState.column || !Array.isArray(rows)) return rows;
        const sorted = [...rows];
        sorted.sort((a, b) => {
          let aVal, bVal;
          switch (marcaDetailSortState.column) {
            case "codvend":
              aVal = parseFloat(a.CODVEND || 0);
              bVal = parseFloat(b.CODVEND || 0);
              break;
            case "apelido":
              aVal = String(a.APELIDO || "").toLowerCase();
              bVal = String(b.APELIDO || "").toLowerCase();
              break;
            case "qtdprev":
              aVal = parseFloat(a.QTDPREV || 0);
              bVal = parseFloat(b.QTDPREV || 0);
          ...
          const dir = marcaDetailSortState.direction === "desc" ? -1 : 1;
          if (typeof aVal === "string") {
            return aVal.localeCompare(bVal, "pt-BR") * dir;
          }
          return (aVal > bVal ? 1 : aVal < bVal ? -1 : 0) * dir;
      ...
      function exportMarcaDetailToExcel() {
        const rows = marcaDetailRaw || [];
        if (rows.length === 0) {
          alert("Não há dados para exportar");
          return;
        }
        ...
        rows.forEach((row) => {
          ...
          const pctQtd = qp > 0 ? (qr / qp) * 100 : null;
          const pctVlr = vp > 0 ? (vr / vp) * 100 : null;
          const ticketMedio = qr > 0 ? vr / qr : 0;
          const ticketMedioMeta = qp > 0 ? vp / qp : 0;
          const varPercTicket = ticketMedioMeta > 0 ? ((ticketMedio - ticketMedioMeta) / ticketMedioMeta) * 100 : null;
          ...
          headers.forEach((header) => {
            ...
            if (header === "% ATING. QTD") {
              ...
              value = pctVlr;
            } else if (header === "TICKET MÉDIO") {
              value = ticketMedio;
            } else if (header === "TICKET MÉDIO META") {
              value = ticketMedioMeta;
            } else if (header === "VAR. % TICKET MÉDIO") {
              value = varPercTicket;
            } else {
              value = row[header] ?? "";
            ...
            xml += `<Cell><Data ss:Type="${isNum ? "Number" : "String"}">${value ?? ""}</Data></Cell>\n`;
          });
          xml += "</Row>\n";
        });
        xml += "</Table>\n</Worksheet>\n</Workbook>";
        ...
        const link = document.createElement("a");
        link.href = URL.createObjectURL(blob);
        link.download = `detalhe_marca_${(currentMarcaNome || '').replace(/[^a-z0-9]/gi, '_')}.xls`;
        link.click();
        URL.revokeObjectURL(link.href);
      }

      // ===== Overlay Detalhe do Parceiro: Funções de controle =====
      async function openParceiroDetailOverlay(codVend, codParc, nomeParceiro) {
        currentParceiroCod = codParc;
        currentParceiroNome = nomeParceiro;
        // Reset expansão/caches ao trocar o parceiro (evita mistura de marcas/produtos)
        parceiroMarcaProdutosCache = {};
        parceiroMarcaProdutosLoading = {};
        parceiroMarcaProdutosExpanded = {};
        const modal = document.getElementById("parceiroDetailModal");
        if (modal) {
          modal.classList.add("show");
          const title = modal.querySelector(".overlay-title");
          if (title) {
            title.innerHTML = `<i class="fas fa-handshake"></i> Detalhe do Parceiro - ${nomeParceiro} (${codParc})`;
          }
        }
        await reloadParceiroDetail();
      }

      function closeParceiroDetailOverlay() {
        const modal = document.getElementById("parceiroDetailModal");
        if (modal) modal.classList.remove("show");
      }

      async function reloadParceiroDetail() {
        ...
        try {
          ...
          const dtInicio =
            document.getElementById("dtInicio").value || dtInicioDefault;
          const dtFim = document.getElementById("dtFim").value || dtFimDefault;
          const sql = buildParceiroDetailSQL(dtInicio, dtFim, currentVendedorCod, currentParceiroCod);
          const rows = await JX.consultar(sql);
          parceiroDetailRaw = rows || [];
          renderParceiroDetail(parceiroDetailRaw);
          filterParceiroDetail();
        } catch (e) {
          console.error("Erro ao recarregar detalhe do parceiro:", e);
        }
      }
      ...
      function getMarcaProdutosKey(marca) {
        return `${currentVendedorCod || 0}|${currentParceiroCod || 0}|${String(marca || "")}`;
      }

      function renderMarcaProdutosInto(containerEl, rows) {
            ...
            <tbody>
              ${data
                .map((r) => {
                  ...
                  const qtd = formatNumber(parseFloat(r.QTD_REAL || 0));
                  const vlr = formatCurrency(parseFloat(r.VLR_REAL || 0));
                  return `<tr>
                    <td>${cod}</td>
                    <td>${prod}</td>
      ...
      async function ensureMarcaProdutosLoaded(marca) {
        const key = getMarcaProdutosKey(marca);
        if (parceiroMarcaProdutosCache[key]) return;
        if (parceiroMarcaProdutosLoading[key]) return;
        parceiroMarcaProdutosLoading[key] = true;

        const domId = toDomId(key);
        const nested = document.getElementById(`marcaNested_${domId}`);
        if (nested) {
          nested.innerHTML =
        ...
        try {
          ...
          const dtInicio =
            document.getElementById("dtInicio").value || dtInicioDefault;
          const dtFim = document.getElementById("dtFim").value || dtFimDefault;
          const sql = buildMarcaProdutoDetailSQL(
            dtInicio,
            dtFim,
            currentVendedorCod,
            currentParceiroCod,
          ...
          const rows = await JX.consultar(sql);
          parceiroMarcaProdutosCache[key] = rows || [];
          renderMarcaProdutosInto(nested, parceiroMarcaProdutosCache[key]);
        } catch (e) {
          ...
          parceiroMarcaProdutosLoading[key] = false;
        }
      }

      async function toggleMarcaProdutos(marca) {
        const key = getMarcaProdutosKey(marca);
        const domId = toDomId(key);
        const expRow = document.getElementById(`marcaExpRow_${domId}`);
        const icon = document.getElementById(`marcaExpIcon_${domId}`);
        const willExpand = !(parceiroMarcaProdutosExpanded[key] === true);

        parceiroMarcaProdutosExpanded[key] = willExpand;
        if (expRow) expRow.style.display = willExpand ? "table-row" : "none";
        if (icon) icon.textContent = willExpand ? "-" : "+";

        if (willExpand) {
          await ensureMarcaProdutosLoaded(marca);
        }
        updateToggleAllButtonState();
      }

      async function toggleAllParceiroDetailExpansion() {
        const rows = parceiroDetailRaw || [];
        if (rows.length === 0) return;

        // Verifica se todos estão expandidos
        let allExpanded = true;
        for (const r of rows) {
          const marca = r.MARCA ?? "";
          const key = getMarcaProdutosKey(marca);
          if (!(parceiroMarcaProdutosExpanded[key] === true)) {
            allExpanded = false;
            break;
          }
        }
      ...
      function updateToggleAllButtonState() {
        const rows = parceiroDetailRaw || [];
        const btn = document.getElementById("toggleAllParceiroDetailBtn");
        const icon = document.getElementById("toggleAllParceiroDetailIcon");
        const text = document.getElementById("toggleAllParceiroDetailText");
        ...
        if (text) {
          text.textContent = allExpanded ? "Retrair Todos" : "Expandir Todos";
        }
      }

      function renderParceiroDetail(rows) {
        const tbody = document.getElementById("parceiroDetailBody");
        if (!tbody) return;
        tbody.innerHTML = (rows || [])
          .map((r) => {
            const qr = parseFloat(r.QTDREAL || 0);
            ...
            const marca = r.MARCA ?? "";
            const marcaJs = String(marca).replace(/'/g, "\\'");
            const key = getMarcaProdutosKey(marca);
            const domId = toDomId(key);
            const isExpanded = parceiroMarcaProdutosExpanded[key] === true;
            const iconSymbol = isExpanded ? "-" : "+";

            return `<tr>
            <td>
              <span class="expand-toggle" onclick="event.stopPropagation(); toggleMarcaProdutos('${marcaJs}')">
                <span class="expand-icon" id="marcaExpIcon_${domId}">${iconSymbol}</span>
                <span>${marca}</span>
              </span>
            </td>
            <td class="text-center metric-value">${qtdPrevFmt}</td>
          ...
          <tr class="exp-row" id="marcaExpRow_${domId}" style="display: ${
              isExpanded ? "table-row" : "none"
            }">
            <td colspan="10">
              <div class="nested-wrap" id="marcaNested_${domId}"></div>
            </td>
          </tr>`;
          })
          .join("");
        ...
        (rows || []).forEach((r) => {
          const marca = r.MARCA ?? "";
          const key = getMarcaProdutosKey(marca);
          if (parceiroMarcaProdutosExpanded[key] !== true) return;
          const domId = toDomId(key);
          const nested = document.getElementById(`marcaNested_${domId}`);
          if (!nested) return;
          if (parceiroMarcaProdutosCache[key]) {
            renderMarcaProdutosInto(nested, parceiroMarcaProdutosCache[key]);
          } else if (!parceiroMarcaProdutosLoading[key]) {
            // dispara carregamento sob demanda sem quebrar o layout
            ensureMarcaProdutosLoaded(marca);
          }
        });
        updateToggleAllButtonState();
      }

      function filterParceiroDetail() {
        const term = (
          document.getElementById("parceiroDetailSearch").value || ""
        ).toLowerCase();
        const rows = (parceiroDetailRaw || []).filter((r) => {
          return (
            !term ||
            String(r.MARCA || "")
              .toLowerCase()
        ...
        const sortedRows = applyParceiroDetailSort(rows);
        renderParceiroDetail(sortedRows);
      }

      function handleParceiroDetailSort(columnKey) {
        if (parceiroDetailSortState.column === columnKey) {
          parceiroDetailSortState.direction = parceiroDetailSortState.direction === "asc" ? "desc" : "asc";
        } else {
          parceiroDetailSortState.column = columnKey;
          parceiroDetailSortState.direction = "asc";
        }
        filterParceiroDetail();
      }

      function applyParceiroDetailSort(rows) {
        if (!parceiroDetailSortState.column || !Array.isArray(rows)) return rows;
        const sorted = [...rows];
        sorted.sort((a, b) => {
          let aVal, bVal;
          switch (parceiroDetailSortState.column) {
            case "marca":
              aVal = String(a.MARCA || "").toLowerCase();
              bVal = String(b.MARCA || "").toLowerCase();
              break;
            case "qtdprev":
              aVal = parseFloat(a.QTDPREV || 0);
              bVal = parseFloat(b.QTDPREV || 0);
          ...
          const dir = parceiroDetailSortState.direction === "desc" ? -1 : 1;
          if (typeof aVal === "string") {
            return aVal.localeCompare(bVal, "pt-BR") * dir;
          }
          return (aVal > bVal ? 1 : aVal < bVal ? -1 : 0) * dir;
      ...
      function exportParceiroDetailToExcel() {
        const rows = parceiroDetailRaw || [];
        if (rows.length === 0) {
          alert("Não há dados para exportar");
          return;
        ...
        let xml = '<?xml version="1.0"?>\n<?mso-application progid="Excel.Sheet"?>\n<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet">\n<Worksheet ss:Name="DetalheParceiro">\n<Table>\n<Row>\n';
        headers.forEach(h => {
          xml += `<Cell><Data ss:Type="String">${escapeXml(h)}</Data></Cell>\n`;
        });
        xml += "</Row>\n";
        rows.forEach(row => {
          xml += "<Row>\n";
          xml += `<Cell><Data ss:Type="String">${escapeXml(String(row.MARCA || ""))}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.QTDPREV || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.QTDREAL || 0}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${parseFloat(row.PERC || 0) / 100}</Data></Cell>\n`;
          xml += `<Cell><Data ss:Type="Number">${row.VLR_PREV || 0}</Data></Cell>\n`;
        ...
        const link = document.createElement("a");
        link.href = URL.createObjectURL(blob);
        link.download = `detalhe_parceiro_${currentParceiroCod}.xls`;
        link.click();
        URL.revokeObjectURL(link.href);
      }

      // ===== Overlay Detalhe do Parceiro - Marcas: Funções de controle =====
      async function openParceiroMarcaDetailOverlay(codParc, nomeParceiro) {
        currentParceiroMarcaCod = codParc;
        currentParceiroMarcaNome = nomeParceiro;
        // Reset expansão/caches ao trocar o parceiro (evita mistura de marcas/produtos)
        parceiroMarcaDetailProdutosCache = {};
        parceiroMarcaDetailProdutosLoading = {};
        parceiroMarcaDetailProdutosExpanded = {};
        const modal = document.getElementById("parceiroMarcaDetailModal");
        if (modal) {
          modal.classList.add("show");
          const title = modal.querySelector(".overlay-title");
          if (title) {
            title.innerHTML = `<i class="fas fa-tags"></i> Detalhe do Parceiro - ${nomeParceiro} (${codParc})`;
          }
        }
        await reloadParceiroMarcaDetail();
      }

      function closeParceiroMarcaDetailOverlay() {
        const modal = document.getElementById("parceiroMarcaDetailModal");
        if (modal) modal.classList.remove("show");
      }

      async function reloadParceiroMarcaDetail() {
        if (!currentParceiroMarcaCod) return;
        try {
          if (typeof JX === "undefined" || !JX.consultar) return;
          const { dtInicio: dtInicioDefault, dtFim: dtFimDefault } = getDatasDinamicas();
          const dtInicio =
            document.getElementById("dtInicio").value || dtInicioDefault;
          const dtFim = document.getElementById("dtFim").value || dtFimDefault;
          const sql = buildParceiroMarcaDetailSQL(dtInicio, dtFim, currentParceiroMarcaCod);
          const rows = await JX.consultar(sql);
          parceiroMarcaDetailRaw = rows || [];
          renderParceiroMarcaDetail(parceiroMarcaDetailRaw);
          filterParceiroMarcaDetail();
          
          // Atualizar título com informações dos vendedores
          const vendedores = [];
          const vendedoresMap = new Map();
          (parceiroMarcaDetailRaw || []).forEach((r) => {
            if (r.CODVEND && r.APELIDO) {
              const key = `${r.CODVEND}`;
              if (!vendedoresMap.has(key)) {
                vendedoresMap.set(key, r.APELIDO);
                vendedores.push(`${r.CODVEND} - ${r.APELIDO}`);
              }
            }
          });
            ...
            if (title) {
              ...
              if (vendedores.length > 0) {
                if (vendedores.length === 1) {
                  vendedoresText = ` - Vendedor: ${vendedores[0]}`;
                } else if (vendedores.length <= 3) {
                  vendedoresText = ` - Vendedor: ${vendedores.join(", ")}`;
                } else {
                  vendedoresText = ` - Vendedor: ${vendedores.slice(0, 2).join(", ")} e mais ${vendedores.length - 2}`;
                }
              }
              title.innerHTML = `<i class="fas fa-tags"></i> Detalhe do Parceiro - ${currentParceiroMarcaNome} (${currentParceiroMarcaCod})${vendedoresText}`;
            }
          }
        } catch (e) {
          console.error("Erro ao recarregar detalhe do parceiro - marcas:", e);
        }
      }

      // ===== Overlay Detalhe do Parceiro - Marcas: Funções de expansão =====
      function getParceiroMarcaProdutosKey(marca) {
        return `${currentParceiroMarcaCod || 0}|${String(marca || "")}`;
      }

      function renderParceiroMarcaProdutosInto(containerEl, rows) {
        if (!containerEl) return;
        const data = Array.isArray(rows) ? rows : [];
        if (!data.length) {
          containerEl.innerHTML =
      ...
      async function ensureParceiroMarcaProdutosLoaded(marca) {
        const key = getParceiroMarcaProdutosKey(marca);
        if (parceiroMarcaDetailProdutosCache[key]) return;
        if (parceiroMarcaDetailProdutosLoading[key]) return;
        parceiroMarcaDetailProdutosLoading[key] = true;

        const domId = toDomId(key);
        const nested = document.getElementById(`parceiroMarcaNested_${domId}`);
        if (nested) {
          nested.innerHTML =
            '<div class="nested-empty">Carregando produtos...</div>';
        }
        ...
        try {
          ...
          const dtInicio =
            document.getElementById("dtInicio").value || dtInicioDefault;
          const dtFim = document.getElementById("dtFim").value || dtFimDefault;
          const sql = buildParceiroMarcaProdutoDetailSQL(
            dtInicio,
            dtFim,
            currentParceiroMarcaCod,
            marca
          );
          const rows = await JX.consultar(sql);
          parceiroMarcaDetailProdutosCache[key] = rows || [];
          renderParceiroMarcaProdutosInto(nested, parceiroMarcaDetailProdutosCache[key]);
        } catch (e) {
          console.error("Erro ao carregar produtos da marca:", e);
          if (nested) {
            nested.innerHTML =
          ...
          parceiroMarcaDetailProdutosLoading[key] = false;
        }
      }

      async function toggleParceiroMarcaProdutos(marca) {
        const key = getParceiroMarcaProdutosKey(marca);
        const domId = toDomId(key);
        const expRow = document.getElementById(`parceiroMarcaExpRow_${domId}`);
        const icon = document.getElementById(`parceiroMarcaExpIcon_${domId}`);
        const willExpand = !(parceiroMarcaDetailProdutosExpanded[key] === true);

        parceiroMarcaDetailProdutosExpanded[key] = willExpand;
        if (expRow) expRow.style.display = willExpand ? "table-row" : "none";
        if (icon) icon.textContent = willExpand ? "-" : "+";

        if (willExpand) {
          await ensureParceiroMarcaProdutosLoaded(marca);
        }
        updateToggleAllParceiroMarcaDetailButtonState();
      }

      async function toggleAllParceiroMarcaDetailExpansion() {
        const rows = parceiroMarcaDetailRaw || [];
        if (rows.length === 0) return;
        ...
        for (const r of rows) {
          const marca = r.MARCA ?? "";
          const key = getParceiroMarcaProdutosKey(marca);
          if (!(parceiroMarcaDetailProdutosExpanded[key] === true)) {
            allExpanded = false;
            break;
          }
        }
      ...
      function updateToggleAllParceiroMarcaDetailButtonState() {
        const rows = parceiroMarcaDetailRaw || [];
        const btn = document.getElementById("toggleAllParceiroMarcaDetailBtn");
        const icon = document.getElementById("toggleAllParceiroMarcaDetailIcon");
        const text = document.getElementById("toggleAllParceiroMarcaDetailText");
      ...
      function renderParceiroMarcaDetail(rows) {
        const tbody = document.getElementById("parceiroMarcaDetailBody");
        if (!tbody) return;
        tbody.innerHTML = (rows || [])
          .map((r) => {
            const qr = parseFloat(r.QTDREAL || 0);
            ...
            const key = getParceiroMarcaProdutosKey(marca);
            const domId = toDomId(key);
            const isExpanded = parceiroMarcaDetailProdutosExpanded[key] === true;
            const iconSymbol = isExpanded ? "-" : "+";

            return `<tr>
            <td>
              <span class="expand-toggle" onclick="event.stopPropagation(); toggleParceiroMarcaProdutos('${marcaJs}')">
                <span class="expand-icon" id="parceiroMarcaExpIcon_${domId}">${iconSymbol}</span>
                <span>${marca}</span>
              </span>
            </td>
            <td class="text-center metric-value">${qtdPrevFmt}</td>
          ...
          <tr class="exp-row" id="parceiroMarcaExpRow_${domId}" style="display: ${
              isExpanded ? "table-row" : "none"
            }">
            <td colspan="10">
              <div class="nested-wrap" id="parceiroMarcaNested_${domId}"></div>
            </td>
          </tr>`;
          })
          .join("");
        ...
        (rows || []).forEach((r) => {
          const marca = r.MARCA ?? "";
          const key = getParceiroMarcaProdutosKey(marca);
          if (parceiroMarcaDetailProdutosExpanded[key] !== true) return;
          const domId = toDomId(key);
          const nested = document.getElementById(`parceiroMarcaNested_${domId}`);
          if (!nested) return;
          if (parceiroMarcaDetailProdutosCache[key]) {
            renderParceiroMarcaProdutosInto(nested, parceiroMarcaDetailProdutosCache[key]);
          } else if (!parceiroMarcaDetailProdutosLoading[key]) {
            // dispara carregamento sob demanda sem quebrar o layout
            ensureParceiroMarcaProdutosLoaded(marca);
          }
        });
        updateToggleAllParceiroMarcaDetailButtonState();
      }

      function filterParceiroMarcaDetail() {
        const term = (
          document.getElementById("parceiroMarcaDetailSearch").value || ""
        ).toLowerCase();
        const rows = (parceiroMarcaDetailRaw || []).filter((r) => {
          return (
            !term ||
            String(r.MARCA || "")
              .toLowerCase()
        ...
        const sortedRows = applyParceiroMarcaDetailSort(rows);
        renderParceiroMarcaDetail(sortedRows);
      }

      function handleParceiroMarcaDetailSort(columnKey) {
        if (parceiroMarcaDetailSortState.column === columnKey) {
          parceiroMarcaDetailSortState.direction = parceiroMarcaDetailSortState.direction === "asc" ? "desc" : "asc";
        } else {
          parceiroMarcaDetailSortState.column = columnKey;
          parceiroMarcaDetailSortState.direction = "asc";
        }
        filterParceiroMarcaDetail();
      }

      function applyParceiroMarcaDetailSort(rows) {
        if (!parceiroMarcaDetailSortState.column || !Array.isArray(rows)) return rows;
        const sorted = [...rows];
        sorted.sort((a, b) => {
          let aVal, bVal;
          switch (parceiroMarcaDetailSortState.column) {
            case "codvend":
              aVal = parseFloat(a.CODVEND || 0);
              bVal = parseFloat(b.CODVEND || 0);
              break;
          ...
          const dir = parceiroMarcaDetailSortState.direction === "desc" ? -1 : 1;
          if (typeof aVal === "string") {
            return aVal.localeCompare(bVal, "pt-BR") * dir;
          }
          return (aVal > bVal ? 1 : aVal < bVal ? -1 : 0) * dir;
      ...
      function exportParceiroMarcaDetailToExcel() {
        const rows = parceiroMarcaDetailRaw || [];
        if (rows.length === 0) {
          alert("Não há dados para exportar");
          return;
        ...
        let xml = '<?xml version="1.0"?>\n<?mso-application progid="Excel.Sheet"?>\n<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet">\n<Worksheet ss:Name="DetalheParceiroMarcas">\n<Table>\n<Row>\n';
        headers.forEach(h => {
          xml += `<Cell><Data ss:Type="String">${escapeXml(h)}</Data></Cell>\n`;
        });
        xml += "</Row>\n";
        ...
        const link = document.createElement("a");
        link.href = URL.createObjectURL(blob);
        link.download = `detalhe_parceiro_marcas_${currentParceiroMarcaCod}.xls`;
        link.click();
        URL.revokeObjectURL(link.href);
      }
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        // Fechar dropdowns ao clicar em qualquer lugar da página
