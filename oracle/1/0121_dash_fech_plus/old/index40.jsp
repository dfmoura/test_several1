...
<html lang="pt">
  <head>
    ...
    <style>
      ...
      /* Cards dinâmicos de variáveis - Layout Compacto */
      .compact-variable-card {
        background: white;
        border-radius: 12px;
      ...
      .compact-detail-value.currency {
        color: #28a745;
      }

      .compact-detail-value.number {
        color: #007bff;
      }
  ...
  <body>
    ...
    <div class="main-container">
      ...
      <!-- Seção de Cards Compactos de Variáveis -->
        ...
        <div class="row">
          <div class="col-lg-12 mb-3">
            <div class="chart-container" style="padding: 15px">
              ...
              <div id="compactVariablesCardsContainer">
    ...
    <script>
      ...
      // Função para carregar dados das variáveis de benefício (versão compacta)
      async function loadCompactVariablesData() {
        try {
          ...
          if (data && data.length > 0) {
            ...
            window.compactVariablesData = data.map((item) => ({
            ...
            // Renderizar cards compactos das variáveis
            renderCompactVariablesCards();
          } else {
            // Mostrar mensagem quando não há dados
            document.getElementById(
              "compactVariablesCardsContainer"
            ).innerHTML = `
              <div class="text-center py-3">
      ...
      // Função para renderizar cards compactos das variáveis dinamicamente
      function renderCompactVariablesCards() {
        const container = document.getElementById(
          "compactVariablesCardsContainer"
        );

        if (
          !window.compactVariablesData ||
          window.compactVariablesData.length === 0
        ) {
          container.innerHTML = `
            <div class="text-center py-3">
              <i class="fas fa-info-circle text-muted" style="font-size: 24px;"></i>
        ...
        // Criar cards compactos em layout horizontal
        const cardsHTML = window.compactVariablesData
          .map((variable, index) => {
            ...
            return `
            <div class="compact-variable-card">
              <div class="compact-card-left">
                <div class="compact-card-icon">
                  <i class="${icon}"></i>
                </div>
                <div class="compact-card-info">
                  <div class="compact-card-title">${variable.descrvar}</div>
              ...
              <div class="compact-card-right">
                <div class="compact-percentage">${variable.perc_ating_var.toFixed(
                  1
                )}%</div>
                <div class="compact-details">
                  <div class="compact-detail-item">
                    <div class="compact-detail-label">Real</div>
                    <div class="compact-detail-value currency">${formatCompactCurrency(
                      variable.beneficio_real
                    )}</div>
                  </div>
                  <div class="compact-detail-item">
                    <div class="compact-detail-label">Previsto</div>
                    <div class="compact-detail-value currency">${formatCompactCurrency(
      ...
      // Função auxiliar para formatação compacta de moeda
      ...
      async function initializeDashboard() {
        try {
          ...
          await loadCompactVariablesData();
        } catch (error) {
