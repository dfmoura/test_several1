...
<body>
    ...
    <button class="btn btn-primary overlay-btn" data-toggle="modal" data-target="#addRecordModal">Adicionar Novo Registro</button>
    ...
    <script>
        ...
        function saveRecord() {
            const dados = {
                ...
                //USUARIO: 'usuario_teste'  // Substitua pelo nome do usuário atual
            };
