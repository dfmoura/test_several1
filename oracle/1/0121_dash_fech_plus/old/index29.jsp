  ...
  <body>
    ...
    <div class="main-container">
      ...
      <div class="row mb-0">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
          <div
            class="card dashboard-card card-atingido"
            onclick="openAtingidoOverlay()"
          >
            <div class="card-body">
              <div class="card-icon">
          ...
          <div class="filters-grid">
            ...
            <div class="filter-group">
              ...
              <div class="range-inputs">
                <input
                  type="number"
                  id="faturamentoFilterQtdPrevMin"
                  class="filter-input"
                  placeholder="Mín"
                />
                <span>até</span>
                <input
                  type="number"
                  id="faturamentoFilterQtdPrevMax"
                  class="filter-input"
                  placeholder="Máx"
                />
              </div>
            ...
            <div class="filter-group">
              ...
              <div class="range-inputs">
                <input
                  type="number"
                  id="faturamentoFilterQtdRealMin"
                  class="filter-input"
                  placeholder="Mín"
                />
                <span>até</span>
                <input
                  type="number"
                  id="faturamentoFilterQtdRealMax"
                  class="filter-input"
                  placeholder="Máx"
                />
              </div>
            ...
            <div class="filter-group">
              ...
              <div class="range-inputs">
                <input
                  type="number"
                  id="faturamentoFilterVlrPrevMin"
                  class="filter-input"
                  placeholder="Mín"
                  step="0.01"
                />
                ...
                <input
                  type="number"
                  id="faturamentoFilterVlrPrevMax"
                  class="filter-input"
                  placeholder="Máx"
                  step="0.01"
                />
            ...
            <div class="filter-group">
              ...
              <div class="range-inputs">
                <input
                  type="number"
                  id="faturamentoFilterVlrRealMin"
                  class="filter-input"
                  placeholder="Mín"
                  step="0.01"
                />
                ...
                <input
                  type="number"
                  id="faturamentoFilterVlrRealMax"
                  class="filter-input"
                  placeholder="Máx"
                  step="0.01"
                />
            ...
            <thead>
              <tr>
                ...
                <th
                  ...
                  data-sort="qtdprev"
                  onclick="sortFaturamentoTable('qtdprev')"
                >
                ...
                <th
                  class="sortable text-right"
                  data-sort="qtdreal"
                  onclick="sortFaturamentoTable('qtdreal')"
                >
                ...
                <th
                  class="sortable text-right"
                  data-sort="vlr_prev"
                  onclick="sortFaturamentoTable('vlr_prev')"
                >
                ...
                <th
                  class="sortable text-right"
                  data-sort="vlr_real"
                  onclick="sortFaturamentoTable('vlr_real')"
                >
                ...
                <th
                  class="sortable text-right"
                  data-sort="perc"
                  onclick="sortFaturamentoTable('perc')"
                >
            ...
            <thead>
              <tr>
                ...
                <th
                  class="sortable text-right"
                  data-sort="vlr_prev"
                  onclick="sortMetaTable('vlr_prev')"
                >
                  Valor Previsto <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="vlr_real"
                  onclick="sortMetaTable('vlr_real')"
                >
                  Valor Real <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
      ...
      <div class="overlay-content">
        ...
        <div class="overlay-toolbar">
          <div class="toolbar-left">
            ...
            <button
              class="btn-overlay btn-secondary has-active-filters"
              onclick="toggleAtingidoFilters()"
              id="atingidoFiltersToggle"
            >
              <i class="fas fa-filter"></i>
              Filtros Avançados
              <span
                class="filters-active-indicator"
                id="atingidoFiltersIndicator"
                style="display: none"
                >0</span
              >
            </button>
        ...
        <!-- Painel de Filtros Avançados para % Atingido -->
        <div
          class="filters-panel"
          id="atingidoFiltersPanel"
          style="display: none"
        >
          <div class="filters-header">
            <h4><i class="fas fa-filter"></i> Filtros Avançados</h4>
            <button class="btn-clear-filters" onclick="clearAtingidoFilters()">
              <i class="fas fa-times"></i>
              Limpar Filtros
            </button>
          </div>
          <div class="filters-grid">
            ...
            <div class="filter-group">
              <label>Status Meta:</label>
              <select id="atingidoFilterStatus" class="filter-select">
                <option value="">Todos</option>
                <option value="atingida">Meta Atingida (≥100%)</option>
                <option value="proxima">Próximo da Meta (80-99%)</option>
                <option value="abaixo">Abaixo da Meta (<80%)</option>
          ...
          <div class="filters-actions">
            <button
              class="btn-overlay btn-primary"
              onclick="applyAtingidoAdvancedFilters()"
            >
              <i class="fas fa-check"></i>
              Aplicar Filtros
            </button>
            ...
            <thead>
              <tr>
                <th
                  class="sortable"
                  data-sort="codvend"
                  onclick="sortAtingidoTable('codvend')"
                >
                  Código Vendedor <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="apelido"
                  onclick="sortAtingidoTable('apelido')"
                >
                  Vendedor <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="qtdprev"
                  onclick="sortAtingidoTable('qtdprev')"
                >
                  Qtd Prevista <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="qtdreal"
                  onclick="sortAtingidoTable('qtdreal')"
                >
                  Qtd Real <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="vlr_prev"
                  onclick="sortAtingidoTable('vlr_prev')"
                >
                  Valor Previsto <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="vlr_real"
                  onclick="sortAtingidoTable('vlr_real')"
                >
                  Valor Real <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="perc"
                  onclick="sortAtingidoTable('perc')"
                >
                  % Atingido <i class="fas fa-sort sort-icon"></i>
                </th>
              </tr>
        ...
        <div class="overlay-footer">
          <div class="footer-left">
            ...
            <select
              class="page-size-select"
              id="atingidoPageSize"
              onchange="changeAtingidoPageSize()"
            >
              <option value="10">10 por página</option>
              <option value="25" selected>25 por página</option>
              <option value="50">50 por página</option>
      ...
      <div class="overlay-content">
        ...
        <div class="overlay-toolbar">
          <div class="toolbar-left">
            ...
            <button class="btn-overlay" onclick="toggleBeneficioFilters()">
              <i class="fas fa-filter"></i>
              Filtros Avançados
            </button>
        ...
        >
          ...
          <div class="filters-grid">
            ...
            <div class="filter-group">
              <label>Variável Preço Médio:</label>
              <div class="range-inputs">
                <input
                  type="number"
                  id="beneficioFilterPrecoMedMin"
                  class="filter-input"
                  placeholder="Mín"
                />
                <span>até</span>
            ...
            <div class="filter-group">
              <label>Variável Custo CR:</label>
              <div class="range-inputs">
                <input
                  type="number"
                  id="beneficioFilterCustoCRMin"
                  class="filter-input"
                  placeholder="Mín"
                />
                <span>até</span>
            ...
            <div class="filter-group">
              <label>Variável Faturamento:</label>
              <div class="range-inputs">
                <input
                  type="number"
                  id="beneficioFilterFaturamentoMin"
                  class="filter-input"
                  placeholder="Mín"
                />
                <span>até</span>
                <input
                  type="number"
                  id="beneficioFilterFaturamentoMax"
                  class="filter-input"
                  placeholder="Máx"
                />
              </div>
            ...
            <div class="filter-group">
              <label>FAT Grupo Prod Gat:</label>
              <div class="range-inputs">
                <input
                  type="number"
                  id="beneficioFilterFatGrupoMin"
                  class="filter-input"
                  placeholder="Mín"
                />
                <span>até</span>
            ...
            <thead>
              <tr>
                ...
                <th
                  class="sortable text-right"
                  data-sort="gatilho"
                  onclick="sortBeneficioTable('gatilho')"
                >
                  Gatilho <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="variavel_precomed"
                  onclick="sortBeneficioTable('variavel_precomed')"
                >
                  Variável Preço Médio <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="variavel_custo_cr"
                  onclick="sortBeneficioTable('variavel_custo_cr')"
                >
                  Variável Custo CR <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="variavel_faturamento"
                  onclick="sortBeneficioTable('variavel_faturamento')"
                >
                  Variável Faturamento <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="fat_grupoprodgat"
                  onclick="sortBeneficioTable('fat_grupoprodgat')"
                >
                  FAT Grupo Prod Gat <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="total"
                  onclick="sortBeneficioTable('total')"
                >
        ...
        <div class="overlay-footer">
          <div class="footer-left">
            <span class="results-info" id="beneficioResultsInfo">
            ...
            <thead>
              <tr>
                <th
                  class="sortable"
                  data-sort="mes"
                  onclick="sortEvolucaoMensalTable('mes')"
                >
                  Mês <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="ano"
                  onclick="sortEvolucaoMensalTable('ano')"
                >
                  Ano <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="mes_ano"
                  onclick="sortEvolucaoMensalTable('mes_ano')"
                >
                  Mês/Ano <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="codvend"
    ...
    <!-- Overlay Modal para Detalhamento Vendedor -->
    <div class="overlay-modal" id="vendedorModal">
      <div class="overlay-content">
        <div class="overlay-header">
          <h2 class="overlay-title">
            <i class="fas fa-user-tie"></i>
            Detalhamento Vendedor
          </h2>
          <button class="overlay-close" onclick="closeOverlay('vendedorModal')">
            <i class="fas fa-times"></i>
          </button>
        </div>
          ...
          <div class="toolbar-left">
            <div class="search-container">
              ...
              <input
                ...
                id="vendedorSearch"
                class="search-input"
                placeholder="Busca geral por vendedor, código, parceiro..."
              />
            </div>
            <button class="btn-overlay" onclick="toggleVendedorFilters()">
              <i class="fas fa-filter"></i>
              Filtros Avançados
            </button>
            <button class="btn-overlay" onclick="refreshVendedorData()">
              <i class="fas fa-sync-alt"></i>
              Atualizar
            </button>
          </div>
        ...
        <div
          class="filters-panel"
          id="vendedorFiltersPanel"
          style="display: none"
        >
          <div class="filters-header">
            <h4><i class="fas fa-filter"></i> Filtros Avançados</h4>
            <button class="btn-clear-filters" onclick="clearVendedorFilters()">
              <i class="fas fa-times"></i> Limpar Filtros
            </button>
          </div>
          <div class="filters-grid">
            ...
            <div class="filter-group">
              ...
              <input
                type="text"
                id="vendedorFilterParceiro"
                class="filter-input"
                placeholder="Ex: Empresa ou Empresa,Loja"
              />
            </div>
            <div class="filter-group">
              <label>Marca:</label>
              <input
                type="text"
                id="vendedorFilterMarca"
                class="filter-input"
                placeholder="Ex: Marca1 ou Marca1,Marca2"
              />
            </div>
            <div class="filter-group">
              <label>Qtd Prevista:</label>
        ...
        <!-- Tabela de Dados -->
        <div class="overlay-table-container">
          <div class="loading-overlay" id="vendedorLoadingOverlay">
            <div class="spinner"></div>
          </div>

          <table class="overlay-table" id="vendedorTable">
            <thead>
              <tr>
                <th
                  class="sortable"
                  data-sort="dtref"
                  onclick="sortVendedorTable('dtref')"
                >
                  Data Ref. <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="codvend"
                  onclick="sortVendedorTable('codvend')"
                >
                  Código Vendedor <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="apelido"
                  onclick="sortVendedorTable('apelido')"
                >
                  Vendedor <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="codger"
                  onclick="sortVendedorTable('codger')"
                >
                  Código Gerente <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="codparc"
                  onclick="sortVendedorTable('codparc')"
                >
                ...
                <th
                  class="sortable"
                  data-sort="parceiro"
                  onclick="sortVendedorTable('parceiro')"
                >
                  Parceiro <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable"
                  data-sort="marca"
                  onclick="sortVendedorTable('marca')"
                >
                ...
                <th
                  class="sortable text-right"
                  data-sort="qtdprev"
                  onclick="sortVendedorTable('qtdprev')"
                >
                  Qtd Prevista <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="qtdreal"
                  onclick="sortVendedorTable('qtdreal')"
                >
                  Qtd Real <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="vlr_prev"
                  onclick="sortVendedorTable('vlr_prev')"
                >
                  Valor Previsto <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="vlr_real"
                  onclick="sortVendedorTable('vlr_real')"
                >
                  Valor Real <i class="fas fa-sort sort-icon"></i>
                </th>
                <th
                  class="sortable text-right"
                  data-sort="perc"
                  onclick="sortVendedorTable('perc')"
                >
                  % Atingido <i class="fas fa-sort sort-icon"></i>
                </th>
              </tr>
            </thead>
            <tbody id="vendedorTableBody">
              <!-- Dados serão inseridos via JavaScript -->
            </tbody>
          </table>
        </div>
        ...
        <div class="overlay-footer">
          <div class="footer-left">
            <span class="results-info" id="vendedorResultsInfo">
              Mostrando 0 de 0 resultados
            </span>
            <select
              class="page-size-select"
              id="vendedorPageSize"
              onchange="changeVendedorPageSize()"
            >
              <option value="10">10 por página</option>
              <option value="20" selected>20 por página</option>
              <option value="50">50 por página</option>
          ...
          <div class="footer-right">
            <div class="pagination" id="vendedorPagination">
              <!-- Botões de paginação serão inseridos via JavaScript -->
            </div>
          </div>
        </div>
    ...
    <script>
      ...
      async function loadCardsData() {
        try {
          ...
          document.getElementById("faturamento-valor").textContent =
            formatCurrency(vlrReal);
          document.getElementById("meta-valor").textContent =
            formatCurrency(vlrPrev);
          document.getElementById("atingido-valor").textContent =
            formatPercentage(percentualAtingido);
      ...
      async function loadBarChartData() {
        try {
          ...
          if (typeof JX === "undefined" || !JX.consultar) {
            console.error(
              "SankhyaJX não está disponível para o gráfico de colunas"
            );
            return;
          }
          ...
          if (data && data.length > 0) {
            const labels = data.map(
              (item) => `${item.CODVEND} - ${item.APELIDO}`
            );
            const realData = data.map((item) => parseFloat(item.VLR_REAL) || 0);
            const metaData = data.map((item) => parseFloat(item.VLR_PREV) || 0);
            const codvendData = data.map((item) => item.CODVEND);

            createBarChart(labels, realData, metaData, codvendData);
          } else {
      ...
      function createBarChart(labels, realData, metaData, codvendData) {
        console.log("Criando gráfico de colunas com dados:", {
          labels,
          realData,
          metaData,
          codvendData,
          ...
          options: {
            ...
            onClick: function (event, elements) {
              if (elements.length > 0) {
                ...
                const codvend = codvendData[index];
                openVendedorOverlay(codvend);
              }
            },
          },
        });
        ...
        try {
          ...
          const sql = `
                    SELECT
                        ...
                        CASE WHEN SUM(QTDPREV * PRECOLT) = 0 THEN 0 ELSE SUM(VLRREAL) * 100 / NULLIF(SUM(QTDPREV * PRECOLT), 0) END AS PERC
                    FROM (
                        SELECT MET.CODMETA,MET.DTREF, NVL(MET.CODVEND,0) AS CODVEND, NVL(VEN.APELIDO,0) AS APELIDO,NVL(VEN.CODGER,0) AS CODGER, NVL(MET.CODPARC,0) AS CODPARC, 
                        NVL(PAR.RAZAOSOCIAL,0) AS PARCEIRO, 
                        NVL(MET.MARCA,0) AS MARCA,
        ...
        try {
          ...
          if (data && data.length > 0) {
            overlayStates.beneficio.data = data.map((item) => ({
              codvend: item.CODVEND,
              apelido: item.APELIDO,
              gatilho: parseFloat(item.GATILHO) || 0,
              variavel_precomed: parseFloat(item.VARIAVEL_PRECOMED) || 0,
              variavel_custo_cr: parseFloat(item.VARIAVEL_CUSTO_CR) || 0,
              variavel_faturamento: parseFloat(item.VARIAVEL_FATURAMENTO) || 0,
              fat_grupoprodgat: parseFloat(item.FAT_GRUPOPRODGAT) || 0,
      ...
      function renderAtingidoTable() {
        ...
        const pageData = overlayStates.atingido.filteredData.slice(
          startIndex,
          endIndex
        );
      ...
      function renderBeneficioTable() {
        ...
        pageData.forEach((item, index) => {
          ...
          row.innerHTML = `
                    ...
                    <td class="text-right font-semibold">${formatCurrency(
                      item.variavel_precomed
                    )}</td>
                    <td class="text-right font-semibold">${formatCurrency(
                      item.variavel_custo_cr
                    )}</td>
                    <td class="text-right font-semibold">${formatCurrency(
                      item.variavel_faturamento
                    )}</td>
                    <td class="text-right font-semibold">${formatCurrency(
                      item.fat_grupoprodgat
                    )}</td>
                    <td class="text-right font-semibold text-primary">${formatCurrency(
                      item.total
                    )}</td>
                `;
          tbody.appendChild(row);
      ...
      function renderEvolucaoMensalTable() {
        ...
        pageData.forEach((item, index) => {
          const row = document.createElement("tr");
          row.innerHTML = `
                    <td class="font-mono font-semibold">${item.mes}</td>
                    <td class="font-mono font-semibold">${item.ano}</td>
                    <td class="font-mono font-semibold">${item.mes_ano}</td>
                    <td class="font-mono font-semibold">${item.codvend}</td>
                    <td>${item.apelido}</td>
                    <td class="text-right font-semibold">${formatCurrency(
                      item.vlr_prev
      ...
      function renderVendedorTable() {
        ...
        pageData.forEach((item, index) => {
          const row = document.createElement("tr");
          row.innerHTML = `
                    <td class="font-mono font-semibold">${new Date(
                      item.dtref
                    ).toLocaleDateString("pt-BR")}</td>
                    <td class="font-mono font-semibold">${item.codvend}</td>
                    <td>${item.apelido}</td>
                    <td class="font-mono font-semibold">${item.codger}</td>
      ...
      function exportVendedorToExcel() {
        const ws = XLSX.utils.json_to_sheet(
          overlayStates.vendedor.filteredData.map((item) => ({
            "Data Ref.": new Date(item.dtref).toLocaleDateString("pt-BR"),
            "Código Vendedor": item.codvend,
            Vendedor: item.apelido,
            "Código Gerente": item.codger,
      ...
      function exportVendedorToPDF() {
        ...
        const tableData = overlayStates.vendedor.filteredData.map((item) => [
          new Date(item.dtref).toLocaleDateString("pt-BR"),
          item.codvend.toString(),
          item.apelido,
          item.codger.toString(),
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        const faturamentoFilterInputs = [
          ...
          "faturamentoFilterQtdPrevMin",
          "faturamentoFilterQtdPrevMax",
          "faturamentoFilterQtdRealMin",
          "faturamentoFilterQtdRealMax",
          "faturamentoFilterVlrPrevMin",
          "faturamentoFilterVlrPrevMax",
          "faturamentoFilterVlrRealMin",
          "faturamentoFilterVlrRealMax",
          "faturamentoFilterPercMin",
          "faturamentoFilterPercMax",
        ...
        document.getElementById("atingidoSearch").addEventListener(
          "input",
          debounce(function (e) {
        ...
        const metaFilterInputs = [
          "metaFilterCodvend",
          "metaFilterApelido",
          "metaFilterQtdPrevMin",
          "metaFilterQtdPrevMax",
          "metaFilterQtdRealMin",
          "metaFilterQtdRealMax",
          "metaFilterVlrPrevMin",
          "metaFilterVlrPrevMax",
          "metaFilterVlrRealMin",
          "metaFilterVlrRealMax",
          "metaFilterPercMin",
          "metaFilterPercMax",
        ];
        ...
        // Event listeners para filtros avançados do % Atingido
        const atingidoFilterInputs = [
          "atingidoFilterCodvend",
          "atingidoFilterApelido",
          "atingidoFilterQtdPrevMin",
          "atingidoFilterQtdPrevMax",
          "atingidoFilterQtdRealMin",
          "atingidoFilterQtdRealMax",
          "atingidoFilterVlrPrevMin",
          "atingidoFilterVlrPrevMax",
          "atingidoFilterVlrRealMin",
          "atingidoFilterVlrRealMax",
          "atingidoFilterPercMin",
          "atingidoFilterPercMax",
        ];

        atingidoFilterInputs.forEach((inputId) => {
          const input = document.getElementById(inputId);
          if (input) {
            input.addEventListener(
              "input",
        ...
        // Event listener para select de status do % Atingido
        const atingidoFilterStatus = document.getElementById(
          "atingidoFilterStatus"
        );
        if (atingidoFilterStatus) {
          atingidoFilterStatus.addEventListener("change", function () {
            applyAtingidoAdvancedFilters();
          });
        }
      ...
      function applyAdvancedFaturamentoFilters(data) {
        ...
        // Filtro por quantidade prevista (faixa)
        ...
        // Filtro por quantidade real (faixa)
        ...
        // Filtro por valor previsto (faixa)
        ...
        // Filtro por percentual atingido (faixa)
        if (filters.percMin !== "") {
          filtered = filtered.filter(
        ...
        if (filters.status) {
          switch (filters.status) {
            case "atingida":
              filtered = filtered.filter((item) => item.perc >= 100);
              break;
            case "proxima":
              filtered = filtered.filter(
                (item) => item.perc >= 80 && item.perc < 100
              );
              break;
            case "abaixo":
              filtered = filtered.filter((item) => item.perc < 80);
              break;
          }
        }
      ...
      function applyFaturamentoAdvancedFilters() {
        ...
        overlayStates.faturamento.advancedFilters.qtdprevMin =
          document.getElementById("faturamentoFilterQtdPrevMin").value;
        overlayStates.faturamento.advancedFilters.qtdprevMax =
          document.getElementById("faturamentoFilterQtdPrevMax").value;
        overlayStates.faturamento.advancedFilters.qtdrealMin =
          document.getElementById("faturamentoFilterQtdRealMin").value;
        overlayStates.faturamento.advancedFilters.qtdrealMax =
          document.getElementById("faturamentoFilterQtdRealMax").value;
        overlayStates.faturamento.advancedFilters.vlrprevMin =
          document.getElementById("faturamentoFilterVlrPrevMin").value;
        overlayStates.faturamento.advancedFilters.vlrprevMax =
          document.getElementById("faturamentoFilterVlrPrevMax").value;
        overlayStates.faturamento.advancedFilters.vlrrealMin =
          document.getElementById("faturamentoFilterVlrRealMin").value;
        overlayStates.faturamento.advancedFilters.vlrrealMax =
          document.getElementById("faturamentoFilterVlrRealMax").value;
        overlayStates.faturamento.advancedFilters.percMin =
          document.getElementById("faturamentoFilterPercMin").value;
        overlayStates.faturamento.advancedFilters.percMax =
      ...
      function applyMetaAdvancedFilters() {
        ...
        overlayStates.meta.advancedFilters.qtdprevMin = document.getElementById(
          "metaFilterQtdPrevMin"
        ).value;
        overlayStates.meta.advancedFilters.qtdprevMax = document.getElementById(
          "metaFilterQtdPrevMax"
        ).value;
        overlayStates.meta.advancedFilters.qtdrealMin = document.getElementById(
          "metaFilterQtdRealMin"
        ).value;
        overlayStates.meta.advancedFilters.qtdrealMax = document.getElementById(
          "metaFilterQtdRealMax"
        ).value;
        overlayStates.meta.advancedFilters.vlrprevMin = document.getElementById(
          "metaFilterVlrPrevMin"
        ).value;
        overlayStates.meta.advancedFilters.vlrprevMax = document.getElementById(
          "metaFilterVlrPrevMax"
        ).value;
        overlayStates.meta.advancedFilters.vlrrealMin = document.getElementById(
          "metaFilterVlrRealMin"
        ).value;
        overlayStates.meta.advancedFilters.vlrrealMax = document.getElementById(
          "metaFilterVlrRealMax"
        ).value;
        overlayStates.meta.advancedFilters.percMin =
          document.getElementById("metaFilterPercMin").value;
        overlayStates.meta.advancedFilters.percMax =
          document.getElementById("metaFilterPercMax").value;
        overlayStates.meta.advancedFilters.status =
      ...
      function clearVendedorFilters() {
        // Limpar todos os campos de filtro
        document.getElementById("vendedorFilterCodvend").value = "";
        document.getElementById("vendedorFilterApelido").value = "";
