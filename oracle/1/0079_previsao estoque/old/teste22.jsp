    ...
    <table>
        <thead>
            <tr>
                ...
                <th title="Estoque em Vermelho Precisa Receber Transferência">Posição</th>
            </tr>
        </thead>
        <tbody>
...
<script>
    ...
    function updateCalculationEstMinVarEscolha(span, estMin) {
        ...
        const estoqueAtual = parseFloat(span.closest('tr').querySelector('td:nth-child(8)').textContent);
