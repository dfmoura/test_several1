    ...
    SELECT
        ...
        BY
           ...
           CASE 
            ...
            ELSE ITE.VLRTOT / NULLIF(SUM(ITE.VLRTOT) OVER (PARTITION 
            BY
                ITE.NUNOTA), 0) 
...
ISNULL(
                GRU1.DESCRGRUPO_NIVEL1,
'SEM GRUPO'
            ) DESCRGRUPO_NIVEL1,

ISNULL(
                GRU1.DIVIDEMULTIPLICA,
0
            ) DIVIDEMULTIPLICA,
ISNULL(
                GRU1.QUANTIDADE,
...
(
                CASE 
                    ...
                    WHEN ITE.CODVOL<>'KG' THEN CASE 
                        ...
                        WHEN GRU1.DIVIDEMULTIPLICA='M' THEN ITE.QTDNEG/NULLIF(GRU1.QUANTIDADE, 0) 
...
/
NULLIF(CASE 
WHEN CAB.TIPMOV = 'V' THEN VP.VLRNOTA * VP.PROPORCAO_ITEM END, 0)
PERCMARGEM,
