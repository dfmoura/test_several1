...
<head>
    ...
    <style>
        ...
        .chart-overlay {
            ...
            font-weight: bold;
            color: #333;
            left: 62%; /* Move o overlay mais para a direita */
    ...
    <snk:query var="cip_total">  	
        WITH bas AS (
            SELECT /*+ INDEX(vw_rentabilidade_aco idx_rent_dtneg_tipmov) */
                ...
                codemp,
                empresa,
                SUM(CASE WHEN TIPMOV = 'V' THEN (VLRTOT)-(VLRDESC1)-(VLRDESCTOT_PROP)+(VLRSUBST_PROP)-(VLRREPRED) ELSE 0 END) AS VLRNOTA,
                -- Soma total por codgrupai usando OVER (PARTITION BY)
                SUM(SUM(VLRNOTA)) OVER (PARTITION BY codgrupai) AS total_grupo
            FROM vw_rentabilidade_aco 
            WHERE tipmov IN ('V', 'D')
...
<snk:query var="fat_produto">
    ...
    <div class="container">
        <div class="section">
            ...
            <div class="part" id="left-bottom">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                    <div class="part-title">${row.descrgrupo_nivel1} - Empresa</div>
                </c:forEach>
                <div class="chart-container">
        ...
        <div class="section">
            <div class="part" id="right-top">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                <div class="part-title">${row.descrgrupo_nivel1} - Vendedores</div>
            </c:forEach>
                <div class="chart-container">
            ...
            <div class="part" id="right-bottom">
                <c:forEach items="${fat_prod_titulo.rows}" var="row">
                    <div class="part-title">${row.descrgrupo_nivel1} - Produtos</div>
                </c:forEach>
    ...
    <script>
        ...
        function ref_fat1(TIPOPROD) {
            ...
            refreshDetails('html5_ahmbmb4', params1); 
