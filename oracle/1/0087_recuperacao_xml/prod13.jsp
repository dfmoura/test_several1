...
<body>
    ...
    <!-- Armazenando o resultado da query em uma variável JavaScript -->
    <c:set var="nfeData" value="${nfe.rows}" scope="page" />

    <script type="text/javascript">
        // Convertendo a variável JSTL para JavaScript
        var nfeData = [
            <c:forEach var="row" items="${nfeData}" varStatus="loop">
                {
                    grupo: "${row.grupo}",
                    Origem: "${row.Origem}",
        ...
        // Exemplo de como usar a variável nfeData no JavaScript
        console.log(nfeData);
    </script>
