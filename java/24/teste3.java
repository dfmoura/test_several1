            ...
            while ((linha = reader.readLine()) != null) {
                if (linhaNum == 0) {
                    ...
                    if (colunas.length >= 3) {
                        ...
                        String strQtd = colunas[2].trim().replace(".", "").replace(",", ".").replace("R$", "").replace("-", "").trim();
                        BigDecimal qtdNeg = new BigDecimal(strQtd);
                        ...
                        conteudo.append("Linha ").append(linhaNum).append(" inserida com sucesso: ")
                                .append(perfil).append(", ").append(material).append(", ").append(qtdNeg).append("\n");
                    } else {
