...
<body class="bg-green-50 min-h-screen flex flex-col items-center py-2">
  ...
  <div class="fixed-header">
    ...
    <div class="header-actions">
      ...
      <button id="insertDataBtn" class="header-btn" title="Efetivar Preço">
...
function hideStatusOverlay() {
  document.getElementById('statusOverlay').style.display = 'none';
    ...
    function collectTableDataForSimulation() {
      ...
      // Obter o valor do parceiro selecionado
      const parceiroSelect = document.getElementById('parceiroSelect');
      const codparc = parceiroSelect ? parceiroSelect.value : '';
      ...
      try {
        ...
        result.forEach(simulacao => {
          ...
          row.addEventListener('dblclick', function() {
            ...
            if (codemp && periodo) {
              loadSimulationData(codemp, periodo);
            }
          });
        ...
        tableBody.innerHTML = `
          <tr>
            <td colspan="6" style="padding: 20px; text-align: center; color: #ef4444; font-style: italic;">
    ...
    async function loadSimulationData(codemp, periodo) {
      try {
        // Fechar modal
        document.getElementById('loadSimulationModal').style.display = 'none';
    ...
    async function verificarDadosSimulacao(codusu, empresa, periodo) {
      try {
        const sql = `
    ...
    async function preencherDadosSimulacao() {
      try {
        ...
        // Obter empresa e período dos filtros
