...
<script>
      ...
      if (resultado && resultado.length > 0) {
        ...
        if (faturamentoCard) {
          ...
          if (cardFooter) {
            ...
            // Adicionar seta indicativa baseada na variação
            let seta = '';
            if (variacao > 0) {
              seta = '<span style="color: green; font-weight: bold;">↗</span>';
            } else if (variacao < 0) {
              seta = '<span style="color: red; font-weight: bold;">↘</span>';
            } else {
              seta = '<span style="color: gray; font-weight: bold;">→</span>';
            }
  ...
  function atualizarDadosFaturamento() {
    const btn = document.querySelector('.header-btn[onclick="atualizarDadosFaturamento()"]');
    ...
    carregarDadosFaturamento().finally(() => {
