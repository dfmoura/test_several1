    ...
    <div class="bg-green-100 rounded-lg p-4 shadow">
      ...
      <div class="flex flex-wrap items-center justify-between gap-2 mb-3">
        <div class="flex items-center space-x-2">
          <button onclick="openMainFilterModal()" class="flex items-center space-x-1 px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition text-sm">
            <i class="fas fa-filter"></i>
            <span>Filtros</span>
          </button>
        </div>
        
        <!-- Campos de filtro básico reposicionados -->
        <div class="flex items-center space-x-2">
          <label for="empresaSelect" class="font-semibold text-green-900 text-xs">Empresa: *</label>
          <select id="empresaSelect" name="empresaSelect" required class="border border-green-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-green-400 text-xs w-32">
        ...
        <div class="flex items-center space-x-2">
          ...
          <input type="text" id="periodoInput" name="periodoInput" placeholder="DD/MM/YYYY" maxlength="10" required class="border border-green-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-green-400 text-xs w-32" />
        </div>
        ...
        <div class="flex items-center space-x-2">
          <button onclick="listarResumoMaterial()" class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition text-xs">Consultar</button>
        </div>
      </div>
      
      <!-- Segunda linha: Controles globais -->
      <div class="flex flex-wrap items-center justify-between gap-2">
        <div class="flex items-center space-x-2">
          ...
          <button id="applyGlobalPrice" class="ml-2 px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600 transition text-xs">Aplicar</button>
        </div>
        <div class="flex items-center space-x-2">
          ...
          <button id="applyGlobalDtVigor" class="ml-2 px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600 transition text-xs">Aplicar</button>
        </div>
        <div class="flex items-center space-x-2">
          ...
          <button id="applyGlobalMargin" class="ml-2 px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600 transition text-xs">Aplicar</button>
        </div>
      </div>
    </div>
  </div>
