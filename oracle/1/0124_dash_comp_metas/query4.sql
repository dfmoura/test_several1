...
SELECT
    ...
    -- Percentual de atingimento Julho
    NVL(CASE WHEN MD.JUL_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.JUL_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Agosto
    NVL(CASE WHEN MD.AGO_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.AGO_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Setembro
    NVL(CASE WHEN MD.SET_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.SET_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Outubro
    NVL(CASE WHEN MD.OUT_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.OUT_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Novembro
    NVL(CASE WHEN MD.NOV_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.NOV_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Dezembro
    NVL(CASE WHEN MD.DEZ_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.DEZ_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Janeiro
    NVL(CASE WHEN MD.JAN_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.JAN_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Fevereiro
    NVL(CASE WHEN MD.FEV_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.FEV_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Março
    NVL(CASE WHEN MD.MAR_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.MAR_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Abril
    NVL(CASE WHEN MD.ABR_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.ABR_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Maio
    NVL(CASE WHEN MD.MAI_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.MAI_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
    ...
    -- Percentual de atingimento Junho
    NVL(CASE WHEN MD.JUN_DATA_INI BETWEEN MD.DATA_INI AND MD.DATA_FIN OR MD.JUN_DATA_FIN BETWEEN MD.DATA_INI AND MD.DATA_FIN THEN
